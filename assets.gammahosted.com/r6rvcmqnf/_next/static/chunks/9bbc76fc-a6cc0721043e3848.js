        ...
        27194: (e, t, n) => {
            ...
            function O(e, t) {
                ...
                let r = m(e),
                    ...
                    a = null == (n = o.find(e => h(e, "topNode"))) ? void 0 : n.name,
            ...
            function z(e) {
                let {
                    ...
                    if (function(e) {
                            ...
                            return n.doc.nodesBetween(r, o, (e, t) => {
                                ...
                                $(e.textBetween(u - t, h - t, void 0, "￼"), i.find, s).forEach(e => {
                ...
                return n.map(e => new r.Plugin({
                    view(e) {
                        let t = t => {
                            var n;
                            o = (null == (n = e.dom.parentElement) ? void 0 : n.contains(t.target)) ? e.dom.parentElement : null
                        };
            ...
            class F {
                constructor(e, t) {
                    this.splittableMarks = [], this.editor = t, this.extensions = F.resolve(e), this.schema = O(this.extensions, t), this.setupExtensions()
                }
                static resolve(e) {
                    let t = F.sort(F.flatten(e)),
                        n = L(t.map(e => e.name));
                ...
                get plugins() {
                    let {
                        editor: e
                    } = this, t = F.sort([...this.extensions].reverse()), n = [], r = [], o = t.map(t => {
                        let o = {
                                name: t.name,
                                options: t.options,
                                storage: t.storage,
                            ...
                            l = {};
                        if ("mark" === t.type && h(t, "exitable", o) && (l.ArrowRight = () => eH.handleExit({
                                editor: e,
                                mark: t
                            })), a) {
                ...
                setupExtensions() {
                    this.extensions.forEach(e => {
                        ...
                        let n = {
                            ...
                            storage: e.storage,
                            editor: this.editor,
                            type: E(e.name, this.schema)
                        };
                        "mark" === e.type && (null == (t = k(h(e, "keepOnSplit", n))) || t) && this.splittableMarks.push(e.name);
            ...
            function V(e, t) {
                ...
                return H(e) && H(t) && Object.keys(t).forEach(r => {
                    H(t[r]) && H(e[r]) ? n[r] = V(e[r], t[r]) : n[r] = t[r]
                }), n
            }
            class _ {
                constructor(e = {}) {
                ...
                extend(e = {}) {
                    ...
                    return t.parent = this, this.child = t, t.name = e.name ? e.name : t.parent.name, e.defaultOptions && Object.keys(e.defaultOptions).length > 0 && console.warn(`[tiptap warn]: BREAKING CHANGE: "defaultOptions" is deprecated. Please use "addOptions" instead. Found in extension: "${t.name}".`), t.options = k(h(t, "addOptions", {
                        name: t.name
                        ...
                        props: {
                            clipboardTextSerializer: () => {
                                let {
                                    ...
                                    ranges: i
                                } = o, s = Math.min(...i.map(e => e.$from.pos)), a = Math.max(...i.map(e => e.$to.pos)), l = W(n);
                                return K(r, {
                                    from: s,
                                    to: a
            ...
            function U(e, t, n = {
                ...
                let r = Object.keys(t);
                return !r.length || r.every(r => n.strict ? t[r] === e[r] : P(t[r]) ? t[r].test(e[r]) : t[r] === e[r])
            }

            function q(e, t, n = {}) {
                return e.find(e => e.type === t && U(e.attrs, n))
            }
            ...
            function er(e, t, n) {
                ...
                if (o) {
                    if (n.errorOnInvalidContent) {
                        ...
                        if (n.slice ? s.DOMParser.fromSchema(i).parseSlice(en(e), n.parseOptions) : s.DOMParser.fromSchema(i).parse(en(e), n.parseOptions), n.errorOnInvalidContent && r) throw Error("[tiptap error]: Invalid HTML content", {
            ...
            function ev(e, t) {
                ...
                return "node" === n ? eb(e, t) : "mark" === n ? eu(e, t) : {}
            }
            ...
            function eS(e, t, n = {}) {
                let {
                    empty: r,
                    ranges: o
                } = e.selection, i = t ? X(t, e.schema) : null;
            ...
            var eA = Object.freeze({
                ...
                focus: (e = null, t = {}) => ({
                    ...
                    let s = () => {
                        ee() && r.dom.focus(), requestAnimationFrame(() => {
                ...
                insertContentAt: (e, t, n) => ({
                    ...
                    if (o) {
                        ...
                        c ? (a = Array.isArray(t) ? t.map(e => e.text || "").join("") : "object" == typeof t && t && t.text ? t.text : t, r.insertText(a, l, d)) : (a = o, r.replaceWith(l, d, a)), n.updateSelection && eo(r, r.steps.length - 1, -1), n.applyInputRules && r.setMeta("applyInputRules", {
                            from: l,
                            text: a
                ...
                joinTextblockBackward: () => ({
                    state: e,
                    dispatch: t
                }) => l.joinTextblockBackward(e, t),
                joinTextblockForward: () => ({
                    state: e,
                    dispatch: t
                }) => l.joinTextblockForward(e, t),
                joinUp: () => ({
                    state: e,
                    dispatch: t
                }) => l.joinUp(e, t),
                ...
                resetAttributes: (e, t) => ({
                    ...
                    return !!a && ("node" === a && (i = g(e, r.schema)), "mark" === a && (s = X(e, r.schema)), o && n.selection.ranges.forEach(e => {
                        r.doc.nodesBetween(e.$from.pos, e.$to.pos, (e, r) => {
                            i && i === e.type && n.setNodeMarkup(r, void 0, ed(e.attrs, t)), s && e.marks.length && e.marks.forEach(o => {
                ...
                selectNodeBackward: () => ({
                    state: e,
                    dispatch: t
                }) => l.selectNodeBackward(e, t),
                selectNodeForward: () => ({
                    state: e,
                    dispatch: t
                }) => l.selectNodeForward(e, t),
                selectParentNode: () => ({
                    state: e,
                    dispatch: t
                }) => l.selectParentNode(e, t),
                selectTextblockEnd: () => ({
                    state: e,
                    dispatch: t
                }) => l.selectTextblockEnd(e, t),
                selectTextblockStart: () => ({
                    state: e,
                    dispatch: t
                }) => l.selectTextblockStart(e, t),
                setContent: (e, t = !1, n = {}, r = {}) => ({
                    editor: o,
                    tr: i,
                    dispatch: s,
                    commands: a
                    ...
                    if ("full" !== n.preserveWhitespace) {
                        let a = ec(e, o.schema, n, {
                            errorOnInvalidContent: null != (l = r.errorOnInvalidContent) ? l : o.options.enableContentCheck
                        });
                        return s && i.replaceWith(0, c.content.size, a).setMeta("preventUpdate", !t), !0
                    }
                    return s && i.setMeta("preventUpdate", !t), a.insertContentAt({
                        from: 0,
                        to: c.content.size
                    }, e, {
                        parseOptions: n,
                        errorOnInvalidContent: null != (d = r.errorOnInvalidContent) ? d : o.options.enableContentCheck
                    })
                },
                setMark: (e, t = {}) => ({
                    tr: n,
                ...
                setNode: (e, t = {}) => ({
                    ...
                    return i.isTextblock ? o().command(({
                        commands: e
                    }) => !!l.setBlockType(i, t)(n) || e.clearNodes()).command(({
                        state: e
                    }) => l.setBlockType(i, t)(e, r)).run() : (console.warn('[tiptap warn]: Currently "setNode()" only supports text block nodes.'), !1)
                },
                setNodeSelection: e => ({
                    tr: t,
                    dispatch: n
                    ...
                    if (n) {
                        let {
                            doc: n
                        } = t, o = Q(e, 0, n.content.size), i = r.NodeSelection.create(n, o);
                        t.setSelection(i)
                    }
                    return !0
                },
                setTextSelection: e => ({
                    ...
                    if (n) {
                        let {
                            ...
                            from: e,
                            to: e
                        } : e, s = r.TextSelection.atStart(n).from, a = r.TextSelection.atEnd(n).to, l = Q(o, s, a), d = Q(i, s, a), c = r.TextSelection.create(n, l, d);
                        t.setSelection(c)
                    }
                    return !0
                },
                ...
                splitBlock: ({
                    ...
                    let {
                        ...
                        $from: d,
                        $to: c
                    } = s, u = ew(i.extensionManager.attributes, d.node().type.name, d.node().attrs);
                    ...
                    let p = c.parentOffset === c.parent.content.size,
                        h = 0 === d.depth ? void 0 : ep(d.node(-1).contentMatchAt(d.indexAfter(-1))),
                        f = p && h ? [{
                            type: h,
                            attrs: u
                        }] : void 0,
                        m = a.canSplit(t.doc, t.mapping.map(d.pos), 1, f);
                    if (!f && !m && a.canSplit(t.doc, t.mapping.map(d.pos), 1, h ? [{
                            type: h
                        }] : void 0) && (m = !0, f = h ? [{
                            type: h,
                            attrs: u
                        }] : void 0), o) {
                        if (m && (s instanceof r.TextSelection && t.deleteSelection(), t.split(t.mapping.map(d.pos), 1, f), h && !p && !d.parentOffset && d.parent.type !== h)) {
                ...
                splitListItem: (e, t = {}) => ({
                    ...
                    if (0 === u.parent.content.size && u.node(-1).childCount === u.indexAfter(-1)) {
                        ...
                        if (i) {
                            ...
                            for (let t = u.depth - o; t >= u.depth - 3; t -= 1) e = s.Fragment.from(u.node(t).copy(e));
                            let i = u.indexAfter(-1) < u.node(-2).childCount ? 1 : u.indexAfter(-2) < u.node(-3).childCount ? 2 : 3,
                                a = { ...ew(m, u.node().type.name, u.node().attrs),
                                    ...t
                                },
                                l = (null == (d = c.contentMatch.defaultType) ? void 0 : d.createAndFill(a)) || void 0;
                            e = e.append(s.Fragment.from(c.createAndFill(null, l) || void 0));
                            let p = u.before(u.depth - (o - 1));
                            n.replace(p, u.after(-i), new s.Slice(e, 4 - o, 0));
                            let h = -1;
                            n.doc.nodesBetween(p, n.doc.content.size, (e, t) => {
                                if (h > -1) return !1;
                                e.isTextblock && 0 === e.content.size && (h = t + 1)
                            }), h > -1 && n.setSelection(r.TextSelection.near(n.doc.resolve(h))), n.scrollIntoView()
                        }
                        return !0
                    }
                    let y = p.pos === u.end() ? f.contentMatchAt(0).defaultType : null,
                        b = { ...ew(m, f.type.name, f.attrs),
                            ...t
                        },
                        v = { ...ew(m, u.node().type.name, u.node().attrs),
                            ...t
                        };
                    n.delete(u.pos, p.pos);
                    let k = y ? [{
                        type: c,
                        attrs: b
                    }, {
                    ...
                    if (i) {
                        ...
                        if (n.split(u.pos, 2, k).scrollIntoView(), !s || !i) return !0;
                ...
                toggleList: (e, t, n, r = {}) => ({
                    ...
                    let {
                        ...
                        $from: b,
                        $to: v
                    } = m, k = b.blockRange(v), x = y || m.$to.parentOffset && m.$from.marks();
                    if (!k) return !1;
                    let w = ef(e => eO(e.type.name, u))(m);
                    if (k.depth >= 1 && w && k.depth - w.depth <= 1) {
                        if (w.node.type === h) return d.liftListItem(f);
                        if (eO(w.node.type.name, u) && h.validContent(w.node.content) && a) return l().command(() => (i.setNodeMarkup(w.pos, h), !0)).command(() => eC(i, h)).command(() => eP(i, h)).run()
                    }
                    return n && x && a ? l().command(() => {
                        let e = c().wrapInList(h, r),
                            t = x.filter(e => p.includes(e.type.name));
                        return i.ensureMarks(t), !!e || d.clearNodes()
                    }).wrapInList(h, r).command(() => eC(i, h)).command(() => eP(i, h)).run() : l().command(() => !!c().wrapInList(h, r) || d.clearNodes()).wrapInList(h, r).command(() => eC(i, h)).command(() => eP(i, h)).run()
                },
                toggleMark: (e, t = {}, n = {}) => ({
                    state: r,
                    commands: o
                ...
                unsetMark: (e, t = {}) => ({
                    ...
                    if (c && s) {
                        let {
                            from: e,
                            to: t
                        } = a, r = null == (i = d.marks().find(e => e.type === l)) ? void 0 : i.attrs, o = G(d, l, r);
                    ...
                    addKeyboardShortcuts() {
                        let e = () => this.editor.commands.first(({
                                ...
                                let {
                                    ...
                                    pos: a,
                                    parent: l
                                } = s, d = s.parent.isTextblock && a > 0 ? t.doc.resolve(a - 1) : s, c = d.parent.type.spec.isolating, u = s.pos - s.parentOffset, p = c && 1 === d.parent.childCount ? u === s.pos : r.Selection.atStart(o).from === a;
                        ...
                        return [new r.Plugin({
                            ...
                            appendTransaction: (e, t, n) => {
                                ...
                                let {
                                    ...
                                    from: i,
                                    to: s
                                } = t.selection, a = r.Selection.atStart(t.doc).from, l = r.Selection.atEnd(t.doc).to;
...
.tippy-box[data-animation=fade][data-state=hidden] {
  opacity: 0
            ...
            class eF extends p {
                ...
                injectCSS() {
                    this.options.injectCSS && document && (this.css = eL(ez, this.options.injectNonce))
                }
                setOptions(e = {}) {
                ...
                registerPlugin(e, t) {
                    let n = v(t) ? t(e, [...this.state.plugins]) : [...this.state.plugins, e],
                ...
                createExtensionManager() {
                    var e, t;
                    let n = [...this.options.enableCoreExtensions ? [eI, J.configure({
                        blockSeparator: null == (t = null == (e = this.options.coreExtensionOptions) ? void 0 : e.clipboardTextSerializer) ? void 0 : t.blockSeparator
                    }), eN, ej, eR, eB] : [], ...this.options.extensions].filter(e => ["extension", "node", "mark"].includes(null == e ? void 0 : e.type));
                    this.extensionManager = new F(n, this)
                }
                ...
                createView() {
                    let e;
                    try {
                        e = ec(this.options.content, this.schema, this.options.parseOptions, {
                        ...
                        this.emit("contentError", {
                            ...
                            error: t,
                            disableCollaboration: () => {
                                this.options.extensions = this.options.extensions.filter(e => "collaboration" !== e.name), this.createExtensionManager()
                            }
                        }), e = ec(this.options.content, this.schema, this.options.parseOptions, {
                            errorOnInvalidContent: !1
                        })
                    }
                    let t = Z(e, this.options.autofocus);
                    this.view = new o.EditorView(this.options.element, { ...this.options.editorProps,
                        dispatchTransaction: this.dispatchTransaction.bind(this),
                        state: r.EditorState.create({
                            doc: e,
                            selection: t || void 0
                        })
                    });
                ...
                getText(e) {
                    ...
                    return ey(this.state.doc, {
                        blockSeparator: t,
                        textSerializers: { ...W(this.schema),
                            ...n
                        }
                    })
                }
                ...
                get isDestroyed() {
                    var e;
                    return !(null == (e = this.view) ? void 0 : e.docView)
                }
                $node(e, t) {
                    var n;
            ...
            class e_ {
                constructor(e, t, n) {
                    this.isDragging = !1, this.component = e, this.editor = t.editor, this.options = {
                        ...
                        ignoreMutation: null,
                        ...n
                    }, this.extension = t.extension, this.node = t.node, this.decorations = t.decorations, this.getPos = t.getPos, this.mount()
                }
                mount() {}
                get dom() {
                ...
                onDragStart(e) {
                    ...
                    if (this.dom !== u) {
                        let t = this.dom.getBoundingClientRect(),
                            ...
                            r = null != (o = e.offsetX) ? o : null == (i = e.nativeEvent) ? void 0 : i.offsetX,
                            l = null != (s = e.offsetY) ? s : null == (a = e.nativeEvent) ? void 0 : a.offsetY;
                        p = n.x - t.x + r, h = n.y - t.y + l
                    }
                    null == (l = e.dataTransfer) || l.setDragImage(this.dom, p, h);
                ...
                stopEvent(e) {
                    ...
                    let {
                        ...
                        isDragging: a
                    } = this, l = !!this.node.type.spec.draggable, d = r.NodeSelection.isSelectable(this.node), c = "copy" === e.type, u = "paste" === e.type, p = "cut" === e.type, h = "mousedown" === e.type;
                ...
                ignoreMutation(e) {
                    return !this.dom || !this.contentDOM || ("function" == typeof this.options.ignoreMutation ? this.options.ignoreMutation({
                        mutation: e
                    }) : !!this.node.isLeaf || !!this.node.isAtom || !("selection" === e.type || this.dom.contains(e.target) && "childList" === e.type && (ee() || "Android" === navigator.platform || /android/i.test(navigator.userAgent)) && this.editor.isFocused && [...Array.from(e.addedNodes), ...Array.from(e.removedNodes)].every(e => e.isContentEditable)) && (this.contentDOM === e.target && "attributes" === e.type || !this.contentDOM.contains(e.target)))
                }
                updateAttributes(e) {
                    this.editor.commands.command(({
                        ...
                        let n = this.getPos();
                        return t.setNodeMarkup(n, void 0, { ...this.node.attrs,
                            ...e
                        }), !0
                    })
                }
            ...
            t.CommandManager = u, t.Editor = eF, t.Extension = _, t.InputRule = A, t.Mark = eH, t.Node = eV, t.NodePos = eD, t.NodeView = e_, t.PasteRule = B, t.Tracker = eK, t.callOrReturn = k, t.combineTransactionSteps = function(e, t) {
            ...
            }, t.createChainableState = c, t.createDocument = ec, t.createNodeFromContent = er, t.createStyleTag = eL, t.defaultBlockAt = ep, t.deleteProps = ed, t.elementFromString = en, t.escapeForRegEx = function(e) {
                return e.replace(/[-/\\^$*+?.()|[\]{}]/g, "\\$&")
            }, t.extensions = e$, t.findChildren = function(e, t) {
                let n = [];
            ...
            }, t.findDuplicates = L, t.findParentNode = ef, t.findParentNodeClosestToPos = eh, t.fromString = w, t.generateHTML = function(e, t) {
                let n = eg(t);
                ...
                return ey(s.Node.fromJSON(i, e), {
                    blockSeparator: r,
                    textSerializers: { ...W(i),
                        ...o
                    }
                })
            }, t.getAttributes = ev, t.getAttributesFromExtensions = m, t.getChangedRanges = function(e) {
                let {
                    mapping: t,
                    steps: n
                } = e, r = [];
                ...
                let o = ek(r);
                return 1 === o.length ? o : o.filter((e, t) => !o.filter((e, n) => n !== t).some(t => e.oldRange.from >= t.oldRange.from && e.oldRange.to <= t.oldRange.to && e.newRange.from >= t.newRange.from && e.newRange.to <= t.newRange.to))
            }, t.getDebugJSON = function e(t, n = 0) {
                let r = +(t.type !== t.type.schema.topNodeType),
                    o = n + t.nodeSize,
                    i = t.marks.map(e => {
                        let t = {
                            type: e.type.name
                        };
                        return Object.keys(e.attrs).length && (t.attrs = { ...e.attrs
                        }), t
                    }),
                    s = { ...t.attrs
                    },
                ...
                return Object.keys(s).length && (a.attrs = s), i.length && (a.marks = i), t.content.childCount && (a.content = [], t.forEach((t, o) => {
                    var i;
                    null == (i = a.content) || i.push(e(t, n + o + r))
                })), t.text && (a.text = t.text), a
            }, t.getExtensionField = h, t.getHTMLFromFragment = em, t.getMarkAttributes = eu, t.getMarkRange = G, t.getMarkType = X, t.getMarksBetween = ex, t.getNodeAtPosition = (e, t, n, r = 20) => {
                ...
                return [s, i]
            }, t.getNodeAttributes = eb, t.getNodeType = g, t.getRenderedAttributes = b, t.getSchema = eg, t.getSchemaByResolvedExtensions = O, t.getSchemaTypeByName = E, t.getSchemaTypeNameByName = el, t.getSplittedAttributes = ew, t.getText = ey, t.getTextBetween = K, t.getTextContentFromNodes = C, t.getTextSerializersFromSchema = W, t.injectExtensionAttributesToParseRule = S, t.inputRulesPlugin = j, t.isActive = eM, t.isAtEndOfNode = (e, t) => {
                let {
                    $from: n,
                    $to: r,
                    $anchor: o
            ...
            }, t.isEmptyObject = x, t.isExtensionRulesEnabled = T, t.isFunction = v, t.isList = eO, t.isMacOS = es, t.isMarkActive = eS, t.isNodeActive = ea, t.isNodeEmpty = eE, t.isNodeSelection = function(e) {
                return e instanceof r.NodeSelection
            }, t.isNumber = R, t.isPlainObject = H, t.isRegExp = P, t.isString = function(e) {
                return "string" == typeof e
            }, t.isTextSelection = Y, t.isiOS = ee, t.markInputRule = function(e) {
                return new A({
                    find: e.find,
                    handler: ({
                        state: t,
                        ...
                        if (s) {
                            let r = a.search(/\S/),
                                ...
                                d = l + s.length;
                            if (ex(n.from, n.to, t.doc).filter(t => t.mark.type.excluded.find(n => n === e.type && n !== t.mark.type)).filter(e => e.to > l).length) return null;
                    ...
                    handler: ({
                        ...
                        if (a) {
                            let r = l.search(/\S/),
                                ...
                                c = o + a.length;
                            if (ex(n.from, n.to, t.doc).filter(t => t.mark.type.excluded.find(n => n === e.type && n !== t.mark.type)).filter(e => e.to > o).length) return null;
            ...
            }, t.mergeAttributes = y, t.mergeDeep = V, t.minMax = Q, t.nodeInputRule = function(e) {
                return new A({
                    find: e.find,
                    handler: ({
                        state: t,
                ...
                return new B({
                    ...
                    handler({
                        ...
                        let i = k(e.getAttributes, void 0, t, o),
                            s = k(e.getContent, void 0, i);
                        if (!1 === i || null === i) return null;
                        let a = {
                            type: e.type.name,
                            attrs: i
                        };
                        s && (a.content = s), t.input && n().deleteRange(r).insertContentAt(r.from, a)
                    }
                })
            }, t.objectIncludes = U, t.pasteRulesPlugin = z, t.posToDOMRect = function(e, t, n) {
            ...
            }, t.removeDuplicates = ek, t.resolveFocusPosition = Z, t.selectionToInsertionEnd = eo, t.splitExtensions = f, t.textInputRule = function(e) {
                return new A({
                    find: e.find,
                    handler: ({
                        state: t,
...
//# sourceMappingURL=9bbc76fc-a6cc0721043e3848.js.map