    ...
    [8635], {
        97255: (e, t, n) => {
            ...
            let b = "undefined" != typeof navigator ? navigator : null,
                ...
                D = /Edge\/(\d+)/.exec(v),
                N = /MSIE \d/.exec(v),
                C = /Trident\/(?:[7-9]|\d{2,})\..*rv:(\d+)/.exec(v),
                S = !!(N || C || D),
                O = N ? document.documentMode : C ? +C[1] : D ? +D[1] : 0,
                M = !S && /gecko\/(\d+)/i.test(v);
            M && (/Firefox\/(\d+)/.exec(v) || [0, 0])[1];
            let x = !S && /Chrome\/(\d+)/.exec(v),
                k = !!x,
                T = x ? +x[1] : 0,
                E = !S && !!b && /Apple Computer/.test(b.vendor),
                P = E && (/Mobile\/\w+/.test(v) || !!b && b.maxTouchPoints > 2),
                A = P || !!b && /Mac/.test(b.platform),
                V = !!b && /Win/.test(b.platform),
                R = /Android \d/.test(v),
                B = !!w && "webkitFontSmoothing" in w.documentElement.style,
                F = B ? +(/\bAppleWebKit\/(\d+)/.exec(navigator.userAgent) || [0, 0])[1] : 0;
            ...
            function z(e, t, n) {
                ...
                for (let r = n || e.dom; r;) {
                    ...
                    let e = r,
                        ...
                        a = 0,
                        c = 0;
                    if (t.top < d.top + L(o, "top") ? c = -(d.top - t.top + L(i, "top")) : t.bottom > d.bottom - L(o, "bottom") && (c = t.bottom - t.top > d.bottom - d.top ? t.top + L(i, "top") - d.top : t.bottom - d.bottom + L(i, "bottom")), t.left < d.left + L(o, "left") ? a = -(d.left - t.left + L(i, "left")) : t.right > d.right - L(o, "right") && (a = t.right - d.right + L(i, "right")), a || c)
                        if (n) s.defaultView.scrollBy(a, c);
                        else {
                            let n = e.scrollLeft,
                                o = e.scrollTop;
                    ...
                    let h = n ? "fixed" : getComputedStyle(r).position;
                    if (/^(fixed|sticky)$/.test(h)) break;
                    r = "absolute" == h ? r.offsetParent : l(r)
                }
            }
            ...
            function _(e, t, n) {
                let {
                    ...
                    offset: i,
                    atom: s
                } = e.docView.domFromPos(t, n < 0 ? -1 : 1), r = B || M;
                if (3 == o.nodeType)
                    if (r && (U.test(o.nodeValue) || (n < 0 ? !i : i == o.nodeValue.length))) {
                        let e = H(a(o, i, i), n);
                ...
                if (!e.state.doc.resolve(t - (s || 0)).parent.inlineContent) {
                    if (null == s && i && (n < 0 || i == p(o))) {
                        ...
                        if (1 == e.nodeType) return J(e.getBoundingClientRect(), !1)
                    }
                    if (null == s && i < p(o)) {
                        let e = o.childNodes[i];
                        if (1 == e.nodeType) return J(e.getBoundingClientRect(), !0)
                    }
                    return J(o.getBoundingClientRect(), n >= 0)
                }
                if (null == s && i && (n < 0 || i == p(o))) {
                    let e = o.childNodes[i - 1],
                        t = 3 == e.nodeType ? a(e, p(e) - !r) : 1 != e.nodeType || "BR" == e.nodeName && e.nextSibling ? null : e;
                    if (t) return G(H(t, 1), !1)
                }
                if (null == s && i < p(o)) {
                    let e = o.childNodes[i];
                    for (; e.pmViewDesc && e.pmViewDesc.ignoreForCoords;) e = e.nextSibling;
                    let t = e ? 3 == e.nodeType ? a(e, 0, +!r) : 1 == e.nodeType ? e : null : null;
            ...
            class ee {
                ...
                setSelection(e, t, n, o = !1) {
                    ...
                    if (M && c.focusNode && c.focusNode != d.node && 1 == c.focusNode.nodeType) {
                        let e = c.focusNode.childNodes[c.focusOffset];
                        e && "false" == e.contentEditable && (o = !0)
                    }
                    if (!(o || u && E) && h(l.node, l.offset, c.anchorNode, c.anchorOffset) && h(d.node, d.offset, c.focusNode, c.focusOffset)) return;
                    let f = !1;
                    if ((a.extend || e == t) && !u) {
            ...
            class eo extends ee {
                ...
                static create(e, t, n, o) {
                    let s = o.nodeViews[t.type.name],
                        r = s && s(t, o, n);
                    return r && r.dom || (r = i.ZF.renderSpec(document, t.type.spec.toDOM(t, n), null, t.attrs)), new eo(e, t, r.dom, r.contentDOM || r.dom, r)
                }
                parseRule() {
            ...
            class ei extends ee {
                ...
                static create(e, t, n, o, s, r) {
                    ...
                    if (t.isText)
                        ...
                        let e = i.ZF.renderSpec(document, t.type.spec.toDOM(t), null, t.attrs);
                        ({
                            dom: c,
                            contentDOM: h
                        } = e)
                ...
                updateChildren(e, t) {
                    ...
                    (function(e, t, n, o) {
                        ...
                        for (let a = 0;;) {
                            ...
                            if (u.isText) {
                                ...
                                for (; r < i.length && i[r].to < p;) r++;
                            let m = u.isInline && !u.isLeaf ? l.filter(e => !e.inline) : l.slice();
                            o(u, m, t.forChild(s, u), f), s = p
                        }
                    })(this.node, this.innerDeco, (t, s, r) => {
                        t.spec.marks ? d.syncToMarks(t.spec.marks, n, e) : t.type.side >= 0 && !r && d.syncToMarks(s == this.node.childCount ? i.CU.none : this.node.child(s).marks, n, e), d.placeWidget(t, e, o)
                    }, (t, i, r, a) => {
                        let c;
                    ...
                    }(this.contentDOM, this.children, e), P && function(e) {
                ...
                localCompositionInfo(e, t) {
                    ...
                    if (!(e.state.selection instanceof o.U3) || n < t || i > t + this.node.content.size) return null;
                ...
                for (let s = 0; s < e.length; s++) {
                    ...
                    if (r)
                        for (let e in r.nodeName && i.push(o = new ea(r.nodeName)), r) {
                            let s = r[e];
                            null != s && (n && 1 == i.length && i.push(o = new ea(t.isInline ? "span" : "div")), "class" == e ? o.class = (o.class ? o.class + " " : "") + s : "style" == e ? o.style = (o.style ? o.style + ";" : "") + s : "nodeName" != e && (o[e] = s))
                        }
                }
                return i
            }
            ...
            class eg {
                ...
                updateNextNode(e, t, n, o, i, s) {
                    for (let r = this.index; r < this.top.children.length; r++) {
                        ...
                        if (l instanceof ei) {
                            ...
                            let a = l.dom,
                                c, h = this.isLocked(a) && !(e.isText && l.node && l.node.isText && l.nodeDOM.nodeValue == e.text && 3 != l.dirty && ep(t, l.outerDeco));
                            if (!h && l.update(e, t, n, o)) return this.destroyBetween(this.index, r), l.dom != a && (this.changed = !0), this.index++, !0;
                            if (!h && (c = this.recreateWrapper(l, e, t, n, o, s))) return this.destroyBetween(this.index, r), this.top.children[this.index] = c, c.contentDOM && (c.dirty = 2, c.updateChildren(o, s + 1), c.dirty = 0), this.changed = !0, this.index++, !0;
                            break
                        }
                    }
                    return !1
                ...
                recreateWrapper(e, t, n, o, i, s) {
                    if (e.dirty || t.isAtom || !e.children.length || !e.node.content.eq(t.content) || !ep(n, e.outerDeco) || !o.eq(e.innerDeco)) return null;
                    let r = ei.create(this.top, t, n, o, i, s);
                    if (r.contentDOM)
                        for (let t of (r.children = e.children, e.children = [], r.children)) t.parent = r;
                    return e.destroy(), r
                }
                addNode(e, t, n, o, i) {
                ...
                addTextblockHacks() {
                    ...
                    (!e || !(e instanceof er) || /\n$/.test(e.node.text) || this.view.requiresGeckoHackNode && /\s$/.test(e.node.text)) && ((E || k) && e && "false" == e.dom.contentEditable && this.addHackNode("IMG", t), this.addHackNode("BR", this.top))
                }
                addHackNode(e, t) {
            ...
            function ew(e, t = null) {
                ...
                let a = i.resolve(d),
                    c, h;
                if (g(n)) {
                    for (c = d; s && !s.node;) s = s.parent;
                    let e = s.node;
                    if (s && e.isAtom && o.nh.isSelectable(e) && s.parent && !(e.isInline && function(e, t, n) {
                    ...
                    if (n instanceof e.dom.ownerDocument.defaultView.Selection && n.rangeCount > 1) {
                        ...
                        for (let i = 0; i < n.rangeCount; i++) {
                            ...
                            t = Math.min(t, e.docView.posFromDOM(s.startContainer, s.startOffset, 1)), o = Math.max(o, e.docView.posFromDOM(s.endContainer, s.endOffset, -1))
                        }
                        if (t < 0) return null;
                        [c, d] = o == e.state.selection.anchor ? [o, t] : [t, o], a = i.resolve(d)
                ...
                if (eM(e, n), ev(e)) {
                    ...
                    if (e.domObserver.disconnectSelection(), e.cursorWrapper) ! function(e) {
                        ...
                        let o = e.cursorWrapper.dom,
                            i = "IMG" == o.nodeName;
                        i ? n.setStart(o.parentNode, r(o) + 1) : n.setStart(o, 0), n.collapse(!0), t.removeAllRanges(), t.addRange(n), !i && !e.state.selection.visible && S && O <= 11 && (o.disabled = !0, o.disabled = !1)
                    }(e);
                    else {
                        var i;
                        let s, r, l, d, {
            ...
            function eC(e, t) {
                ...
                if (E && i && "false" == i.contentEditable) return eS(i);
                if ((!i || "false" == i.contentEditable) && (!s || "false" == s.contentEditable)) {
                    if (i) return eS(i);
                    else if (s) return eS(s)
                }
            }
            ...
            function ek(e, t, n, i) {
                return e.someProp("createSelectionBetween", o => o(e, t, n)) || o.U3.between(t, n, i)
            }
            ...
            function eV(e, t, n) {
                ...
                if (i instanceof o.U3) {
                    if (n.indexOf("s") > -1) {
                        let {
                            $head: n
                        } = i, s = n.textOffset ? null : t < 0 ? n.nodeBefore : n.nodeAfter;
                        if (!s || s.isText || !s.isLeaf) return !1;
                        let r = e.state.doc.resolve(n.pos + s.nodeSize * (t < 0 ? -1 : 1));
                        return eA(e, new o.U3(i.$anchor, r))
                    } else if (!i.empty) return !1;
                    else if (e.endOfTextblock(t > 0 ? "forward" : "backward")) {
                        let n = eP(e.state, t);
                        return !!n && n instanceof o.nh && eA(e, n)
                    } else if (!(A && n.indexOf("m") > -1)) {
                        let n = i.$head,
                            s = n.textOffset ? null : t < 0 ? n.nodeBefore : n.nodeAfter,
                            r;
                        if (!s || s.isText) return !1;
                        let l = t < 0 ? n.pos - s.nodeSize : n.pos;
                        return !!(s.isAtom || (r = e.docView.descAt(l)) && !r.contentDOM) && (o.nh.isSelectable(s) ? eA(e, new o.nh(t < 0 ? e.state.doc.resolve(n.pos - s.nodeSize) : n)) : !!B && eA(e, new o.U3(e.state.doc.resolve(t < 0 ? l : l + s.nodeSize))))
                    }
                } else {
                    if (i instanceof o.nh && i.node.isInline) return eA(e, new o.U3(t > 0 ? i.$to : i.$from));
                    let n = eP(e.state, t);
                    return !!n && eA(e, n)
                }
            }
            ...
            function eK(e, t, n) {
                let i = e.state.selection;
                if (i instanceof o.U3 && !i.empty || n.indexOf("s") > -1 || A && n.indexOf("m") > -1) return !1;
                let {
                    $from: s,
                    $to: r
                } = i;
                if (!s.parent.inlineContent || e.endOfTextblock(t < 0 ? "up" : "down")) {
                    let n = eP(e.state, t);
                    if (n && n instanceof o.nh) return eA(e, n)
                }
            ...
            function eW(e, t) {
                ...
                let l = e.someProp("clipboardSerializer") || i.ZF.fromSchema(e.state.schema),
                    d = eX(),
            ...
            function eH(e, t, n, o, s) {
                ...
                if (a) {
                    if (e.someProp("transformPastedText", n => {
                            t = n(t, d || o, e)
                        }), d) return t ? new i.Ji(i.FK.from(e.state.schema.text(t.replace(/\r\n?/g, "\n"))), 0, 0) : i.Ji.empty;
                    ...
                    var t;
                    let n, o = /^(\s*<meta [^>]*>)*/.exec(e);
                    o && (e = e.slice(o[0].length));
                    let i = eX().createElement("div"),
                        s = /<([a-z][^>\s]+)/i.exec(e),
                        r;
                    if ((r = s && ej[s[1].toLowerCase()]) && (e = r.map(e => "<" + e + ">").join("") + e + r.map(e => "</" + e + ">").reverse().join("")), i.innerHTML = (t = e, (n = window.trustedTypes) ? (eY || (eY = n.defaultPolicy || n.createPolicy("ProseMirrorClipboard", {
                            createHTML: e => e
                        })), eY.createHTML(t)) : t), r)
                        for (let e = 0; e < r.length; e++) i = i.querySelector(r[e]) || i;
                    return i
                }(n), B && function(e) {
                ...
                if (l || (l = (e.someProp("clipboardParser") || e.someProp("domParser") || i.S4.fromSchema(e.state.schema)).parseSlice(r, {
                        preserveWhitespace: !!(a || h),
                        context: s,
                        ruleFromNode: e => "BR" != e.nodeName || e.nextSibling || !e.parentNode || eU.test(e.parentNode.nodeName) ? null : {
                            ignore: !0
                        }
                    })), h) l = function(e, t) {
                    if (!e.size) return e;
                    ...
                    for (let e = o.length - 2; e >= 0; e -= 2) {
                        ...
                        s = i.FK.from(t.create(o[e + 1], s)), r++, l++
                    }
                    return new i.Ji(s, r, l)
                }(eJ(l, +h[1], +h[2]), h[4]);
                else if ((l = i.Ji.maxOpen(function(e, t) {
                            ...
                            if (e.forEach(e => {
                                    ...
                                    if (n = r.length && s.length && function e(t, n, o, s, r) {
                                            if (r < t.length && r < n.length && t[r] == n[r]) {
                                                ...
                                                if (s.contentMatchAt(s.childCount).matchType(r == t.length - 1 ? o.type : t[r + 1])) return s.copy(s.content.append(i.FK.from(e_(o, t, r + 1))))
                                            }
            ...
            let eU = /^(a|abbr|acronym|b|cite|code|del|em|i|ins|kbd|label|output|q|ruby|s|samp|span|strong|sub|sup|time|u|tt|var)$/i;

            function e_(e, t, n = 0) {
                for (let o = t.length - 1; o >= n; o--) e = t[o].create(null, i.FK.from(e));
                return e
            }
            ...
            function eG(e, t, n, o, s, r) {
                let l = t < 0 ? e.firstChild : e.lastChild,
                    d = l.content;
                return e.childCount > 1 && (r = 0), s < o - 1 && (d = eG(d, t, n, o, s + 1, r)), s >= n && (d = t < 0 ? l.contentMatchAt(0).fillBefore(d, r <= s).append(d) : d.append(l.contentMatchAt(l.childCount).fillBefore(i.FK.empty, !0))), e.replaceChild(t < 0 ? 0 : e.childCount - 1, l.copy(d))
            }

            function eJ(e, t, n) {
                return t < e.openStart && (e = new i.Ji(eG(e.content, -1, t, e.openStart, 0, e.openEnd), t, e.openEnd)), n < e.openEnd && (e = new i.Ji(eG(e.content, 1, n, e.openEnd, 0, 0), e.openStart, n)), e
            }
            let ej = {
                    thead: ["table"],
                    tbody: ["table"],
            ...
            function eX() {
                return eZ || (eZ = document.implementation.createHTMLDocument("title"))
            }
            let eY = null,
                eQ = {},
                e0 = {},
            ...
            function e5(e) {
                e.someProp("handleDOMEvents", t => {
                    for (let n in t) e.input.eventHandlers[n] || e.dom.addEventListener(n, e.input.eventHandlers[n] = t => e6(e, t))
                })
            }
            ...
            e0.keydown = (e, t) => {
                if ((e.input.shiftKey = 16 == t.keyCode || t.shiftKey, !tt(e, t)) && (e.input.lastKeyCode = t.keyCode, e.input.lastKeyCodeTime = Date.now(), !R || !k || 13 != t.keyCode))
                    if (229 != t.keyCode && e.domObserver.forceFlush(), !P || 13 != t.keyCode || t.ctrlKey || t.altKey || t.metaKey) e.someProp("handleKeyDown", n => n(e, t)) || function(e, t) {
                        let n, o = t.keyCode,
                            i = (n = "", t.ctrlKey && (n += "c"), t.metaKey && (n += "m"), t.altKey && (n += "a"), t.shiftKey && (n += "s"), n);
                        if (8 == o || A && 72 == o && "c" == i) return eq(e, -1) || eF(e, -1);
                        if (46 == o && !t.shiftKey || A && 68 == o && "c" == i) return eq(e, 1) || eF(e, 1);
                        if (13 == o || 27 == o) return !0;
                        if (37 == o || A && 66 == o && "c" == i) {
                            let t = 37 == o ? "ltr" == eI(e, e.state.selection.from) ? -1 : 1 : -1;
                            return eV(e, t, i) || eF(e, t)
                        }
                        if (39 == o || A && 70 == o && "c" == i) {
                            let t = 39 == o ? "ltr" == eI(e, e.state.selection.from) ? 1 : -1 : 1;
                            return eV(e, t, i) || eF(e, t)
                        } else if (38 == o || A && 80 == o && "c" == i) return eK(e, -1, i) || eF(e, -1);
                        else if (40 == o || A && 78 == o && "c" == i) return function(e) {
                ...
                if (tt(e, t) || !t.charCode || t.ctrlKey && !t.altKey || A && t.metaKey) return;
                if (e.someProp("handleKeyPress", n => n(e, t))) return void t.preventDefault();
                let n = e.state.selection;
                if (!(n instanceof o.U3) || !n.$from.sameParent(n.$to)) {
            ...
            eQ.mousedown = (e, t) => {
                ...
                i - e.input.lastClick.time < 500 && function(e, t) {
                    let n = t.x - e.clientX,
                        o = t.y - e.clientY;
                    return n * n + o * o < 100
                }(t, e.input.lastClick) && !t[e7] && ("singleClick" == e.input.lastClick.type ? s = "doubleClick" : "doubleClick" == e.input.lastClick.type && (s = "tripleClick")), e.input.lastClick = {
                    time: i,
                    x: t.clientX,
                    y: t.clientY,
                    type: s
                };
                let r = e.posAtCoords(e8(t));
                r && ("singleClick" == s ? (e.input.mouseDown && e.input.mouseDown.done(), e.input.mouseDown = new te(e, r, t, !!n)) : ("doubleClick" == s ? function(e, t, n, o) {
                    return e9(e, "handleDoubleClickOn", t, n, o) || e.someProp("handleDoubleClick", n => n(e, t, o))
                } : function(e, t, n, i) {
                    return e9(e, "handleTripleClickOn", t, n, i) || e.someProp("handleTripleClick", n => n(e, t, i)) || function(e, t, n) {
                        if (0 != n.button) return !1;
                        let i = e.state.doc;
                        if (-1 == t) return !!i.inlineContent && (e4(e, o.U3.create(i, 0, i.content.size), "pointer"), !0);
                        let s = i.resolve(t);
                        for (let t = s.depth + 1; t > 0; t--) {
                            let n = t > s.depth ? s.nodeAfter : s.node(t),
                                r = s.before(t);
                            if (n.inlineContent) e4(e, o.U3.create(i, r + 1, r + 1 + n.content.size), "pointer");
                            else {
                                if (!o.nh.isSelectable(n)) continue;
                                e4(e, o.nh.create(i, r), "pointer")
                            }
                            return !0
                        }
                    }(e, n, i)
                })(e, r.pos, r.inside, t) ? t.preventDefault() : e2(e, "pointer"))
            };
            class te {
                constructor(e, t, n, i) {
                    let s, r;
                    if (this.view = e, this.pos = t, this.event = n, this.flushed = i, this.delayedSelectionSync = !1, this.mightDrag = null, this.startDoc = e.state.doc, this.selectNode = !!n[e7], this.allowDefault = n.shiftKey, t.inside > -1) s = e.state.doc.nodeAt(t.inside), r = t.inside;
                    else {
                    ...
                    (0 == n.button && s.type.spec.draggable && !1 !== s.type.spec.selectable || a instanceof o.nh && a.from <= r && a.to > r) && (this.mightDrag = {
                        node: s,
                        pos: r,
                    ...
                    }, 20), this.view.domObserver.start()), e.root.addEventListener("mouseup", this.up = this.up.bind(this)), e.root.addEventListener("mousemove", this.move = this.move.bind(this)), e2(e, "pointer")
                }
                done() {
                    this.view.root.removeEventListener("mouseup", this.up), this.view.root.removeEventListener("mousemove", this.move), this.mightDrag && this.target && (this.view.domObserver.stop(), this.mightDrag.addAttr && this.target.removeAttribute("draggable"), this.mightDrag.setUneditable && this.target.removeAttribute("contentEditable"), this.view.domObserver.start()), this.delayedSelectionSync && setTimeout(() => eD(this.view)), this.view.input.mouseDown = null
                }
                up(e) {
                    if (this.done(), !this.view.dom.contains(e.target)) return;
                    let t = this.pos;
                    if (this.view.state.doc != this.startDoc && (t = this.view.posAtCoords(e8(e))), this.updateAllowDefault(e), this.allowDefault || !t) e2(this.view, "pointer");
                    else {
                        var n, i, s, r;
                        (n = this.view, i = t.pos, s = t.inside, r = this.selectNode, e9(n, "handleClickOn", i, s, e) || n.someProp("handleClick", t => t(n, i, e)) || (r ? function(e, t) {
                            if (-1 == t) return !1;
                            let n = e.state.selection,
                                i, s;
                            n instanceof o.nh && (i = n.node);
                            ...
                            return null != s && (e4(e, o.nh.create(e.state.doc, s), "pointer"), !0)
                        }(n, s) : function(e, t) {
                            if (-1 == t) return !1;
                            let n = e.state.doc.resolve(t),
                                i = n.nodeAfter;
                            return !!(i && i.isAtom && o.nh.isSelectable(i)) && (e4(e, new o.nh(n), "pointer"), !0)
                        }(n, s))) ? e.preventDefault(): 0 == e.button && (this.flushed || E && this.mightDrag && !this.mightDrag.node.isAtom || k && !this.view.state.selection.visible && 2 >= Math.min(Math.abs(t.pos - this.view.state.selection.from), Math.abs(t.pos - this.view.state.selection.to))) ? (e4(this.view, o.LN.near(this.view.state.doc.resolve(t.pos)), "pointer"), e.preventDefault()) : e2(this.view, "pointer")
                    }
                }
                move(e) {
            ...
            eQ.touchstart = e => {
                e.input.lastTouch = Date.now(), ts(e), e2(e, "pointer")
            }, eQ.touchmove = e => {
                e.input.lastTouch = Date.now(), e2(e, "pointer")
            }, eQ.contextmenu = e => ts(e);
            let tn = R ? 5e3 : -1;

            function to(e, t) {
                clearTimeout(e.input.composingTimeout), t > -1 && (e.input.composingTimeout = setTimeout(() => ts(e), t))
            }
            ...
            function ts(e, t = !1) {
                if (!R || !(e.domObserver.flushingSoon >= 0)) {
                    if (e.domObserver.forceFlush(), ti(e), t || e.docView && e.docView.dirty) {
                        let n = ew(e);
            ...
            e0.compositionstart = e0.compositionupdate = e => {
                if (!e.composing) {
                    e.domObserver.flush();
                    let {
                        state: t
                    } = e, n = t.selection.$to;
                    if (t.selection instanceof o.U3 && (t.storedMarks || !n.textOffset && n.parentOffset && n.nodeBefore.marks.some(e => !1 === e.type.spec.inclusive))) e.markCursor = e.state.storedMarks || n.marks(), ts(e, !0), e.markCursor = null;
                    else if (ts(e, !t.selection.empty), M && t.selection.empty && n.parentOffset && !n.textOffset && n.nodeBefore.marks.length) {
                        let t = e.domSelectionRange();
                ...
                e.composing && (e.input.composing = !1, e.input.compositionEndedAt = t.timeStamp, e.input.compositionPendingChanges = e.domObserver.pendingRecords().length ? e.input.compositionID : 0, e.input.compositionNode = null, e.input.compositionPendingChanges && Promise.resolve().then(() => e.domObserver.flush()), e.input.compositionID++, to(e, 20))
            };
            let tr = S && O < 15 || P && F < 604;

            function tl(e, t, n, o, s) {
                let r = eH(e, t, n, o, e.state.selection.$from);
                if (e.someProp("handlePaste", t => t(e, s, r || i.Ji.empty))) return !0;
                if (!r) return !1;
            ...
            eQ.copy = e0.cut = (e, t) => {
                ...
                let n = tr ? null : t.clipboardData,
                    o = e.input.shiftKey && 45 != e.input.lastKeyCode;
                n && tl(e, td(n), n.getData("text/html"), o, t) ? t.preventDefault() : function(e, t) {
                    if (!e.dom.parentNode) return;
                    ...
                    setTimeout(() => {
                        e.focus(), o.parentNode && o.parentNode.removeChild(o), n ? tl(e, o.value, null, i, t) : tl(e, o.textContent, o.innerHTML, i, t)
                    }, 50)
                }(e, t)
            };
            class ta {
            ...
            let tc = A ? "altKey" : "ctrlKey";

            function th(e, t) {
                let n = e.someProp("dragCopies", e => !e(t));
                return null != n ? n : !t[tc]
            }
            for (let e in eQ.dragstart = (e, t) => {
                    let n, i = e.input.mouseDown;
                    if (i && i.done(), !t.dataTransfer) return;
                    let s = e.state.selection,
                        r = s.empty ? null : e.posAtCoords(e8(t));
                    if (r && r.pos >= s.from && r.pos <= (s instanceof o.nh ? s.to - 1 : s.to));
                    else if (i && i.mightDrag) n = o.nh.create(e.state.doc, i.mightDrag.pos);
                    else if (t.target && 1 == t.target.nodeType) {
                        let i = e.docView.nearestDesc(t.target, !0);
                        i && i.node.type.spec.draggable && i != e.docView && (n = o.nh.create(e.state.doc, i.posBefore))
                    }
                    ...
                    t.dataTransfer.files.length && k && !(T > 120) || t.dataTransfer.clearData(), t.dataTransfer.setData(tr ? "Text" : "text/html", d.innerHTML), t.dataTransfer.effectAllowed = "copyMove", tr || t.dataTransfer.setData("text/plain", a), e.dragging = new ta(c, th(e, t), n)
                }, eQ.dragend = e => {
                    let t = e.dragging;
                    window.setTimeout(() => {
                        e.dragging == t && (e.dragging = null)
                    }, 50)
                }, e0.dragover = e0.dragenter = (e, t) => t.preventDefault(), e0.drop = (e, t) => {
                    let n = e.dragging;
                    ...
                    d ? e.someProp("transformPasted", t => {
                        d = t(d, e)
                    }) : d = eH(e, td(t.dataTransfer), tr ? null : t.dataTransfer.getData("text/html"), !1, l);
                    let a = !!(n && th(e, t));
                    if (e.someProp("handleDrop", n => n(e, t, d || i.Ji.empty, a))) return void t.preventDefault();
                    if (!d) return;
                    t.preventDefault();
                    let c = d ? (0, s.Um)(e.state.doc, l.pos, d) : l.pos;
                    null == c && (c = l.pos);
                    let h = e.state.tr;
                    if (a) {
                        let {
                    ...
                    if (f && o.nh.isSelectable(d.content.firstChild) && m.nodeAfter && m.nodeAfter.sameMarkup(d.content.firstChild)) h.setSelection(new o.nh(m));
                    else {
            ...
            class tf {
                constructor(e, t) {
                    this.toDOM = e, this.spec = t || tb, this.side = this.spec.side || 0
                }
                map(e, t, n, o) {
                    let {
                        pos: i,
                ...
                eq(e) {
                    return this == e || e instanceof tf && (this.spec.key && this.spec.key == e.spec.key || this.toDOM == e.toDOM && tu(this.spec, e.spec))
                }
                destroy(e) {
            ...
            class tp {
                ...
                eq(e) {
                    return this == e || e instanceof tp && tu(this.attrs, e.attrs) && tu(this.spec, e.spec)
                }
                static is(e) {
                    return e.type instanceof tp
                }
                destroy() {}
            }
            class tm {
                ...
                map(e, t, n, o) {
                    ...
                    return s.deleted || s.pos <= i.pos ? null : new tg(i.pos - n, s.pos - n, this)
                }
                valid(e, t) {
                    let {
                        index: n,
                ...
                eq(e) {
                    return this == e || e instanceof tm && tu(this.attrs, e.attrs) && tu(this.spec, e.spec)
                }
                destroy() {}
            }
            class tg {
                ...
                static widget(e, t, n) {
                    return new tg(e, e, new tf(t, n))
                }
                static inline(e, t, n, o) {
                    return new tg(e, t, new tp(n, o))
                }
                static node(e, t, n, o) {
                    return new tg(e, t, new tm(n, o))
                }
                get spec() {
            ...
            class tw {
                constructor(e, t) {
                    this.local = e.length ? e : ty, this.children = t.length ? t : ty
                }
                static create(e, t) {
                    return t.length ? tO(t, e, 0, tb) : tv
                }
                find(e, t, n) {
                    let o = [];
                ...
                map(e, t, n) {
                    return this == tv || 0 == e.maps.length ? this : this.mapInner(e, t, 0, 0, n || tb)
                }
                mapInner(e, t, n, o, i) {
                    let s;
                    ...
                    return this.children.length ? function(e, t, n, o, i, s, r) {
                        ...
                        for (let t = 0; t < l.length; t += 3)
                            if (l[t + 1] < 0) {
                                ...
                                if (p && f == c && f + p.nodeSize == h) {
                                    ...
                                    o != tv ? (l[t] = c, l[t + 1] = h, l[t + 2] = o) : (l[t + 1] = -2, d = !0)
                                } else d = !0
                            }
                        if (d) {
                            let d = tO(function(e, t, n, o, i, s, r) {
                        ...
                        return new tw(t.sort(tM), l)
                    }(this.children, s || [], e, t, n, o, i) : s ? new tw(s.sort(tM), ty) : tv
                }
                add(e, t) {
                    return t.length ? this == tv ? tw.create(e, t) : this.addInner(e, t, 0) : this
                }
                addInner(e, t, n) {
                    let o, i = 0;
                    e.forEach((e, s) => {
                        ...
                        if (l = tC(t, e, r)) {
                            ...
                            o[i] == s ? o[i + 2] = o[i + 2].addInner(e, l, r + 1) : o.splice(i, 0, s, s + e.nodeSize, tO(l, e, r + 1, tb)), i += 3
                        }
                    });
                    let s = tN(i ? tS(t) : t, -n);
                    for (let t = 0; t < s.length; t++) s[t].type.valid(e, s[t]) || s.splice(t--, 1);
                    return new tw(s.length ? this.local.concat(s).sort(tM) : this.local, o || this.children)
                }
                remove(e) {
                    return 0 == e.length || this == tv ? this : this.removeInner(e, 0)
                }
                removeInner(e, t) {
                    let n = this.children,
                        o = this.local;
                    ...
                    return n == this.children && o == this.local ? this : o.length || n.length ? new tw(o, n) : tv
                }
                forChild(e, t) {
                    let n, o;
                    if (this == tv) return this;
                    if (t.isLeaf) return tw.empty;
                    ...
                    for (let e = 0; e < this.local.length; e++) {
                        let t = this.local[e];
                        if (t.from < s && t.to > i && t.type instanceof tp) {
                    ...
                    if (o) {
                        let e = new tw(o.sort(tM), ty);
                        return n ? new tD([e, n]) : e
                    }
                    return n || tv
                }
                eq(e) {
                    if (this == e) return !0;
                    if (!(e instanceof tw) || this.local.length != e.local.length || this.children.length != e.children.length) return !1;
                ...
                locals(e) {
                    return tx(this.localsInner(e))
                }
                localsInner(e) {
                    if (this == tv) return ty;
                    if (e.inlineContent || !this.local.some(tp.is)) return this.local;
                    let t = [];
                    for (let e = 0; e < this.local.length; e++) this.local[e].type instanceof tp || t.push(this.local[e]);
                    return t
                }
                forEachSet(e) {
                    e(this)
            ...
            tw.empty = new tw([], []), tw.removeOverlap = tx;
            let tv = tw.empty;
            class tD {
                constructor(e) {
                    this.members = e
                ...
                map(e, t) {
                    let n = this.members.map(n => n.map(e, t, tb));
                    return tD.from(n)
                }
                forChild(e, t) {
                    if (t.isLeaf) return tw.empty;
                    ...
                    for (let o = 0; o < this.members.length; o++) {
                        ...
                        i != tv && (i instanceof tD ? n = n.concat(i.members) : n.push(i))
                    }
                    return tD.from(n)
                }
                eq(e) {
                    if (!(e instanceof tD) || e.members.length != this.members.length) return !1;
                ...
                static from(e) {
                    switch (e.length) {
                        ...
                        case 1:
                            return e[0];
                        default:
                            return new tD(e.every(e => e instanceof tw) ? e : e.reduce((e, t) => e.concat(t instanceof tw ? t : t.members), []))
                    }
                }
                forEachSet(e) {
            ...
            function tO(e, t, n, o) {
                ...
                t.forEach((t, r) => {
                    ...
                    if (l) {
                        s = !0;
                        let e = tO(l, t, n + r + 1, o);
                        e != tv && i.push(r, r + t.nodeSize, e)
                    }
                });
                let r = tN(s ? tS(e) : e, -n).sort(tM);
                for (let e = 0; e < r.length; e++) r[e].type.valid(t, r[e]) || (o.onRemove && o.onRemove(r[e].spec), r.splice(e--, 1));
                return r.length || i.length ? new tw(r, i) : tv
            }
                ...
                for (let n = 0; n < t.length - 1; n++) {
                    ...
                    if (o.from != o.to)
                        for (let i = n + 1; i < t.length; i++) {
                            let s = t[i];
                            if (s.from == o.from) {
                                s.to != o.to && (t == e && (t = e.slice()), t[i] = s.copy(s.from, o.to), tk(t, i + 1, s.copy(o.to, s.to)));
                                continue
                            }
                            s.from < o.to && (t == e && (t = e.slice()), t[n] = o.copy(o.from, s.from), tk(t, i, o.copy(s.from, o.to)));
                            break
                        }
                }
                return t
            ...
            function tT(e) {
                ...
                return e.someProp("decorations", n => {
                    let o = n(e.state);
                    o && o != tv && t.push(o)
                }), e.cursorWrapper && t.push(tw.create(e.state.doc, [e.cursorWrapper.deco])), tD.from(t)
            }
            let tE = {
                    childList: !0,
                    characterData: !0,
            ...
            class tV {
                constructor(e, t) {
                    this.view = e, this.handleDOMChange = t, this.queue = [], this.flushingSoon = -1, this.observer = null, this.currentSelection = new tA, this.onCharData = null, this.suppressingSelectionUpdates = !1, this.lastChangedTextNode = null, this.observer = window.MutationObserver && new window.MutationObserver(e => {
                        for (let t = 0; t < e.length; t++) this.queue.push(e[t]);
                        S && O <= 11 && e.some(e => "childList" == e.type && e.removedNodes.length || "characterData" == e.type && e.oldValue.length > e.target.nodeValue.length) ? this.flushSoon() : this.flush()
                    }), tP && (this.onCharData = e => {
                        this.queue.push({
                            target: e.target,
                            type: "characterData",
                ...
                flush() {
                    ...
                    let i = t.domSelectionRange(),
                        s = !this.suppressingSelectionUpdates && !this.currentSelection.eq(i) && eT(t) && !this.ignoreSelectionChange(i),
                        r = -1,
                        l = -1,
                        d = !1,
                        a = [];
                    if (t.editable)
                        for (let e = 0; e < n.length; e++) {
                            let t = this.registerMutation(n[e], a);
                            t && (r = r < 0 ? t.from : Math.min(t.from, r), l = l < 0 ? t.to : Math.max(t.to, l), t.typeOver && (d = !0))
                        }
                    if (M && a.length) {
                        ...
                        if (2 == e.length) {
                            ...
                            for (let o of e) {
                                let e = o.parentNode;
                                e && "LI" == e.nodeName && (!n || function(e, t) {
            ...
            function tF(e, t) {
                ...
                return h(r.node, r.offset, i, s) && ([n, o, i, s] = [i, s, n, o]), {
                    anchorNode: n,
                    anchorOffset: o,
                    focusNode: i,
                    focusOffset: s
            ...
            function tL(e) {
                ...
                if ("BR" == e.nodeName && e.parentNode) {
                    ...
                    } else if (e.parentNode.lastChild == e || E && /^(tr|table)$/i.test(e.parentNode.nodeName)) return {
                        ignore: !0
                    }
            ...
            let tz = /^(a|abbr|acronym|b|bd[io]|big|br|button|cite|code|data(list)?|del|dfn|em|i|ins|kbd|label|map|mark|meter|output|q|ruby|s|samp|small|span|strong|su[bp]|time|u|tt|var)$/i;
            ...
            class t$ {
                    ...
                    this._root = null, this.focused = !1, this.trackWrites = null, this.mounted = !1, this.markCursor = null, this.cursorWrapper = null, this.lastSelectedViewDesc = void 0, this.input = new e3, this.prevDirectPlugins = [], this.pluginViews = [], this.requiresGeckoHackNode = !1, this.dragging = null, this._props = t, this.state = t.state, this.directPlugins = t.plugins || [], this.directPlugins.forEach(tG), this.dispatch = this.dispatch.bind(this), this.dom = e && e.mount || document.createElement("div"), e && (e.appendChild ? e.appendChild(this.dom) : "function" == typeof e ? e(this.dom) : e.mount && (this.mounted = !0)), this.editable = tU(this), tH(this), this.nodeViews = t_(this), this.docView = es(this.state.doc, tW(this), tT(this), this.dom, this), this.domObserver = new tV(this, (e, t, n, s) => (function(e, t, n, s, r) {
                            ...
                            let N = function(e, t, n, o, i) {
                                ...
                                if (r < s && e.size < t.size) {
                                    let e = o <= s && o >= r ? s - o : 0;
                                    (s -= e) && s < t.size && tq(t.textBetween(s - 1, s + 1)) && (s += e ? 1 : -1), l = s + (l - r), r = s
                                } else if (l < s) {
                                    let t = o <= s && o >= l ? s - o : 0;
                                    (s -= t) && s < e.size && tq(e.textBetween(s - 1, s + 1)) && (s += t ? 1 : -1), r = s + (r - l), l = s
                                }
                                return {
                                    start: s,
                                    endA: r,
                            ...
                            }(D.content, w.doc.content, w.from, l, d);
                            if (N && e.input.domChangeCount++, (P && e.input.lastIOSEnter > Date.now() - 225 || R) && r.some(e => 1 == e.nodeType && !tz.test(e.nodeName)) && (!N || N.endA >= N.endB) && e.someProp("handleKeyDown", t => t(e, y(13, "Enter")))) {
                                e.input.lastIOSEnter = 0;
                                return
                            }
                            if (!N)
                                if (s && b instanceof o.U3 && !b.empty && b.$head.sameParent(b.$anchor) && !e.composing && !(w.sel && w.sel.anchor != w.sel.head)) N = {
                                    start: b.from,
                                    endA: b.to,
                                    endB: b.to
                                };
                            ...
                            e.state.selection.from < e.state.selection.to && N.start == N.endB && e.state.selection instanceof o.U3 && (N.start > e.state.selection.from && N.start <= e.state.selection.from + 2 && e.state.selection.from >= w.from ? N.start = e.state.selection.from : N.endA < e.state.selection.to && N.endA >= e.state.selection.to - 2 && e.state.selection.to <= w.to && (N.endB += e.state.selection.to - N.endA, N.endA = e.state.selection.to)), S && O <= 11 && N.endB == N.start + 1 && N.endA == N.start && N.start > w.from && " \xa0" == w.doc.textBetween(N.start - w.from - 1, N.start - w.from + 1) && (N.start--, N.endA--, N.endB--);
                            let C = w.doc.resolveNoCache(N.start - w.from),
                                M = w.doc.resolveNoCache(N.endB - w.from),
                                x = v.resolve(N.start),
                                T = C.sameParent(M) && C.parent.inlineContent && x.end() >= N.endA;
                            if ((P && e.input.lastIOSEnter > Date.now() - 225 && (!T || r.some(e => "DIV" == e.nodeName || "P" == e.nodeName)) || !T && C.pos < w.doc.content.size && (!C.sameParent(M) || !C.parent.inlineContent) && !/\S/.test(w.doc.textBetween(C.pos, M.pos, "", "")) && (a = o.LN.findFrom(w.doc.resolve(C.pos + 1), 1, !0)) && a.head > C.pos) && e.someProp("handleKeyDown", t => t(e, y(13, "Enter")))) {
                                e.input.lastIOSEnter = 0;
                                return
                            }
                            if (e.state.selection.anchor > N.start && function(e, t, n, o, i) {
                                    if (n - t <= i.pos - o.pos || tK(o, !0, !1) < i.pos) return !1;
                                    let s = e.resolve(t);
                                    ...
                                    let r = e.resolve(tK(s, !0, !0));
                                    return !(!r.parent.isTextblock || r.pos > n || tK(r, !0, !1) < n) && o.parent.content.cut(o.parentOffset).eq(r.parent.content)
                                }(v, N.start, N.endA, C, M) && e.someProp("handleKeyDown", t => t(e, y(8, "Backspace")))) {
                                R && k && e.domObserver.suppressSelectionUpdates();
                                return
                            }
                            k && N.endB == N.start && (e.input.lastChromeDelete = Date.now()), R && !T && C.start() != M.start() && 0 == M.parentOffset && C.depth == M.depth && w.sel && w.sel.anchor == w.sel.head && w.sel.head == N.endA && (N.endB -= 2, M = w.doc.resolveNoCache(N.endB - w.from), setTimeout(() => {
                            ...
                            let E = N.start,
                                A = N.endA;
                            if (T) {
                                if (C.pos == M.pos) S && O <= 11 && 0 == C.parentOffset && (e.domObserver.suppressSelectionUpdates(), setTimeout(() => eD(e), 20)), c = e.state.tr.delete(E, A), h = v.resolve(N.start).marksAcross(v.resolve(N.endA));
                                else if (N.endA == N.endB && (u = function(e, t) {
                                        ...
                                        if (i.FK.from(c).eq(e)) return {
                                            mark: d,
                                            type: l
                                        }
                                    }(C.parent.content.cut(C.parentOffset, M.parentOffset), x.parent.content.cut(x.parentOffset, N.endA - x.start())))) c = e.state.tr, "add" == u.type ? c.addMark(E, A, u.mark) : c.removeMark(E, A, u.mark);
                            ...
                            if (c || (c = e.state.tr.replace(E, A, w.doc.slice(N.start - w.from, N.endB - w.from))), w.sel) {
                                let t = tI(e, c.doc, w.sel);
                                t && !(k && e.composing && t.empty && (N.start != N.endB || e.input.lastChromeDelete < Date.now() - 100) && (t.head == E || t.head == c.mapping.map(A) - 1) || S && t.empty && t.head == E) && c.setSelection(t)
                            }
                            ...
                            for (let t in eQ) {
                                ...
                                e.dom.addEventListener(t, e.input.eventHandlers[t] = t => {
                                    ! function(e, t) {
                                        ...
                                        return !0
                                    }(e, t) || e6(e, t) || !e.editable && t.type in e0 || n(e, t)
                                }, e1[t] ? {
                                    passive: !0
                                } : void 0)
                            }
                            E && e.dom.addEventListener("input", () => null), e5(e)
                ...
                update(e) {
                    ...
                    let t = this._props;
                    this._props = e, e.plugins && (e.plugins.forEach(tG), this.directPlugins = e.plugins), this.updateStateInner(e.state, t)
                }
                setProps(e) {
                    let t = {};
                ...
                updateStateInner(e, t) {
                    ...
                    let s = this.state,
                        l = !1,
                        d = !1;
                    e.storedMarks && this.composing && (ti(this), d = !0), this.state = e;
                    ...
                    }(a || t.handleDOMEvents != this._props.handleDOMEvents) && e5(this), this.editable = tU(this), tH(this);
                    let c = tT(this),
                        u = tW(this),
                    ...
                    let y = "preserve" == f && d && null == this.dom.style.overflowAnchor && function(e) {
                    ...
                    if (d) {
                        ...
                        let a = g && (S || k) && !this.composing && !s.selection.empty && !e.selection.empty && (o = s.selection, i = e.selection, d = Math.min(o.$anchor.sharedDepth(o.head), i.$anchor.sharedDepth(i.head)), o.$anchor.start(d) != i.$anchor.start(d));
                        if (g) {
                            ...
                            this.composing && (this.input.compositionNode = function(e) {
                                ...
                                return n || o
                            }(this)), (l || !this.docView.update(e.doc, u, c, this)) && (this.docView.updateOuterDeco(u), this.docView.destroy(), this.docView = es(e.doc, u, c, this.dom, this)), t && !this.trackWrites && (a = !0)
                        }
                        a || !(this.input.mouseDown && this.domObserver.currentSelection.eq(this.domSelectionRange()) && (t = this.docView.domFromPos(this.state.selection.anchor, 0), n = this.domSelectionRange(), h(t.node, t.offset, n.anchorNode, n.anchorOffset))) ? eD(this, a) : (eM(this, e.selection), this.domObserver.setCurSelection()), this.domObserver.start()
                    }
                    this.updatePluginViews(s), (null == (n = this.dragging) ? void 0 : n.node) && !s.doc.eq(e.doc) && this.updateDraggedNode(this.dragging, s), "reset" == f ? this.dom.scrollTop = 0 : "to selection" == f ? this.scrollToSelection() : y && function({
                        refDOM: e,
                        refTop: t,
                        stack: n
                    }) {
                ...
                updateDraggedNode(e, t) {
                    ...
                    this.dragging = new ta(e.slice, e.move, i < 0 ? void 0 : o.nh.create(this.state.doc, i))
                }
                someProp(e, t) {
                ...
                focus() {
                    ...
                    }(this.dom), eD(this), this.domObserver.start()
                }
                get root() {
                    let e = this._root;
                    if (null == e) {
                ...
                posAtCoords(e) {
                    return function(e, t) {
                        ...
                        let o, i, s = e.dom.ownerDocument,
                            ...
                            c = function(e, t, n) {
                                if (e.caretPositionFromPoint) try {
                                    ...
                                    if (o) return {
                                        node: o.offsetNode,
                                        offset: Math.min(p(o.offsetNode), o.offset)
                                    }
                                } catch (e) {}
                                if (e.caretRangeFromPoint) {
                                    ...
                                    if (o) return {
                                        ...
                                        offset: Math.min(p(o.startContainer), o.startOffset)
                                    }
                                }
                            }(s, t.left, t.top);
                        c && ({
                        ...
                        if (h = (o = (n = h).parentNode) && /^li$/i.test(o.nodeName) && t.left < n.getBoundingClientRect().left ? o : n, r) {
                            ...
                            B && d && 1 == r.nodeType && 1 == (n = r.childNodes[d - 1]).nodeType && "false" == n.contentEditable && n.getBoundingClientRect().top >= t.top && d--, r == e.dom && d == r.childNodes.length - 1 && 1 == r.lastChild.nodeType && t.top > r.lastChild.getBoundingClientRect().bottom ? i = e.state.doc.content.size : (0 == d || 1 != r.nodeType || "BR" != r.childNodes[d - 1].nodeName) && (i = function(e, t, n, o) {
                                let i = -1;
                                for (let n = t, s = !1; n != e.dom;) {
                                    let t = e.docView.nearestDesc(n, !0),
                                        r;
                                    if (!t) return null;
                                    if (1 == t.dom.nodeType && (t.node.isBlock && t.parent || !t.contentDOM) && ((r = t.dom.getBoundingClientRect()).width || r.height) && (t.node.isBlock && t.parent && (!s && r.left > o.left || r.top > o.top ? i = t.posBefore : (!s && r.right < o.left || r.bottom < o.top) && (i = t.posAfter), s = !0), !t.contentDOM && i < 0 && !t.node.isText)) return (t.node.isBlock ? o.top < (r.top + r.bottom) / 2 : o.left < (r.left + r.right) / 2) ? t.posBefore : t.posAfter;
                                    n = t.dom.parentNode
                                }
                        ...
                        null == i && (i = function(e, t, n) {
                            let {
                                ...
                                for (let e = t.firstChild, u = 0; e; e = e.nextSibling, u++) {
                                    ...
                                    for (let a = 0; a < t.length; a++) {
                                        ...
                                        if (f.top <= c && f.bottom >= h) {
                                            ...
                                            if (t < r) {
                                                s = e, r = t, l = t && 3 == s.nodeType ? {
                                                    left: f.right < n.left ? f.right : f.left,
                                                    top: n.top
                                                } : n, 1 == e.nodeType && t && (d = u + +(n.left >= (f.left + f.right) / 2));
                                                continue
                                            }
                                        } else f.top > n.top && !o && f.left <= n.left && f.right >= n.left && (o = e, i = {
                                ...
                                return (!s && o && (s = o, l = i, r = 0), s && 3 == s.nodeType) ? function(e, t) {
                                    let n = e.nodeValue.length,
                                        o = document.createRange();
                                    for (let i = 0; i < n; i++) {
                                        o.setEnd(e, i + 1), o.setStart(e, i);
                                        let n = H(o, 1);
                                        if (n.top != n.bottom && $(t, n)) return {
                                            node: e,
                                            offset: i + +(t.left >= (n.left + n.right) / 2)
                                        }
                                    }
                                    return {
                                        node: e,
                ...
                endOfTextblock(e, t) {
                    return function(e, t, n) {
                        let o, i;
                        return X == t && Y == n ? Q : (X = t, Y = n, Q = "up" == n || "down" == n ? (o = t.selection, i = "up" == n ? o.$from : o.$to, j(e, t, () => {
                            let {
                                node: t
                            ...
                            for (let e = t.firstChild; e; e = e.nextSibling) {
                                ...
                                for (let e = 0; e < t.length; e++) {
                                    let i = t[e];
                                    if (i.bottom > i.top + 1 && ("up" == n ? o.top - i.top > (i.bottom - o.top) * 2 : i.bottom - o.bottom > (o.bottom - i.top) * 2)) return !1
                                }
                            }
                            return !0
                        })) : function(e, t, n) {
                            ...
                            let i = o.parentOffset,
                                ...
                                r = e.domSelection();
                            return r ? Z.test(o.parent.textContent) && r.modify ? j(e, t, () => {
                                let {
                                    focusNode: t,
                                    focusOffset: i,
                                    anchorNode: s,
                                    anchorOffset: l
                                } = e.domSelectionRange(), d = r.caretBidiLevel;
                ...
                destroy() {
                    if (this.docView) {
                        for (let e in this.domObserver.stop(), this.input.eventHandlers) this.dom.removeEventListener(e, this.input.eventHandlers[e]);
                        clearTimeout(this.input.composingTimeout), clearTimeout(this.input.lastIOSEnterFallbackTimeout), this.destroyPluginViews(), this.mounted ? (this.docView.update(this.state.doc, [], tT(this), this), this.dom.textContent = "") : this.dom.parentNode && this.dom.parentNode.removeChild(this.dom), this.docView.destroy(), this.docView = null, c()
                    }
                }
                get isDestroyed() {
                ...
                dispatchEvent(e) {
                    !e6(this, e) && eQ[e.type] && (this.editable || !(e.type in e0)) && eQ[e.type](this, e)
                }
                dispatch(e) {
                ...
                domSelectionRange() {
                    ...
                    return e ? E && 11 === this.root.nodeType && function(e) {
                        ...
                        return e.dom.addEventListener("beforeinput", o, !0), document.execCommand("indent"), e.dom.removeEventListener("beforeinput", o, !0), n ? tF(e, n) : null
                    }(this, e) || e : {
                        focusNode: null,
                        focusOffset: 0,
                        anchorNode: null,
            ...
            function tW(e) {
                ...
                }), t.translate || (t.translate = "no"), [tg.node(0, e.state.doc.content.size, t)]
            }
...
//# sourceMappingURL=96c0f419-c92bfee70d655207.js.map