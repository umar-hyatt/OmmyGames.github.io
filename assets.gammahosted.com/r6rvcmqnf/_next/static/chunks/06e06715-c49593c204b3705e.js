    ...
    [6953], {
        73772: (e, t, n) => {
                    ...
                    if (null != n) {
                        ...
                        try {
                            if (i = (n = n.call(e)).next, 0 === t) {
                                ...
                                for (; !(l = (o = i.call(n)).done) && (a.push(o.value), a.length !== t); l = !0);
                        } catch (e) {
                            c = !0, r = e
                        } finally {
                            try {
            ...
            function d(e) {
                ...
                return function() {
                    var n, o = f(e);
                    return n = t ? Reflect.construct(o, arguments, f(this).constructor) : o.apply(this, arguments),
                        function(e, t) {
            ...
            var g = n(48432),
                ...
                O = function(e, t, n, o) {
                    return n && (M(e, t, n, o, -1) || M(e, t, n, o, 1))
                },
                C = /^(img|br|input|textarea|hr)$/i;
            ...
            function M(e, t, n, o, r) {
                for (;;) {
                    ...
                    if (t == (r < 0 ? 0 : x(e))) {
                        var i = e.parentNode;
                        if (!i || 1 != i.nodeType || T(e) || C.test(e.nodeName) || "false" == e.contentEditable) return !1;
                        t = k(e) + (r < 0 ? 0 : 1), e = i
                    } else {
            ...
            var A = "undefined" != typeof navigator ? navigator : null,
                ...
                F = !!(z || I || B),
                L = z ? document.documentMode : I ? +I[1] : B ? +B[1] : 0,
                q = !F && /gecko\/(\d+)/i.test(R);
            q && (/Firefox\/(\d+)/.exec(R) || [0, 0])[1];
            var K = !F && /Chrome\/(\d+)/.exec(R),
                $ = !!K,
                _ = K ? +K[1] : 0,
                W = !F && !!A && /Apple Computer/.test(A.vendor),
            ...
            function Q(e, t, n) {
                for (var o = e.someProp("scrollThreshold") || 0, r = e.someProp("scrollMargin") || 5, i = e.dom.ownerDocument, s = n || e.dom; s;) {
                    if (1 != s.nodeType) {
                        s = w(s);
                        continue
                    }
                    var a = s,
                        ...
                        d = 0,
                        u = 0;
                    if (t.top < c.top + J(o, "top") ? u = -(c.top - t.top + J(r, "top")) : t.bottom > c.bottom - J(o, "bottom") && (u = t.bottom - t.top > c.bottom - c.top ? t.top + J(r, "top") - c.top : t.bottom - c.bottom + J(r, "bottom")), t.left < c.left + J(o, "left") ? d = -(c.left - t.left + J(r, "left")) : t.right > c.right - J(o, "right") && (d = t.right - c.right + J(r, "right")), d || u)
                    ...
                    var v = l ? "fixed" : getComputedStyle(s).position;
                    if (/^(fixed|sticky)$/.test(v)) break;
                    s = "absolute" == v ? s.offsetParent : w(s)
                }
            }
            ...
            function er(e, t) {
                ...
                return Array.prototype.find.call(n, eo) || e.getBoundingClientRect()
            }
            var ei = /[\u0590-\u05f4\u0600-\u06ff\u0700-\u08ac]/;
            ...
            function es(e, t, n) {
                var o = e.docView.domFromPos(t, n < 0 ? -1 : 1),
                    ...
                    a = X || q;
                if (3 == r.nodeType)
                    if (a && (ei.test(r.nodeValue) || (n < 0 ? !i : i == r.nodeValue.length))) {
                        var l = er(D(r, i, i), n);
                        if (q && i && /\s/.test(r.nodeValue[i - 1]) && i < r.nodeValue.length) {
                            var c = er(D(r, i - 1, i - 1), -1);
                            if (c.top == l.top) {
                                var d = er(D(r, i, i + 1), -1);
                                if (d.top != l.top) return ea(d, d.left < c.left)
                            }
                        }
                        return l
                    } else {
                        var u = i,
                            f = i,
                            h = n < 0 ? 1 : -1;
                        return n < 0 && !i ? (f++, h = -1) : n >= 0 && i == r.nodeValue.length ? (u--, h = 1) : n < 0 ? u-- : f++, ea(er(D(r, u, f), h), h < 0)
                    }
                if (!e.state.doc.resolve(t - (s || 0)).parent.inlineContent) {
                    if (null == s && i && (n < 0 || i == x(r))) {
                        var p = r.childNodes[i - 1];
                        if (1 == p.nodeType) return el(p.getBoundingClientRect(), !1)
                    }
                    if (null == s && i < x(r)) {
                        var m = r.childNodes[i];
                        if (1 == m.nodeType) return el(m.getBoundingClientRect(), !0)
                    }
                    return el(r.getBoundingClientRect(), n >= 0)
                }
                if (null == s && i && (n < 0 || i == x(r))) {
                    var v = r.childNodes[i - 1],
                        g = 3 == v.nodeType ? D(v, x(v) - !a) : 1 != v.nodeType || "BR" == v.nodeName && v.nextSibling ? null : v;
                    if (g) return ea(er(g, 1), !1)
                }
                if (null == s && i < x(r)) {
                    for (var y = r.childNodes[i]; y.pmViewDesc && y.pmViewDesc.ignoreForCoords;) y = y.nextSibling;
                    var b = y ? 3 == y.nodeType ? D(y, 0, +!a) : 1 == y.nodeType ? y : null : null;
                    if (b) return ea(er(b, -1), !0)
                }
                return ea(er(3 == r.nodeType ? D(r) : r, -n), n >= 0)
            }
            ...
            var ed = /[\u0590-\u08ac]/,
                ...
                ep = function() {
                    ...
                    return v(e, [{
                        ...
                        value: function(e, t) {
                            ...
                            for (; n && !(a = this.children[n - 1]).size && a instanceof em && a.side >= 0; n--);
                            if (t <= 0) {
                                for (var a, l, c = !0;
                                    (l = n ? this.children[n - 1] : null) && l.dom.parentNode != this.contentDOM; n--, c = !1);
                            ...
                            for (var d, u = !0;
                                (d = n < this.children.length ? this.children[n] : null) && d.dom.parentNode != this.contentDOM; n++, u = !1);
                        ...
                        value: function(e, t, n) {
                            ...
                            if ((q || W) && e == t) {
                                ...
                                if (3 == v.nodeType) {
                                    ...
                                    p = S && ("BR" == S.nodeName || "false" == S.contentEditable)
                                }
                            }
                            if (q && h.focusNode && h.focusNode != u.node && 1 == h.focusNode.nodeType) {
                                var D = h.focusNode.childNodes[h.focusOffset];
                                D && "false" == D.contentEditable && (o = !0)
                            }
                            if (!(!(o || p && W) && O(d.node, d.offset, h.anchorNode, h.anchorOffset) && O(u.node, u.offset, h.focusNode, h.focusOffset))) {
                                var N = !1;
                                if ((f.extend || e == t) && !p) {
                                ...
                                if (!N) {
                                    ...
                                    M.setEnd(u.node, u.offset), M.setStart(d.node, d.offset), f.removeAllRanges(), f.addRange(M)
                                }
                            }
                        }
                    }, {
                ...
                em = function(e) {
                    ...
                    function n(e, o, r, i) {
                        ...
                        return (s = t.call(this, e, [], l, null)).widget = o, s.widget = o, a = u(s), s
                    }
                    return v(n, [{
                        key: "matchesWidget",
                        value: function(e) {
                        ...
                        key: "destroy",
                        value: function() {
                            this.widget.type.destroy(this.dom), a(f(n.prototype), "destroy", this).call(this)
                        }
                    }, {
                        key: "domAtom",
                        get: function() {
                ...
                eg = function(e) {
                    ...
                    function n(e, o, r, i, s) {
                        var a;
                        return p(this, n), (a = t.call(this, e, [], r, i)).mark = o, a.spec = s, a
                    }
                    return v(n, [{
                        key: "parseRule",
                        value: function() {
                        ...
                        key: "markDirty",
                        value: function(e, t) {
                            if (a(f(n.prototype), "markDirty", this).call(this, e, t), 0 != this.dirty) {
                        ...
                        value: function(e, t, o) {
                            var r = n.create(this.parent, this.mark, !0, o),
                                i = this.children,
                                s = this.size;
                            t < s && (i = eA(i, t, s, o)), e > 0 && (i = eA(i, 0, e, o));
                        ...
                        key: "ignoreMutation",
                        value: function(e) {
                            return this.spec.ignoreMutation ? this.spec.ignoreMutation(e) : a(f(n.prototype), "ignoreMutation", this).call(this, e)
                        }
                    }, {
                        key: "destroy",
                        value: function() {
                            this.spec.destroy && this.spec.destroy(), a(f(n.prototype), "destroy", this).call(this)
                        }
                    }], [{
                        key: "create",
                        value: function(e, t, o, r) {
                            var i = r.nodeViews[t.type.name],
                                s = i && i(t, r, o);
                            return s && s.dom || (s = y.DOMSerializer.renderSpec(document, t.type.spec.toDOM(t, o), null, t.attrs)), new n(e, t, s.dom, s.contentDOM || s.dom, s)
                        }
                    }]), n
                }(ep),
                ey = function(e) {
                    ...
                    return v(n, [{
                        ...
                        key: "matchesNode",
                        value: function(e, t, n) {
                            return 0 == this.dirty && e.eq(this.node) && ex(t, this.outerDeco) && n.eq(this.innerDeco)
                        }
                    }, {
                        key: "size",
                        get: function() {
                        ...
                        value: function(e, t) {
                            ...
                            (function(e, t, n, o) {
                                ...
                                for (var l = 0, c = [], d = null, u = 0;;) {
                                    ...
                                    if (v.isText) {
                                        ...
                                        for (; l < r.length && r[l].to < b;) l++;
                                    var S = v.isInline && !v.isLeaf ? c.filter(function(e) {
                                        return !e.inline
                                    }) : c.slice();
                            ...
                            }), l.syncToMarks([], o, e), this.node.isTextblock && l.addTextblockHacks(), l.destroyRest(), (l.changed || 2 == this.dirty) && (s && this.protectLocalComposition(e, s), function e(t, n, o) {
                            ...
                            }(this.contentDOM, this.children, e), H && function(e) {
                        ...
                        value: function(e, t) {
                            ...
                            if (!this.getDesc(n)) {
                                ...
                                var s = new ev(this, i, n, r);
                                e.input.compositionNodes.push(s), this.children = eA(this.children, o, o + r.length, e, s)
                            }
                        }
                    }, {
                        key: "update",
                        ...
                        key: "updateOuterDeco",
                        value: function(e) {
                            if (!ex(e, this.outerDeco)) {
                                var t = 1 != this.nodeDOM.nodeType,
                                    n = this.dom;
                                this.dom = eC(this.dom, this.nodeDOM, eO(this.outerDeco, this.node, t), eO(e, this.node, t)), this.dom != n && (n.pmViewDesc = void 0, this.dom.pmViewDesc = this), this.outerDeco = e
                            }
                        }
                    }, {
                        key: "selectNode",
                        ...
                        value: function(e, t, o, r, i, s) {
                            ...
                            if (t.isText)
                                ...
                                var f = y.DOMSerializer.renderSpec(document, t.type.spec.toDOM(t), null, t.attrs);
                            ...
                            var h = d;
                            return (d = eM(d, o, t), c) ? a = new eS(e, t, o, r, d, u || null, h, c, i, s + 1) : t.isText ? new ek(e, t, o, r, d, h, i) : new n(e, t, o, r, d, u || null, h, i, s + 1)
                        }
                    }]), n
                }(ep);
            ...
            function eb(e, t, n, o, r) {
                eM(o, t, e);
                var i = new ey(void 0, e, t, n, o, o, o, r, 0);
            ...
            var ek = function(e) {
                    ...
                    return v(n, [{
                        ...
                        key: "localPosFromDOM",
                        value: function(e, t, o) {
                            return e == this.nodeDOM ? this.posAtStart + Math.min(t, this.node.text.length) : a(f(n.prototype), "localPosFromDOM", this).call(this, e, t, o)
                        }
                    }, {
                        key: "ignoreMutation",
                        value: function(e) {
                        ...
                        key: "markDirty",
                        value: function(e, t) {
                            a(f(n.prototype), "markDirty", this).call(this, e, t), this.dom != this.nodeDOM && (0 == e || t == this.nodeDOM.nodeValue.length) && (this.dirty = 3)
                        }
                    }, {
                        key: "domAtom",
                        get: function() {
                ...
                eS = function(e) {
                    ...
                    return v(n, [{
                        ...
                        value: function(e, t, o, r) {
                            ...
                            return (!!this.contentDOM || !!e.isLeaf) && a(f(n.prototype), "update", this).call(this, e, t, o, r)
                        }
                    }, {
                        key: "selectNode",
                        value: function() {
                            this.spec.selectNode ? this.spec.selectNode() : a(f(n.prototype), "selectNode", this).call(this)
                        }
                    }, {
                        key: "deselectNode",
                        value: function() {
                            this.spec.deselectNode ? this.spec.deselectNode() : a(f(n.prototype), "deselectNode", this).call(this)
                        }
                    }, {
                        key: "setSelection",
                        value: function(e, t, o, r) {
                            this.spec.setSelection ? this.spec.setSelection(e, t, o.root) : a(f(n.prototype), "setSelection", this).call(this, e, t, o, r)
                        }
                    }, {
                        key: "destroy",
                        value: function() {
            ...
            function eO(e, t, n) {
                ...
                for (var o = n ? eN[0] : new eD, r = [o], i = 0; i < e.length; i++) {
                    var s = e[i].type.attrs;
                    if (s)
                        for (var a in s.nodeName && r.push(o = new eD(s.nodeName)), s) {
                            var l = s[a];
                            null != l && (n && 1 == r.length && r.push(o = new eD(t.isInline ? "span" : "div")), "class" == a ? o.class = (o.class ? o.class + " " : "") + l : "style" == a ? o.style = (o.style ? o.style + ";" : "") + l : "nodeName" != a && (o[a] = l))
                        }
                }
                return r
            }
            ...
            function eM(e, t, n) {
                return eC(e, e, eN, eO(t, n, 1 != e.nodeType))
            }
            ...
            var eP = function() {
                        ...
                        e: for (; r > 0;) {
                            for (var a = void 0;;)
                                if (o) {
                                    ...
                                    if (l instanceof eg) n = l, o = l.children.length;
                                    else {
                                        a = l, o--;
                                        break
                                    }
                ...
                return v(e, [{
                    ...
                    value: function(e, t, n) {
                        ...
                        for (; r < e.length;) {
                            ...
                            if (s > -1) s > this.index && (this.changed = !0, this.destroyBetween(this.index, s)), this.top = this.top.children[this.index];
                                ...
                                var c = eg.create(this.top, e[r], t, n);
                    ...
                    value: function(e, t, n, o, r, i) {
                        for (var s = this.index; s < this.top.children.length; s++) {
                            ...
                            if (a instanceof ey) {
                                ...
                                var c = a.dom,
                                    d = void 0,
                                    u = this.isLocked(c) && !(e.isText && a.node && a.node.isText && a.nodeDOM.nodeValue == e.text && 3 != a.dirty && ex(t, a.outerDeco));
                                if (!u && a.update(e, t, n, o)) return this.destroyBetween(this.index, s), a.dom != c && (this.changed = !0), this.index++, !0;
                                if (!u && (d = this.recreateWrapper(a, e, t, n, o, i))) return this.destroyBetween(this.index, s), this.top.children[this.index] = d, d.contentDOM && (d.dirty = 2, d.updateChildren(o, i + 1), d.dirty = 0), this.changed = !0, this.index++, !0;
                                break
                            }
                        }
                        return !1
                    ...
                    value: function(e, t, n, o, i, s) {
                        if (e.dirty || t.isAtom || !e.children.length || !e.node.content.eq(t.content) || !ex(n, e.outerDeco) || !o.eq(e.innerDeco)) return null;
                        var a = ey.create(this.top, t, n, o, i, s);
                        if (a.contentDOM) {
                    ...
                    key: "addNode",
                    value: function(e, t, n, o, r) {
                        var i = ey.create(this.top, e, t, n, o, r);
                    ...
                    value: function() {
                        for (var e = this.top.children[this.index - 1], t = this.top; e instanceof eg;) e = (t = e).children[t.children.length - 1];
            ...
            function eV(e) {
                ...
                if (a < 0) return null;
                var l, c, d = r.resolve(a);
                if (P(n)) {
                    for (l = a; i && !i.node;) i = i.parent;
                    var u = i.node;
                    if (i && u.isAtom && g.NodeSelection.isSelectable(u) && i.parent && !(u.isInline && function(e, t, n) {
                            for (var o = 0 == t, r = t == x(e); o || r;) {
                                if (e == n) return !0;
                                var i = k(e);
                        ...
                        var f = i.posBefore;
                        c = new g.NodeSelection(a == f ? d : r.resolve(f))
                    }
                } else {
                    if (n instanceof e.dom.ownerDocument.defaultView.Selection && n.rangeCount > 1) {
                        ...
                        if (h < 0) return null;
                        var y = o(p == e.state.selection.anchor ? [p, h] : [h, p], 2);
                        l = y[0], a = y[1], d = r.resolve(a)
                    } else l = e.docView.posFromDOM(n.anchorNode, n.anchorOffset, 1);
                    if (l < 0) return null
                }
                var b = r.resolve(l);
                if (!c) {
                    var w = "pointer" == t || e.state.selection.head < d.pos && !s ? 1 : -1;
                    c = e$(e, b, d, w)
                }
                return c
            }
            ...
            function eR(e) {
                return e.editable ? e.hasFocus() : eW(e) && document.activeElement && document.activeElement.contains(e.dom)
            }
            ...
            function eB(e) {
                ...
                if (eq(e, n), eR(e)) {
                    if (!t && e.input.mouseDown && e.input.mouseDown.allowDefault && $) {
                        ...
                        if (o.anchorNode && r.anchorNode && O(o.anchorNode, o.anchorOffset, r.anchorNode, r.anchorOffset)) {
                    ...
                    if (e.domObserver.disconnectSelection(), e.cursorWrapper) {
                        ...
                        if (s) {
                            var l = i.cursorWrapper.dom,
                                c = "IMG" == l.nodeName;
                            c ? a.setStart(l.parentNode, k(l) + 1) : a.setStart(l, 0), a.collapse(!0), s.removeAllRanges(), s.addRange(a), !c && !i.state.selection.visible && F && L <= 11 && (l.disabled = !0, l.disabled = !1)
                        }
                    } else {
                        var d, u, f, h, p, m, v, y = n.anchor,
                            b = n.head;
                        ez && !(n instanceof g.TextSelection) && (n.$from.parent.inlineContent || (m = eI(e, n.from)), n.empty || n.$from.parent.inlineContent || (v = eI(e, n.to))), e.docView.setSelection(y, b, e, t), ez && (m && eL(m), v && eL(v)), n.visible ? e.dom.classList.remove("ProseMirror-hideselection") : (e.dom.classList.add("ProseMirror-hideselection"), "onselectionchange" in document && ((u = (d = e).dom.ownerDocument).removeEventListener("selectionchange", d.input.hideSelectionGuard), h = (f = d.domSelectionRange()).anchorNode, p = f.anchorOffset, u.addEventListener("selectionchange", d.input.hideSelectionGuard = function() {
                            (f.anchorNode != h || f.anchorOffset != p) && (u.removeEventListener("selectionchange", d.input.hideSelectionGuard), setTimeout(function() {
                                (!eR(d) || d.state.selection.visible) && d.dom.classList.remove("ProseMirror-hideselection")
                            }, 20))
                        })))
                    }
            ...
            function eI(e, t) {
                ...
                if (W && i && "false" == i.contentEditable) return eF(i);
                if ((!i || "false" == i.contentEditable) && (!s || "false" == s.contentEditable)) {
                    if (i) return eF(i);
                    else if (s) return eF(s)
                }
            }
            ...
            function eq(e, t) {
                if (t instanceof g.NodeSelection) {
                    ...
                    n != e.lastSelectedViewDesc && (eK(e), n && n.selectNode(), e.lastSelectedViewDesc = n)
                } else eK(e)
            }
            ...
            function e_(e) {
                return (!e.editable || !!e.hasFocus()) && eW(e)
            }
            ...
            function eU(e, t, n) {
                ...
                if (o instanceof g.TextSelection) {
                    if (n.indexOf("s") > -1) {
                        ...
                        return ej(e, new g.TextSelection(o.$anchor, s))
                    } else if (!o.empty) return !1;
                    else if (e.endOfTextblock(t > 0 ? "forward" : "backward")) {
                        var a = eH(e.state, t);
                        return !!a && a instanceof g.NodeSelection && ej(e, a)
                    } else if (!(j && n.indexOf("m") > -1)) {
                        var l, c = o.$head,
                            d = c.textOffset ? null : t < 0 ? c.nodeBefore : c.nodeAfter;
                        if (!d || d.isText) return !1;
                        var u = t < 0 ? c.pos - d.nodeSize : c.pos;
                        return !!(d.isAtom || (l = e.docView.descAt(u)) && !l.contentDOM) && (g.NodeSelection.isSelectable(d) ? ej(e, new g.NodeSelection(t < 0 ? e.state.doc.resolve(c.pos - d.nodeSize) : c)) : !!X && ej(e, new g.TextSelection(e.state.doc.resolve(t < 0 ? u : u + d.nodeSize))))
                    }
                } else {
                    if (o instanceof g.NodeSelection && o.node.isInline) return ej(e, new g.TextSelection(t > 0 ? o.$to : o.$from));
                    var f = eH(e.state, t);
                    return !!f && ej(e, f)
                }
            }
            ...
            function eY(e, t) {
                return t < 0 ? function(e) {
                    ...
                    if (n) {
                        var r, i, s = !1;
                        for (q && 1 == n.nodeType && o < eG(n) && eX(n.childNodes[o], -1) && (s = !0);;)
                            if (o > 0)
                            ...
                            for (var l = n.previousSibling; l && eX(l, -1);) r = n.parentNode, i = k(l), l = l.previousSibling;
                            if (l) o = eG(n = l);
                            else {
                        ...
                        s ? eQ(e, n, o) : r && eQ(e, r, i)
                    }
                }(e) : function(e) {
                    var t, n, o = e.domSelectionRange(),
                        r = o.focusNode,
                        i = o.focusOffset;
                    if (r) {
                        for (var s = eG(r);;)
                            if (i < s) {
                                ...
                                if (eX(r.childNodes[i], 1)) t = r, n = ++i;
                                else break
                            } else if (eJ(r)) break;
                        else {
                            for (var a = r.nextSibling; a && eX(a, 1);) t = a.parentNode, n = k(a) + 1, a = a.nextSibling;
                            if (a) i = 0, s = eG(r = a);
                            else {
            ...
            function eQ(e, t, n) {
                if (3 != t.nodeType) {
                    var o, r;
                    (r = function(e, t) {
                        for (; e && t == e.childNodes.length && !T(e);) t = k(e) + 1, e = e.parentNode;
                    ...
                    }(t, n)) ? (t = r, n = 0) : (o = function(e, t) {
                        for (; e && !t && !T(e);) t = k(e), e = e.parentNode;
                        for (; e && t;) {
            ...
            function e0(e, t, n) {
                var o = e.state.selection;
                if (o instanceof g.TextSelection && !o.empty || n.indexOf("s") > -1 || j && n.indexOf("m") > -1) return !1;
                var r = o.$from,
                    i = o.$to;
                if (!r.parent.inlineContent || e.endOfTextblock(t < 0 ? "up" : "down")) {
                    var s = eH(e.state, t);
                    if (s && s instanceof g.NodeSelection) return ej(e, s)
                }
            ...
            function e5(e, t, n, o, r) {
                var i, s, a = r.parent.type.spec.code;
                if (!n && !t) return null;
                var l = t && (o || a || !n);
                if (l) {
                    if (e.someProp("transformPastedText", function(n) {
                            t = n(t, a || o, e)
                        }), a) return t ? new y.Slice(y.Fragment.from(e.state.schema.text(t.replace(/\r\n?/g, "\n"))), 0, 0) : y.Slice.empty;
                    ...
                    if (c) s = c;
                        ...
                        var d = r.marks(),
                            u = e.state.schema,
                            f = y.DOMSerializer.fromSchema(u);
                    ...
                    var t, n, o = /^(\s*<meta [^>]*>)*/.exec(e);
                    o && (e = e.slice(o[0].length));
                    var r, i = tt().createElement("div"),
                        s = /<([a-z][^>\s]+)/i.exec(e);
                    if ((r = s && e9[s[1].toLowerCase()]) && (e = r.map(function(e) {
                            return "<" + e + ">"
                        }).join("") + e + r.map(function(e) {
                            return "</" + e + ">"
                        }).reverse().join("")), i.innerHTML = (t = e, (n = window.trustedTypes) ? (tn || (tn = n.defaultPolicy || n.createPolicy("ProseMirrorClipboard", {
                            createHTML: function(e) {
                                return e
                            }
                        })), tn.createHTML(t)) : t), r)
                        for (var a = 0; a < r.length; a++) i = i.querySelector(r[a]) || i;
                    return i
                }(n), X && function(e) {
                ...
                if (s || (s = (e.someProp("clipboardParser") || e.someProp("domParser") || y.DOMParser.fromSchema(e.state.schema)).parseSlice(i, {
                        preserveWhitespace: !!(l || p),
                        context: r,
                        ruleFromNode: function(e) {
                            return "BR" != e.nodeName || e.nextSibling || !e.parentNode || e6.test(e.parentNode.nodeName) ? null : {
                                ignore: !0
                            }
                        }
                    })), p) s = function(e, t) {
                    ...
                    return new y.Slice(r, i, s)
                ...
                else if ((s = y.Slice.maxOpen(function(e, t) {
                        if (e.childCount < 2) return e;
                        for (var n, o = t.depth; o >= 0; o--)
                            if (n = function() {
                                    var n, r = t.node(o).contentMatchAt(t.index(o)),
                                        i = [];
                                    if (e.forEach(function(e) {
                                            if (i) {
                                                var t, o = r.findWrapping(e.type);
                                                if (!o) return i = null;
                                                if (t = i.length && n.length && function e(t, n, o, r, i) {
                                                        if (i < t.length && i < n.length && t[i] == n[i]) {
                                                            var s = e(t, n, o, r.lastChild, i + 1);
                                                            if (s) return r.copy(r.content.replaceChild(r.childCount - 1, s));
                                                            if (r.contentMatchAt(r.childCount).matchType(i == t.length - 1 ? o.type : t[i + 1])) return r.copy(r.content.append(y.Fragment.from(e8(o, t, i + 1))))
                                                        }
                                                    }(o, n, e, i[i.length - 1], 0)) i[i.length - 1] = t;
                                                else {
                                                    i.length && (i[i.length - 1] = function e(t, n) {
                                                        if (0 == n) return t;
                                                        var o = t.content.replaceChild(t.childCount - 1, e(t.lastChild, n - 1)),
                                                            r = t.contentMatchAt(t.childCount).fillBefore(y.Fragment.empty, !0);
                        ...
                        return e
                    }(s.content, r), !0)).openStart || s.openEnd) {
                    for (var g = 0, b = 0, k = s.content.firstChild; g < s.openStart && !k.type.spec.isolating; g++, k = k.firstChild);
            ...
            var e6 = /^(a|abbr|acronym|b|cite|code|del|em|i|ins|kbd|label|output|q|ruby|s|samp|span|strong|sub|sup|time|u|tt|var)$/i;
            ...
            function e7(e, t, n, o, r, i) {
                var s = t < 0 ? e.firstChild : e.lastChild,
                    a = s.content;
                return e.childCount > 1 && (i = 0), r < o - 1 && (a = e7(a, t, n, o, r + 1, i)), r >= n && (a = t < 0 ? s.contentMatchAt(0).fillBefore(a, i <= r).append(a) : a.append(s.contentMatchAt(s.childCount).fillBefore(y.Fragment.empty, !0))), e.replaceChild(t < 0 ? 0 : e.childCount - 1, s.copy(a))
            }

            function e4(e, t, n) {
                return t < e.openStart && (e = new y.Slice(e7(e.content, -1, t, e.openStart, 0, e.openEnd), t, e.openEnd)), n < e.openEnd && (e = new y.Slice(e7(e.content, 1, n, e.openEnd, 0, 0), e.openStart, n)), e
            }
            var e9 = {
                    thead: ["table"],
                    tbody: ["table"],
            ...
            function tt() {
                return te || (te = document.implementation.createHTMLDocument("title"))
            }
            var tn = null,
                to = {},
                tr = {},
            ...
            function tu(e, t, n, o, r) {
                if (-1 == o) return !1;
                for (var i, s = e.state.doc.resolve(o), a = function(o) {
            ...
            tr.keydown = function(e, t) {
                if ((e.input.shiftKey = 16 == t.keyCode || t.shiftKey, !tm(e, t)) && (e.input.lastKeyCode = t.keyCode, e.input.lastKeyCodeTime = Date.now(), !G || !$ || 13 != t.keyCode))
                    if (229 != t.keyCode && e.domObserver.forceFlush(), !H || 13 != t.keyCode || t.ctrlKey || t.altKey || t.metaKey) e.someProp("handleKeyDown", function(n) {
                        return n(e, t)
                    }) || function(e, t) {
                        var n, o = t.keyCode,
                            r = (n = "", t.ctrlKey && (n += "c"), t.metaKey && (n += "m"), t.altKey && (n += "a"), t.shiftKey && (n += "s"), n);
                        if (8 == o || j && 72 == o && "c" == r) return e1(e, -1) || eY(e, -1);
                        if (46 == o && !t.shiftKey || j && 68 == o && "c" == r) return e1(e, 1) || eY(e, 1);
                        if (13 == o || 27 == o) return !0;
                        if (37 == o || j && 66 == o && "c" == r) {
                            var i = 37 == o ? "ltr" == eZ(e, e.state.selection.from) ? -1 : 1 : -1;
                            return eU(e, i, r) || eY(e, i)
                        }
                        if (39 == o || j && 70 == o && "c" == r) {
                            var s = 39 == o ? "ltr" == eZ(e, e.state.selection.from) ? 1 : -1 : 1;
                            return eU(e, s, r) || eY(e, s)
                        } else if (38 == o || j && 80 == o && "c" == r) return e0(e, -1, r) || eY(e, -1);
                        else if (40 == o || j && 78 == o && "c" == r) return function(e) {
                            ...
                            if (n && 1 == n.nodeType && 0 == o && n.firstChild && "false" == n.firstChild.contentEditable) {
                                var r = n.firstChild;
                                e2(e, r, "true"), setTimeout(function() {
                                    return e2(e, r, "false")
                                }, 20)
                            }
                            return !1
                        ...
                        return !1
                    }(e, t) ? t.preventDefault() : ta(e, "key");
                    else {
                        var n = Date.now();
                        e.input.lastIOSEnter = n, e.input.lastIOSEnterFallbackTimeout = setTimeout(function() {
                            e.input.lastIOSEnter == n && (e.someProp("handleKeyDown", function(t) {
                                return t(e, E(13, "Enter"))
                            }), e.input.lastIOSEnter = 0)
                        }, 200)
                    }
            }, tr.keyup = function(e, t) {
                16 == t.keyCode && (e.input.shiftKey = !1)
            }, tr.keypress = function(e, t) {
                if (!tm(e, t) && t.charCode && (!t.ctrlKey || t.altKey) && (!j || !t.metaKey)) {
                    if (e.someProp("handleKeyPress", function(n) {
                            return n(e, t)
                        })) return void t.preventDefault();
                    var n = e.state.selection;
                    if (!(n instanceof g.TextSelection) || !n.$from.sameParent(n.$to)) {
                        var o = String.fromCharCode(t.charCode);
                        /[\r\n]/.test(o) || e.someProp("handleTextInput", function(t) {
                            return t(e, n.$from.pos, n.$to.pos, o)
                        }) || e.dispatch(e.state.tr.insertText(o).scrollIntoView()), t.preventDefault()
                    }
                }
            };
            var th = j ? "metaKey" : "ctrlKey";
            to.mousedown = function(e, t) {
                e.input.shiftKey = t.shiftKey;
                var n, o, r, i = tb(e),
                    s = Date.now(),
                    a = "singleClick";
                s - e.input.lastClick.time < 500 && (o = (n = e.input.lastClick).x - t.clientX) * o + (r = n.y - t.clientY) * r < 100 && !t[th] && ("singleClick" == e.input.lastClick.type ? a = "doubleClick" : "doubleClick" == e.input.lastClick.type && (a = "tripleClick")), e.input.lastClick = {
                    time: s,
                    x: t.clientX,
                    y: t.clientY,
                    type: a
                };
                var l = e.posAtCoords(td(t));
                l && ("singleClick" == a ? (e.input.mouseDown && e.input.mouseDown.done(), e.input.mouseDown = new tp(e, l, t, !!i)) : ("doubleClick" == a ? function(e, t, n, o) {
                    return tu(e, "handleDoubleClickOn", t, n, o) || e.someProp("handleDoubleClick", function(n) {
                        return n(e, t, o)
                    })
                } : function(e, t, n, o) {
                    return tu(e, "handleTripleClickOn", t, n, o) || e.someProp("handleTripleClick", function(n) {
                        return n(e, t, o)
                    }) || function(e, t, n) {
                        if (0 != n.button) return !1;
                        var o = e.state.doc;
                        if (-1 == t) return !!o.inlineContent && (tf(e, g.TextSelection.create(o, 0, o.content.size), "pointer"), !0);
                        for (var r = o.resolve(t), i = r.depth + 1; i > 0; i--) {
                            var s = i > r.depth ? r.nodeAfter : r.node(i),
                                a = r.before(i);
                            if (s.inlineContent) tf(e, g.TextSelection.create(o, a + 1, a + 1 + s.content.size), "pointer");
                            else {
                                if (!g.NodeSelection.isSelectable(s)) continue;
                                tf(e, g.NodeSelection.create(o, a), "pointer")
                            }
                            return !0
                        }
                    }(e, n, o)
                })(e, l.pos, l.inside, t) ? t.preventDefault() : ta(e, "pointer"))
            };
            var tp = function() {
                function e(t, n, o, r) {
                    var i, s, a = this;
                    if (p(this, e), this.view = t, this.pos = n, this.event = o, this.flushed = r, this.delayedSelectionSync = !1, this.mightDrag = null, this.startDoc = t.state.doc, this.selectNode = !!o[th], this.allowDefault = o.shiftKey, n.inside > -1) i = t.state.doc.nodeAt(n.inside), s = n.inside;
                    else {
                    ...
                    }, 20), this.view.domObserver.start()), t.root.addEventListener("mouseup", this.up = this.up.bind(this)), t.root.addEventListener("mousemove", this.move = this.move.bind(this)), ta(t, "pointer")
                }
                return v(e, [{
                    key: "done",
                    value: function() {
                    ...
                    value: function(e) {
                        if (this.done(), this.view.dom.contains(e.target)) {
                            ...
                            (this.view.state.doc != this.startDoc && (i = this.view.posAtCoords(td(e))), this.updateAllowDefault(e), this.allowDefault || !i) ? ta(this.view, "pointer"): (t = this.view, n = i.pos, o = i.inside, r = this.selectNode, tu(t, "handleClickOn", n, o, e) || t.someProp("handleClick", function(o) {
                                return o(t, n, e)
                            }) || (r ? function(e, t) {
                                if (-1 == t) return !1;
                                ...
                                return null != o && (tf(e, g.NodeSelection.create(e.state.doc, o), "pointer"), !0)
                            }(t, o) : function(e, t) {
                                if (-1 == t) return !1;
                                var n = e.state.doc.resolve(t),
                                    o = n.nodeAfter;
                                return !!(o && o.isAtom && g.NodeSelection.isSelectable(o)) && (tf(e, new g.NodeSelection(n), "pointer"), !0)
                            }(t, o))) ? e.preventDefault() : 0 == e.button && (this.flushed || W && this.mightDrag && !this.mightDrag.node.isAtom || $ && !this.view.state.selection.visible && 2 >= Math.min(Math.abs(i.pos - this.view.state.selection.from), Math.abs(i.pos - this.view.state.selection.to))) ? (tf(this.view, g.Selection.near(this.view.state.doc.resolve(i.pos)), "pointer"), e.preventDefault()) : ta(this.view, "pointer")
                        }
                    }
                }, {
                    key: "move",
                    value: function(e) {
                        this.updateAllowDefault(e), ta(this.view, "pointer"), 0 == e.buttons && this.done()
                    }
                }, {
            ...
            function tm(e, t) {
                return !!e.composing || !!(W && 500 > Math.abs(t.timeStamp - e.input.compositionEndedAt)) && (e.input.compositionEndedAt = -2e8, !0)
            }
            to.touchstart = function(e) {
                e.input.lastTouch = Date.now(), tb(e), ta(e, "pointer")
            }, to.touchmove = function(e) {
                e.input.lastTouch = Date.now(), ta(e, "pointer")
            }, to.contextmenu = function(e) {
                return tb(e)
            };
            var tv = G ? 5e3 : -1;
            ...
            function tb(e) {
                ...
                if (!G || !(e.domObserver.flushingSoon >= 0)) {
                    if (e.domObserver.forceFlush(), ty(e), t || e.docView && e.docView.dirty) {
                        var n = eV(e);
            ...
            tr.compositionstart = tr.compositionupdate = function(e) {
                if (!e.composing) {
                    e.domObserver.flush();
                    var t = e.state,
                        n = t.selection.$to;
                    if (t.selection instanceof g.TextSelection && (t.storedMarks || !n.textOffset && n.parentOffset && n.nodeBefore.marks.some(function(e) {
                        ...
                        }))) e.markCursor = e.state.storedMarks || n.marks(), tb(e, !0), e.markCursor = null;
                    else if (tb(e, !t.selection.empty), q && t.selection.empty && n.parentOffset && !n.textOffset && n.nodeBefore.marks.length)
                ...
                tg(e, tv)
            }, tr.compositionend = function(e, t) {
                ...
                }), e.input.compositionID++, tg(e, 20))
            };
            var tk = F && L < 15 || H && Y < 604;

            function tw(e, t, n, o, r) {
                var i = e5(e, t, n, o, e.state.selection.$from);
            ...
            to.copy = tr.cut = function(e, t) {
                var n = e.state.selection,
                    o = "cut" == t.type;
                if (!n.empty) {
                    var r = tk ? null : t.clipboardData,
                        i = e3(e, n.content()),
                        s = i.dom,
                        a = i.text;
                    if (r) t.preventDefault(), r.clearData(), r.setData("text/html", s.innerHTML), r.setData("text/plain", a);
                    else if (e.dom.parentNode) {
                        var l = e.dom.parentNode.appendChild(document.createElement("div"));
                        l.appendChild(s), l.style.cssText = "position: fixed; left: -10000px; top: 10px";
                        var c = getSelection(),
                            d = document.createRange();
                        d.selectNodeContents(s), e.dom.blur(), c.removeAllRanges(), c.addRange(d), setTimeout(function() {
                            l.parentNode && l.parentNode.removeChild(l), e.focus()
                        }, 50)
                    }
                    o && e.dispatch(e.state.tr.deleteSelection().scrollIntoView().setMeta("uiEvent", "cut"))
                }
            }, tr.paste = function(e, t) {
                if (!e.composing || G) {
                    var n = tk ? null : t.clipboardData,
                        o = e.input.shiftKey && 45 != e.input.lastKeyCode;
                    if (n && tw(e, tS(n), n.getData("text/html"), o, t)) t.preventDefault();
                    else if (e.dom.parentNode) {
                        var r = e.input.shiftKey || e.state.selection.$from.parent.type.spec.code,
                            i = e.dom.parentNode.appendChild(document.createElement(r ? "textarea" : "div"));
                        r || (i.contentEditable = "true"), i.style.cssText = "position: fixed; left: -10000px; top: 10px", i.focus();
                        var s = e.input.shiftKey && 45 != e.input.lastKeyCode;
                        setTimeout(function() {
                            e.focus(), i.parentNode && i.parentNode.removeChild(i), r ? tw(e, i.value, null, s, t) : tw(e, i.textContent, i.innerHTML, s, t)
                        }, 50)
                    }
                }
            };
            var tD = v(function e(t, n, o) {
                    p(this, e), this.slice = t, this.move = n, this.node = o
                }),
                tN = j ? "altKey" : "ctrlKey";
            ...
            function tO(e, t) {
                ...
                return null != n ? n : !t[tN]
            }
            for (var tC in to.dragstart = function(e, t) {
                    var n, o = e.input.mouseDown;
                    if (o && o.done(), t.dataTransfer) {
                        var r = e.state.selection,
                            i = r.empty ? null : e.posAtCoords(td(t));
                        if (i && i.pos >= r.from && i.pos <= (r instanceof g.NodeSelection ? r.to - 1 : r.to));
                        else if (o && o.mightDrag) n = g.NodeSelection.create(e.state.doc, o.mightDrag.pos);
                        else if (t.target && 1 == t.target.nodeType) {
                            var s = e.docView.nearestDesc(t.target, !0);
                            s && s.node.type.spec.draggable && s != e.docView && (n = g.NodeSelection.create(e.state.doc, s.posBefore))
                        }
                        var a = (n || e.state.selection).content(),
                            ...
                            d = l.text,
                            u = l.slice;
                        t.dataTransfer.files.length && $ && !(_ > 120) || t.dataTransfer.clearData(), t.dataTransfer.setData(tk ? "Text" : "text/html", c.innerHTML), t.dataTransfer.effectAllowed = "copyMove", tk || t.dataTransfer.setData("text/plain", d), e.dragging = new tD(u, tO(e, t), n)
                    }
                }, to.dragend = function(e) {
                    var t = e.dragging;
                    window.setTimeout(function() {
                        e.dragging == t && (e.dragging = null)
                    }, 50)
                }, tr.dragover = tr.dragenter = function(e, t) {
                    return t.preventDefault()
                }, tr.drop = function(e, t) {
                    var n = e.dragging;
                    if (e.dragging = null, !t.dataTransfer) return;
                    var o = e.posAtCoords(td(t));
                    if (o) {
                        var r = e.state.doc.resolve(o.pos),
                            i = n && n.slice;
                        i ? e.someProp("transformPasted", function(t) {
                            i = t(i, e)
                        }) : i = e5(e, tS(t.dataTransfer), tk ? null : t.dataTransfer.getData("text/html"), !1, r);
                        var s = !!(n && tO(e, t));
                        if (e.someProp("handleDrop", function(n) {
                                return n(e, t, i || y.Slice.empty, s)
                            })) return void t.preventDefault();
                        if (i) {
                            t.preventDefault();
                            var a = i ? b.dropPoint(e.state.doc, r.pos, i) : r.pos;
                            null == a && (a = r.pos);
                            var l = e.state.tr;
                            if (s) {
                                var c = n.node;
                            ...
                            if (u ? l.replaceRangeWith(d, d, i.content.firstChild) : l.replaceRange(d, d, i), !l.doc.eq(f)) {
                                ...
                                if (u && g.NodeSelection.isSelectable(i.content.firstChild) && h.nodeAfter && h.nodeAfter.sameMarkup(i.content.firstChild)) l.setSelection(new g.NodeSelection(h));
                                else {
                                    var p = l.mapping.map(a);
                                    l.mapping.maps[l.mapping.maps.length - 1].forEach(function(e, t, n, o) {
                                        return p = o
                                    }), l.setSelection(e$(e, h, l.doc.resolve(p)))
                                }
                    ...
                    e.input.lastFocus = Date.now(), e.focused || (e.domObserver.stop(), e.dom.classList.add("ProseMirror-focused"), e.domObserver.start(), e.focused = !0, setTimeout(function() {
                        e.docView && e.hasFocus() && !e.domObserver.currentSelection.eq(e.domSelectionRange()) && eB(e)
                    }, 20))
                }, to.blur = function(e, t) {
            ...
            var tx = function() {
                    function e(t, n) {
                        p(this, e), this.toDOM = t, this.spec = n || tV, this.side = this.spec.side || 0
                    }
                    return v(e, [{
                        key: "map",
                        value: function(e, t, n, o) {
                            var r = e.mapResult(t.from + o, this.side < 0 ? -1 : 1),
                                i = r.pos;
                            return r.deleted ? null : new tE(i - n, i - n, this)
                        }
                    }, {
                        key: "valid",
                        value: function() {
                ...
                tT = function() {
                    function e(t, n) {
                        p(this, e), this.attrs = t, this.spec = n || tV
                    }
                    return v(e, [{
                        key: "map",
                        value: function(e, t, n, o) {
                            ...
                            return r >= i ? null : new tE(r, i, this)
                        }
                    }, {
                        key: "valid",
                        value: function(e, t) {
                ...
                tP = function() {
                    ...
                    return v(e, [{
                        ...
                        value: function(e, t, n, o) {
                            ...
                            return i.deleted || i.pos <= r.pos ? null : new tE(r.pos - n, i.pos - n, this)
                        }
                    }, {
                        key: "valid",
                        value: function(e, t) {
                ...
                tE = function() {
                    ...
                    return v(e, [{
                        ...
                        key: "widget",
                        get: function() {
                            return this.type instanceof tx
                        }
                    }], [{
                        key: "widget",
                        value: function(t, n, o) {
                            return new e(t, t, new tx(n, o))
                        }
                    }, {
                        key: "inline",
                        value: function(t, n, o, r) {
                            return new e(t, n, new tT(o, r))
                        }
                    }, {
                        key: "node",
                        value: function(t, n, o, r) {
                            return new e(t, n, new tP(o, r))
                        }
                    }]), e
                }(),
                tA = [],
                ...
                tR = function() {
                    function e(t, n) {
                        p(this, e), this.local = t.length ? t : tA, this.children = n.length ? n : tA
                    }
                    return v(e, [{
                        key: "find",
                        value: function(e, t, n) {
                        ...
                        key: "map",
                        value: function(e, t, n) {
                            return this == tB || 0 == e.maps.length ? this : this.mapInner(e, t, 0, 0, n || tV)
                        }
                    }, {
                        key: "mapInner",
                        value: function(t, n, o, r, i) {
                            ...
                            return this.children.length ? function(e, t, n, o, r, i, s) {
                                for (var a = e.slice(), l = function(e) {
                                        var t = 0;
                                ...
                                for (var u = !1, f = 0; f < a.length; f += 3)
                                    if (a[f + 1] < 0) {
                                        ...
                                        if (b && y == p && y + b.nodeSize == m) {
                                            ...
                                            k != tB ? (a[f] = p, a[f + 1] = m, a[f + 2] = k) : (a[f + 1] = -2, u = !0)
                                        } else u = !0
                                    }
                                if (u) {
                                    var w = tq(function(e, t, n, o, r, i, s) {
                                        for (var a = 0; a < e.length; a += 3) - 1 == e[a + 1] && function e(t, i) {
                                    ...
                                    for (var D = 0, N = 0; D < w.children.length; D += 3) {
                                        for (var O = w.children[D]; N < a.length && a[N] < O;) N += 3;
                                        a.splice(N, 0, w.children[D], w.children[D + 1], w.children[D + 2])
                                    }
                                }
                                return new tR(t.sort(tK), a)
                            }(this.children, s || [], t, n, o, r, i) : s ? new e(s.sort(tK), tA) : tB
                        }
                    }, {
                        key: "add",
                        value: function(t, n) {
                            return n.length ? this == tB ? e.create(t, n) : this.addInner(t, n, 0) : this
                        }
                    }, {
                        key: "addInner",
                        value: function(t, n, o) {
                            ...
                            t.forEach(function(e, t) {
                                ...
                                if (a = tF(n, e, l)) {
                                    ...
                                    r[s] == t ? r[s + 2] = r[s + 2].addInner(e, a, l + 1) : r.splice(s, 0, t, t + e.nodeSize, tq(a, e, l + 1, tV)), s += 3
                                }
                            });
                            for (var a = tI(s ? tL(n) : n, -o), l = 0; l < a.length; l++) a[l].type.valid(t, a[l]) || a.splice(l--, 1);
                            return new e(a.length ? this.local.concat(a).sort(tK) : this.local, r || this.children)
                        }
                    }, {
                        key: "remove",
                        value: function(e) {
                        ...
                        value: function(t, n) {
                            ...
                            return o == this.children && r == this.local ? this : r.length || o.length ? new e(r, o) : tB
                        }
                    }, {
                        key: "forChild",
                        value: function(t, n) {
                            ...
                            for (var s = t + 1, a = s + n.content.size, l = 0; l < this.local.length; l++) {
                                var c = this.local[l];
                                if (c.from < a && c.to > s && c.type instanceof tT) {
                            ...
                            if (r) {
                                var f = new e(r.sort(tK), tA);
                                return o ? new tz([f, o]) : f
                            }
                            return o || tB
                        }
                    }, {
                        ...
                        key: "localsInner",
                        value: function(e) {
                            if (this == tB) return tA;
                            if (e.inlineContent || !this.local.some(tT.is)) return this.local;
                            for (var t = [], n = 0; n < this.local.length; n++) this.local[n].type instanceof tT || t.push(this.local[n]);
                            return t
                        }
                    }, {
                        key: "forEachSet",
                        ...
                        key: "create",
                        value: function(e, t) {
                            return t.length ? tq(t, e, 0, tV) : tB
                        }
                    }]), e
                }();
            tR.empty = new tR([], []), tR.removeOverlap = t$;
            var tB = tR.empty,
                tz = function() {
                    function e(t) {
                    ...
                    return v(e, [{
                        ...
                        key: "forChild",
                        value: function(t, n) {
                            if (n.isLeaf) return tR.empty;
                            for (var o = [], r = 0; r < this.members.length; r++) {
                                var i = this.members[r].forChild(t, n);
                                i != tB && (i instanceof e ? o = o.concat(i.members) : o.push(i))
                            }
                            return e.from(o)
                        }
                    }, {
                            ...
                            switch (t.length) {
                                ...
                                default:
                                    return new e(t.every(function(e) {
                                        ...
                                        return e.concat(t instanceof tR ? t : t.members)
                                    }, []))
                            }
                        }
                    }]), e
            ...
            function tI(e, t) {
                ...
                for (var n = [], o = 0; o < e.length; o++) {
                    var r = e[o];
                    n.push(new tE(r.from + t, r.to + t, r.type))
                }
                return n
            }
            ...
            function tq(e, t, n, o) {
                ...
                t.forEach(function(t, s) {
                    ...
                    if (a) {
                        i = !0;
                        var l = tq(a, t, n + s + 1, o);
                        l != tB && r.push(s, s + t.nodeSize, l)
                    }
                });
                for (var s = tI(i ? tL(e) : e, -n).sort(tK), a = 0; a < s.length; a++) s[a].type.valid(t, s[a]) || (o.onRemove && o.onRemove(s[a].spec), s.splice(a--, 1));
                return s.length || r.length ? new tR(s, r) : tB
            }
                ...
                for (var t = e, n = 0; n < t.length - 1; n++) {
                    ...
                    if (o.from != o.to)
                        for (var r = n + 1; r < t.length; r++) {
                            var i = t[r];
                            if (i.from == o.from) {
                                i.to != o.to && (t == e && (t = e.slice()), t[r] = i.copy(i.from, o.to), t_(t, r + 1, i.copy(o.to, i.to)));
                                continue
                            }
                            i.from < o.to && (t == e && (t = e.slice()), t[n] = o.copy(o.from, i.from), t_(t, r, o.copy(i.from, o.to)));
                            break
                        }
                }
                return t
            ...
            function tW(e) {
                ...
                return e.someProp("decorations", function(n) {
                    var o = n(e.state);
                    o && o != tB && t.push(o)
                }), e.cursorWrapper && t.push(tR.create(e.state.doc, [e.cursorWrapper.deco])), tz.from(t)
            }
            var tH = {
                    childList: !0,
                    characterData: !0,
                ...
                tG = function() {
                    function e(t, n) {
                        var o = this;
                        p(this, e), this.view = t, this.handleDOMChange = n, this.queue = [], this.flushingSoon = -1, this.observer = null, this.currentSelection = new tU, this.onCharData = null, this.suppressingSelectionUpdates = !1, this.lastChangedTextNode = null, this.observer = window.MutationObserver && new window.MutationObserver(function(e) {
                            for (var t = 0; t < e.length; t++) o.queue.push(e[t]);
                            F && L <= 11 && e.some(function(e) {
                                return "childList" == e.type && e.removedNodes.length || "characterData" == e.type && e.oldValue.length > e.target.nodeValue.length
                            }) ? o.flushSoon() : o.flush()
                        }), tj && (this.onCharData = function(e) {
                            o.queue.push({
                                target: e.target,
                                type: "characterData",
                    ...
                    return v(e, [{
                        ...
                        value: function() {
                            if (e_(this.view)) {
                                if (this.suppressingSelectionUpdates) return eB(this.view);
                                if (F && L <= 11 && !this.view.state.selection.empty) {
                        ...
                        value: function() {
                            if (this.observer) {
                                var e, t = r(this.observer.takeRecords());
                                try {
                                    for (t.s(); !(e = t.n()).done;) {
                                        var n = e.value;
                                        this.queue.push(n)
                        ...
                        value: function() {
                            ...
                            if (e.docView && !(this.flushingSoon > -1)) {
                                var t, n = this.pendingRecords();
                                n.length && (this.queue = []);
                                var i = e.domSelectionRange(),
                                    s = !this.suppressingSelectionUpdates && !this.currentSelection.eq(i) && e_(e) && !this.ignoreSelectionChange(i),
                                    a = -1,
                                    l = -1,
                                    c = !1,
                                    d = [];
                                if (e.editable)
                                    for (var u = 0; u < n.length; u++) {
                                        var f = this.registerMutation(n[u], d);
                                        f && (a = a < 0 ? f.from : Math.min(f.from, a), l = l < 0 ? f.to : Math.max(f.to, l), f.typeOver && (c = !0))
                                    }
                                if (q && d.length) {
                                    ...
                                    if (2 == h.length) {
                                        ...
                                        var y, b = this.currentSelection.focusNode,
                                            k = r(h);
                                        try {
                                            for (k.s(); !(y = k.n()).done;) {
                                                var w = y.value,
                                                    S = w.parentNode;
                                                S && "LI" == S.nodeName && (!b || function(e, t) {
                                ...
                                var D = null;
                                a < 0 && s && e.input.lastFocus > Date.now() - 200 && Math.max(e.input.lastTouch, e.input.lastClick.time) < Date.now() - 300 && P(i) && (D = eV(e)) && D.eq(g.Selection.near(e.state.doc.resolve(0), 1)) ? (e.input.lastFocus = 0, eB(e), this.currentSelection.set(i), e.scrollToSelection()) : (a > -1 || s) && (a > -1 && (e.docView.markDirty(a, l), t = e, !tX.has(t) && (tX.set(t, null), -1 !== ["normal", "nowrap", "pre-line"].indexOf(getComputedStyle(t.dom).whiteSpace)) && (t.requiresGeckoHackNode = q, tY || (console.warn("ProseMirror expects the CSS white-space property to be set, preferably to 'pre-wrap'. It is recommended to load style/prosemirror.css from the prosemirror-view package."), tY = !0))), this.handleDOMChange(a, l, c, d), e.docView && e.docView.dirty ? e.updateState(e.state) : this.currentSelection.eq(i) || eB(e), this.currentSelection.set(i))
                            }
                        }
                    }, {
                        ...
                        value: function(e, t) {
                            ...
                            if ("childList" == e.type) {
                                ...
                                var u = i && i.parentNode == e.target ? k(i) + 1 : 0,
                                    f = n.localPosFromDOM(e.target, u, -1),
                                    h = s && s.parentNode == e.target ? k(s) : e.target.childNodes.length;
                                return {
                                    from: f,
                                    to: n.localPosFromDOM(e.target, h, 1)
                                }
                            }
            ...
            function tQ(e) {
                ...
                if ("BR" == e.nodeName && e.parentNode) {
                    ...
                    } else if (e.parentNode.lastChild == e || W && /^(tr|table)$/i.test(e.parentNode.nodeName)) return {
                        ignore: !0
                    }
            ...
            var tZ = /^(a|abbr|acronym|b|bd[io]|big|br|button|cite|code|data(list)?|del|dfn|em|i|ins|kbd|label|map|mark|meter|output|q|ruby|s|samp|small|span|strong|su[bp]|time|u|tt|var)$/i;
            ...
            var t3 = function() {
                function e(t, n) {
                    var o = this;
                    p(this, e), this._root = null, this.focused = !1, this.trackWrites = null, this.mounted = !1, this.markCursor = null, this.cursorWrapper = null, this.lastSelectedViewDesc = void 0, this.input = new ts, this.prevDirectPlugins = [], this.pluginViews = [], this.requiresGeckoHackNode = !1, this.dragging = null, this._props = n, this.state = n.state, this.directPlugins = n.plugins || [], this.directPlugins.forEach(t4), this.dispatch = this.dispatch.bind(this), this.dom = t && t.mount || document.createElement("div"), t && (t.appendChild ? t.appendChild(this.dom) : "function" == typeof t ? t(this.dom) : t.mount && (this.mounted = !0)), this.editable = t8(this), t6(this), this.nodeViews = t7(this), this.docView = eb(this.state.doc, t5(this), tW(this), this.dom, this), this.domObserver = new tG(this, function(e, t, n, r) {
                        return function(e, t, n, o, r) {
                            var i, s, a, l, c, d, u = e.input.compositionPendingChanges || (e.composing ? e.input.compositionID : 0);
                            ...
                            var m = e.state.doc.resolve(t),
                                v = m.sharedDepth(n);
                            t = m.before(v + 1), n = e.state.doc.resolve(n).after(v + 1);
                            var b = e.state.selection,
                                k = function(e, t, n) {
                                    ...
                                    var m = e.state.doc,
                                        v = e.someProp("domParser") || y.DOMParser.fromSchema(e.state.schema),
                                        g = m.resolve(l),
                                        b = null,
                                        k = v.parse(i, {
                                            topNode: g.parent,
                            ...
                            var D = function(e, t, n, o, r) {
                                ...
                                if (a < i && e.size < t.size) {
                                    var d = o <= i && o >= a ? i - o : 0;
                                    (i -= d) && i < t.size && t2(t.textBetween(i - 1, i + 1)) && (i += d ? 1 : -1), l = i + (l - a), a = i
                                } else if (l < i) {
                                    var u = o <= i && o >= l ? i - o : 0;
                                    (i -= u) && i < e.size && t2(e.textBetween(i - 1, i + 1)) && (i += u ? 1 : -1), a = i + (a - l), l = i
                                }
                                return {
                                    start: i,
                                    endA: a,
                            ...
                            if (D && e.input.domChangeCount++, (H && e.input.lastIOSEnter > Date.now() - 225 || G) && r.some(function(e) {
                                    return 1 == e.nodeType && !tZ.test(e.nodeName)
                                }) && (!D || D.endA >= D.endB) && e.someProp("handleKeyDown", function(t) {
                                    return t(e, E(13, "Enter"))
                                })) {
                                e.input.lastIOSEnter = 0;
                                return
                            ...
                            if (!D)
                                if (o && b instanceof g.TextSelection && !b.empty && b.$head.sameParent(b.$anchor) && !e.composing && !(k.sel && k.sel.anchor != k.sel.head)) D = {
                                    start: b.from,
                                    endA: b.to,
                                    endB: b.to
                                };
                                    ...
                                    if (k.sel) {
                                        var N = t0(e, e.state.doc, k.sel);
                                        if (N && !N.eq(e.state.selection)) {
                                            var O = e.state.tr.setSelection(N);
                                            u && O.setMeta("composition", u), e.dispatch(O)
                                        }
                                    }
                                    return
                                }
                            e.state.selection.from < e.state.selection.to && D.start == D.endB && e.state.selection instanceof g.TextSelection && (D.start > e.state.selection.from && D.start <= e.state.selection.from + 2 && e.state.selection.from >= k.from ? D.start = e.state.selection.from : D.endA < e.state.selection.to && D.endA >= e.state.selection.to - 2 && e.state.selection.to <= k.to && (D.endB += e.state.selection.to - D.endA, D.endA = e.state.selection.to)), F && L <= 11 && D.endB == D.start + 1 && D.endA == D.start && D.start > k.from && " \xa0" == k.doc.textBetween(D.start - k.from - 1, D.start - k.from + 1) && (D.start--, D.endA--, D.endB--);
                            var C = k.doc.resolveNoCache(D.start - k.from),
                                M = k.doc.resolveNoCache(D.endB - k.from),
                                x = w.resolve(D.start),
                                T = C.sameParent(M) && C.parent.inlineContent && x.end() >= D.endA;
                            if ((H && e.input.lastIOSEnter > Date.now() - 225 && (!T || r.some(function(e) {
                                    return "DIV" == e.nodeName || "P" == e.nodeName
                                })) || !T && C.pos < k.doc.content.size && (!C.sameParent(M) || !C.parent.inlineContent) && !/\S/.test(k.doc.textBetween(C.pos, M.pos, "", "")) && (a = g.Selection.findFrom(k.doc.resolve(C.pos + 1), 1, !0)) && a.head > C.pos) && e.someProp("handleKeyDown", function(t) {
                                    return t(e, E(13, "Enter"))
                                })) {
                                e.input.lastIOSEnter = 0;
                                return
                            }
                            if (e.state.selection.anchor > D.start && function(e, t, n, o, r) {
                                    if (n - t <= r.pos - o.pos || t1(o, !0, !1) < r.pos) return !1;
                                    var i = e.resolve(t);
                                    ...
                                    var a = e.resolve(t1(i, !0, !0));
                                    return !(!a.parent.isTextblock || a.pos > n || t1(a, !0, !1) < n) && o.parent.content.cut(o.parentOffset).eq(a.parent.content)
                                }(w, D.start, D.endA, C, M) && e.someProp("handleKeyDown", function(t) {
                                    return t(e, E(8, "Backspace"))
                                })) {
                                G && $ && e.domObserver.suppressSelectionUpdates();
                                return
                            }
                            $ && D.endB == D.start && (e.input.lastChromeDelete = Date.now()), G && !T && C.start() != M.start() && 0 == M.parentOffset && C.depth == M.depth && k.sel && k.sel.anchor == k.sel.head && k.sel.head == D.endA && (D.endB -= 2, M = k.doc.resolveNoCache(D.endB - k.from), setTimeout(function() {
                            ...
                            var A = D.start,
                                V = D.endA;
                            if (T) {
                                if (C.pos == M.pos) F && L <= 11 && 0 == C.parentOffset && (e.domObserver.suppressSelectionUpdates(), setTimeout(function() {
                                    return eB(e)
                                }, 20)), l = e.state.tr.delete(A, V), c = w.resolve(D.start).marksAcross(w.resolve(D.endA));
                                else if (D.endA == D.endB && (d = function(e, t) {
                                    ...
                                    }(C.parent.content.cut(C.parentOffset, M.parentOffset), x.parent.content.cut(x.parentOffset, D.endA - x.start())))) l = e.state.tr, "add" == d.type ? l.addMark(A, V, d.mark) : l.removeMark(A, V, d.mark);
                                else if (C.parent.child(C.index()).isText && C.index() == M.index() - !M.textOffset) {
                            ...
                            if (l || (l = e.state.tr.replace(A, V, k.doc.slice(D.start - k.from, D.endB - k.from))), k.sel) {
                                var B = t0(e, l.doc, k.sel);
                                B && !($ && e.composing && B.empty && (D.start != D.endB || e.input.lastChromeDelete < Date.now() - 100) && (B.head == A || B.head == l.mapping.map(V) - 1) || F && B.empty && B.head == A) && l.setSelection(B)
                            }
                            c && l.ensureMarks(c), u && l.setMeta("composition", u), e.dispatch(l.scrollIntoView())
                        }(o, e, t, n, r)
                    }), this.domObserver.start();
                    var r = this;
                    for (var i in to) ! function() {
                        var e = to[i];
                        r.dom.addEventListener(i, r.input.eventHandlers[i] = function(t) {
                            ! function(e, t) {
                                ...
                                return !0
                            }(r, t) || tc(r, t) || !r.editable && t.type in tr || e(r, t)
                        }, ti[i] ? {
                            passive: !0
                        } : void 0)
                    }();
                    W && r.dom.addEventListener("input", function() {
                        return null
                    }), tl(r), this.updatePluginViews()
                }
                return v(e, [{
                    key: "composing",
                    get: function() {
                    ...
                    value: function(e) {
                        ...
                        var t = this._props;
                        this._props = e, e.plugins && (e.plugins.forEach(t4), this.directPlugins = e.plugins), this.updateStateInner(e.state, t)
                    }
                }, {
                    key: "setProps",
                    value: function(e) {
                    ...
                    value: function(e, t) {
                        var n, o, r, i, s = this.state,
                            a = !1,
                            l = !1;
                        e.storedMarks && this.composing && (ty(this), l = !0), this.state = e;
                        ...
                        }(c || t.handleDOMEvents != this._props.handleDOMEvents) && tl(this), this.editable = t8(this), t6(this);
                        var u = tW(this),
                            f = t5(this),
                        ...
                        var m = "preserve" == h && l && null == this.dom.style.overflowAnchor && function(e) {
                        ...
                        if (l) {
                            ...
                            var v, g, y, b, w, S = p && (F || $) && !this.composing && !s.selection.empty && !e.selection.empty && (v = s.selection, g = e.selection, y = Math.min(v.$anchor.sharedDepth(v.head), g.$anchor.sharedDepth(g.head)), v.$anchor.start(y) != g.$anchor.start(y));
                            if (p) {
                                var D = $ ? this.trackWrites = this.domSelectionRange().focusNode : null;
                                this.composing && (this.input.compositionNode = function(e) {
                                    ...
                                    var n = function(e, t) {
                                            for (;;) {
                                                ...
                                                if (1 == e.nodeType && t > 0) {
                                                    ...
                                                    t = x(e = e.childNodes[t - 1])
                                                } else {
                                                    if (!e.parentNode || T(e)) return null;
                                                    t = k(e), e = e.parentNode
                                                }
                                            }
                                    ...
                                    return n || o
                                }(this)), (a || !this.docView.update(e.doc, f, u, this)) && (this.docView.updateOuterDeco(f), this.docView.destroy(), this.docView = eb(e.doc, f, u, this.dom, this)), D && !this.trackWrites && (S = !0)
                            }
                            S || !(this.input.mouseDown && this.domObserver.currentSelection.eq(this.domSelectionRange()) && (b = this.docView.domFromPos(this.state.selection.anchor, 0), w = this.domSelectionRange(), O(b.node, b.offset, w.anchorNode, w.anchorOffset))) ? eB(this, S) : (eq(this, e.selection), this.domObserver.setCurSelection()), this.domObserver.start()
                        }(this.updatePluginViews(s), (null == (i = this.dragging) ? void 0 : i.node) && !s.doc.eq(e.doc) && this.updateDraggedNode(this.dragging, s), "reset" == h) ? this.dom.scrollTop = 0: "to selection" == h ? this.scrollToSelection() : m && (n = m.refDOM, o = m.refTop, ee(m.stack, 0 == (r = n ? n.getBoundingClientRect().top : 0) ? 0 : r - o))
                    }
                }, {
                    ...
                    value: function() {
                        ...
                        if (t && this.dom.contains(1 == t.nodeType ? t : t.parentNode))
                            ...
                            1 == n.nodeType && Q(this, n.getBoundingClientRect(), t)
                        } else Q(this, this.coordsAtPos(this.state.selection.head, 1), t)
                    }
                }, {
                    ...
                    value: function(e, t) {
                        ...
                        this.dragging = new tD(e.slice, e.move, o < 0 ? void 0 : g.NodeSelection.create(this.state.doc, o))
                    }
                }, {
                    key: "someProp",
                    value: function(e, t) {
                    ...
                    value: function() {
                        this.domObserver.stop(), this.editable && function(e) {
                            ...
                            } : void 0), et || (et = !1, ee(t, 0))
                        }(this.dom), eB(this), this.domObserver.start()
                    }
                }, {
                    key: "root",
                    get: function() {
                        ...
                        return function(e, t) {
                            var n, o = e.dom.ownerDocument,
                                ...
                                i = function(e, t, n) {
                                    if (e.caretPositionFromPoint) try {
                                        ...
                                        if (o) return {
                                            node: o.offsetNode,
                                            offset: Math.min(x(o.offsetNode), o.offset)
                                        }
                                    } catch (e) {}
                                    if (e.caretRangeFromPoint) {
                                        ...
                                        if (r) return {
                                            ...
                                            offset: Math.min(x(r.startContainer), r.startOffset)
                                        }
                                    }
                                }(o, t.left, t.top);
                                            ...
                                            for (var i = Math.max(0, Math.min(r - 1, Math.floor(r * (n.top - o.top) / (o.bottom - o.top)) - 2)), s = i;;) {
                                                ...
                                                if (1 == a.nodeType)
                                                    for (var l = a.getClientRects(), c = 0; c < l.length; c++) {
                                                        var d = l[c];
                                                        if (en(n, d)) return e(a, n, d)
                                                    }
                                                if ((s = (s + 1) % r) == i) break
                                            }
                                        return t
                                    }(e.dom, t, a))) return null
                            }
                            if (W)
                                for (var l = s; n && l; l = w(l)) l.draggable && (n = void 0);
                            if (s = (d = (c = s).parentNode) && /^li$/i.test(d.nodeName) && t.left < c.getBoundingClientRect().left ? d : c, n) {
                                if (q && 1 == n.nodeType && (r = Math.min(r, n.childNodes.length)) < n.childNodes.length) {
                                    var c, d, u, f, h, p = n.childNodes[r];
                                    "IMG" == p.nodeName && (h = p.getBoundingClientRect()).right <= t.left && h.bottom > t.top && r++
                                }
                                X && r && 1 == n.nodeType && 1 == (f = n.childNodes[r - 1]).nodeType && "false" == f.contentEditable && f.getBoundingClientRect().top >= t.top && r--, n == e.dom && r == n.childNodes.length - 1 && 1 == n.lastChild.nodeType && t.top > n.lastChild.getBoundingClientRect().bottom ? u = e.state.doc.content.size : (0 == r || 1 != n.nodeType || "BR" != n.childNodes[r - 1].nodeName) && (u = function(e, t, n, o) {
                                    for (var r = -1, i = t, s = !1; i != e.dom;) {
                                        var a = e.docView.nearestDesc(i, !0),
                                            l = void 0;
                                        if (!a) return null;
                                        if (1 == a.dom.nodeType && (a.node.isBlock && a.parent || !a.contentDOM) && ((l = a.dom.getBoundingClientRect()).width || l.height) && (a.node.isBlock && a.parent && (!s && l.left > o.left || l.top > o.top ? r = a.posBefore : (!s && l.right < o.left || l.bottom < o.top) && (r = a.posAfter), s = !0), !a.contentDOM && r < 0 && !a.node.isText)) return (a.node.isBlock ? o.top < (l.top + l.bottom) / 2 : o.left < (l.left + l.right) / 2) ? a.posBefore : a.posAfter;
                                        i = a.dom.parentNode
                                    }
                                        ...
                                        for (var o, r, i, s, a = 2e8, l = 0, c = n.top, d = n.top, u = t.firstChild, f = 0; u; u = u.nextSibling, f++) {
                                            ...
                                            for (var p = 0; p < h.length; p++) {
                                                ...
                                                if (m.top <= c && m.bottom >= d) {
                                                    ...
                                                    if (v < a) {
                                                        i = u, a = v, s = v && 3 == i.nodeType ? {
                                                            left: m.right < n.left ? m.right : m.left,
                                                            top: n.top
                                                        } : n, 1 == u.nodeType && v && (l = f + +(n.left >= (m.left + m.right) / 2));
                                                        continue
                                                    }
                                                } else m.top > n.top && !o && m.left <= n.left && m.right >= n.left && (o = u, r = {
                                                    left: Math.max(m.left, Math.min(m.right, n.left)),
                                                    top: m.top
                                                });
                                                !i && (n.left >= m.right && n.top >= m.top || n.left >= m.left && n.top >= m.bottom) && (l = f + 1)
                                            }
                                        }
                                        return (!i && o && (i = o, s = r, a = 0), i && 3 == i.nodeType) ? function(e, t) {
                                            for (var n = e.nodeValue.length, o = document.createRange(), r = 0; r < n; r++) {
                                                o.setEnd(e, r + 1), o.setStart(e, r);
                                                var i = er(o, 1);
                                                if (i.top != i.bottom && en(t, i)) return {
                                                    node: e,
                                                    offset: r + +(t.left >= (i.left + i.right) / 2)
                                                }
                                            }
                                            return {
                                                node: e,
                    ...
                    value: function(e, t) {
                        return function(e, t, n) {
                            var o, r;
                            return eu == t && ef == n ? eh : (eu = t, ef = n, eh = "up" == n || "down" == n ? (o = t.selection, r = "up" == n ? o.$from : o.$to, ec(e, t, function() {
                                ...
                                for (var i = es(e, r.pos, 1), s = t.firstChild; s; s = s.nextSibling) {
                                    var a = void 0;
                                    ...
                                    for (var l = 0; l < a.length; l++) {
                                        var c = a[l];
                                        if (c.bottom > c.top + 1 && ("up" == n ? i.top - c.top > (c.bottom - i.top) * 2 : c.bottom - i.bottom > (i.bottom - c.top) * 2)) return !1
                                    }
                                }
                                return !0
                            })) : function(e, t, n) {
                                ...
                                var r = o.parentOffset,
                                    ...
                                    s = e.domSelection();
                                return s ? ed.test(o.parent.textContent) && s.modify ? ec(e, t, function() {
                                    var t = e.domSelectionRange(),
                                        r = t.focusNode,
                                        i = t.focusOffset,
                                        a = t.anchorNode,
                                ...
                                }) : "left" == n || "backward" == n ? !r : i : o.pos == o.start() || o.pos == o.end()
                            }(e, t, n))
                        }(this, t || this.state, e)
                    }
                }, {
                    key: "pasteHTML",
                    value: function(e, t) {
                        return tw(this, "", e, !1, t || new ClipboardEvent("paste"))
                    }
                }, {
                    key: "pasteText",
                    value: function(e, t) {
                        return tw(this, e, null, !0, t || new ClipboardEvent("paste"))
                    }
                }, {
                    ...
                    value: function() {
                        if (this.docView) {
                            for (var e in this.domObserver.stop(), this.input.eventHandlers) this.dom.removeEventListener(e, this.input.eventHandlers[e]);
                            clearTimeout(this.input.composingTimeout), clearTimeout(this.input.lastIOSEnterFallbackTimeout), this.destroyPluginViews(), this.mounted ? (this.docView.update(this.state.doc, [], tW(this), this), this.dom.textContent = "") : this.dom.parentNode && this.dom.parentNode.removeChild(this.dom), this.docView.destroy(), this.docView = null, N()
                        }
                    }
                }, {
                    key: "isDestroyed",
                    ...
                    key: "dispatchEvent",
                    value: function(e) {
                        !tc(this, e) && to[e.type] && (this.editable || !(e.type in tr)) && to[e.type](this, e)
                    }
                }, {
                    key: "dispatch",
                    value: function(e) {
                    ...
                    value: function() {
                        ...
                        return e ? W && 11 === this.root.nodeType && function(e) {
                            ...
                            return e.dom.addEventListener("beforeinput", r, !0), document.execCommand("indent"), e.dom.removeEventListener("beforeinput", r, !0), n ? tJ(e, n) : null
                        }(this, e) || e : {
                            focusNode: null,
                            focusOffset: 0,
                            anchorNode: null,
            ...
            function t5(e) {
                ...
                }), t.translate || (t.translate = "no"), [tE.node(0, e.state.doc.content.size, t)]
            }
            ...
            function t6(e) {
                if (e.markCursor) {
                    ...
                    t.className = "ProseMirror-separator", t.setAttribute("mark-placeholder", "true"), t.setAttribute("alt", ""), e.cursorWrapper = {
                        dom: t,
                        deco: tE.widget(e.state.selection.from, t, {
                            raw: !0,
                            marks: e.markCursor
                        })
                    }
            ...
            t.Decoration = tE, t.DecorationSet = tR, t.EditorView = t3, t.__endComposition = tb, t.__parseFromClipboard = e5
        }
    }
]);
//# sourceMappingURL=06e06715-c49593c204b3705e.js.map