...
(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
    [8213], {
        22905: (e, t, n) => {
            ...
            class $ {
                constructor(e, t) {
                    this.splittableMarks = [], this.editor = t, this.extensions = $.resolve(e), this.schema = M(this.extensions, t), this.setupExtensions()
                }
                static resolve(e) {
                    var t;
                    let n = $.sort($.flatten(e)),
                ...
                get plugins() {
                    let {
                        editor: e
                    } = this, t = $.sort([...this.extensions].reverse()), n = [], o = [], s = t.map(t => {
                        let r = {
                                name: t.name,
                                options: t.options,
                                storage: t.storage,
                            ...
                            l = {};
                        if ("mark" === t.type && h(t, "exitable", r) && (l.ArrowRight = () => eF.handleExit({
                                editor: e,
                                mark: t
                            })), a) {
            ...
            function D(e, t) {
                ...
                return B(e) && B(t) && Object.keys(t).forEach(r => {
                    B(t[r]) && B(e[r]) ? n[r] = D(e[r], t[r]) : n[r] = t[r]
                }), n
            }
            class R {
                constructor(e = {}) {
            ...
            let F = R.create({
                ...
                addProseMirrorPlugins() {
                    return [new r.k_({
                        key: new r.hs("clipboardTextSerializer"),
                        props: {
            ...
            function U(e, t, n = {}) {
                return e.find(e => e.type === t && _(e.attrs, n))
            }
            ...
            function H(e, t, n = {}) {
                ...
                let o = U([...r.node.marks], t, n);
                if (!o) return;
                let i = r.index,
                    s = e.start() + r.offset,
                    a = i + 1,
                    l = s + r.node.nodeSize;
                for (U([...r.node.marks], t, n); i > 0 && o.isInSet(e.parent.child(i - 1).marks);) i -= 1, s -= e.parent.child(i).nodeSize;
            ...
            function G(e, t = null) {
                if (!t) return null;
                let n = r.LN.atStart(e),
                    o = r.LN.atEnd(e);
                if ("start" === t || !0 === t) return n;
                if ("end" === t) return o;
                let i = n.from,
                    s = o.to;
                return "all" === t ? r.U3.create(e, W(0, i, s), W(e.content.size, i, s)) : r.U3.create(e, W(t, i, s), W(t, i, s))
            }
            ...
            function X(e, t, n) {
                ...
                let r = "object" == typeof e && null !== e,
                    o = "string" == typeof e;
                if (r) try {
                    if (Array.isArray(e) && e.length > 0) return s.FK.fromArray(e.map(e => t.nodeFromJSON(e)));
                    ...
                    return console.warn("[tiptap warn]: Invalid content.", "Passed value:", e, "Error:", r), X("", t, n)
                }
                if (o) {
                    if (n.errorOnInvalidContent) {
                        ...
                        if (n.slice ? s.S4.fromSchema(i).parseSlice(Y(e), n.parseOptions) : s.S4.fromSchema(i).parse(Y(e), n.parseOptions), n.errorOnInvalidContent && r) throw Error("[tiptap error]: Invalid HTML content", {
                            cause: Error(`Invalid element found: ${o}`)
                        })
                    }
                    let r = s.S4.fromSchema(t);
            ...
            function ee(e, t, n = {}) {
                ...
                let l = o - r,
                    d = a.filter(e => !s || s.name === e.node.type.name).filter(e => _(e.node.attrs, n, {
                        strict: !1
                    }));
            ...
            function ed(e) {
                return t => el(t.$from, e)
            }

            function ec(e, t) {
                let n = s.ZF.fromSchema(t).serializeFragment(e),
                    r = document.implementation.createHTMLDocument().createElement("div");
                return r.appendChild(n), r.innerHTML
            }

            function eu(e, t) {
                return M($.resolve(e), t)
            }

            function ep(e, t) {
                let n = eu(t);
                return ec(s.bP.fromJSON(n, e).content, n)
            }
            ...
            function em(e, t) {
                let n = et("string" == typeof t ? t : t.name, e.schema);
                if ("node" === n) {
                    let n = g(t, e.schema),
                        {
                            from: r,
            ...
            function eg(e) {
                ...
                let o = function(e, t = JSON.stringify) {
                    let n = {};
                    return e.filter(e => {
                        let r = t(e);
            ...
            function eb(e, t, n = {}) {
                let {
                    empty: r,
                    ranges: o
                } = e.selection, i = t ? V(t, e.schema) : null;
                if (r) return !!(e.storedMarks || e.selection.$from.marks()).filter(e => !i || i.name === e.type.name).find(e => _(e.attrs, n, {
                    strict: !1
                }));
                let s = 0,
                    a = [];
                ...
                let l = a.filter(e => !i || i.name === e.mark.type.name).filter(e => _(e.mark.attrs, n, {
                        strict: !1
            ...
            let eS = (e, t) => {
                    let n = ed(e => e.type === t)(e.selection);
                    if (!n) return !0;
                    let r = e.doc.resolve(Math.max(0, n.pos - 1)).before(n.depth);
                    if (void 0 === r) return !0;
                    let o = e.doc.nodeAt(r);
                    return !(n.node.type === (null == o ? void 0 : o.type) && (0, a.n9)(e.doc, n.pos)) || (e.join(n.pos), !0)
                },
                eE = (e, t) => {
                    let n = ed(e => e.type === t)(e.selection);
                    if (!n) return !0;
                    ...
                    if (void 0 === r) return !0;
                    let o = e.doc.nodeAt(r);
                    return !(n.node.type === (null == o ? void 0 : o.type) && (0, a.n9)(e.doc, r)) || (e.join(r), !0)
                };
            var eC = Object.freeze({
                ...
                cut: (e, t) => ({
                    ...
                    return o.insert(a, s.content), o.setSelection(new r.U3(o.doc.resolve(a - 1))), !0
                },
                deleteCurrentNode: () => ({
                    tr: e,
                    dispatch: t
                ...
                extendMarkRange: (e, t = {}) => ({
                    ...
                    if (i) {
                        ...
                        if (e && e.from <= c && e.to >= u) {
                            let t = r.U3.create(a, e.from, e.to);
                            n.setSelection(t)
                        }
                    }
                    return !0
                    ...
                    if (i) {
                        ...
                        try {
                            i = X(t, s.schema, {
                                ...
                                errorOnInvalidContent: null != (l = n.errorOnInvalidContent) ? l : s.options.enableContentCheck
                            })
                        } catch (e) {
                        ...
                        if ((Z(i) ? i : [i]).forEach(e => {
                                e.check(), p = !!p && e.isText && 0 === e.marks.length, h = !!h && e.isBlock
                            }), c === u && h) {
                            let {
                                parent: e
                            } = o.doc.resolve(c);
                            !e.isTextblock || e.type.spec.code || e.childCount || (c -= 1, u += 1)
                        }
                        p ? (d = Array.isArray(t) ? t.map(e => e.text || "").join("") : "object" == typeof t && t && t.text ? t.text : t, o.insertText(d, c, u)) : (d = i, o.replaceWith(c, u, d)), n.updateSelection && function(e, t, n) {
                            let o = e.steps.length - 1;
                            if (o < t) return;
                            let i = e.steps[o];
                            if (!(i instanceof a.Ln || i instanceof a.Wg)) return;
                            let s = e.mapping.maps[o],
                                l = 0;
                            s.forEach((e, t, n, r) => {
                                0 === l && (l = r)
                            }), e.setSelection(r.LN.near(e.doc.resolve(l), -1))
                ...
                joinItemBackward: () => ({
                    ...
                    try {
                        let r = (0, a.N0)(e.doc, e.selection.$from.pos, -1);
                        if (null == r) return !1;
                ...
                keyboardShortcut: e => ({
                    ...
                    let i = (function(e) {
                            ...
                            for (let e = 0; e < i.length - 1; e += 1) {
                                ...
                                else if (/^mod$/i.test(s)) q() || Q() ? o = !0 : n = !0;
                ...
                resetAttributes: (e, t) => ({
                    ...
                    let i = null,
                        s = null,
                        a = et("string" == typeof e ? e : e.name, r.schema);
                    return !!a && ("node" === a && (i = g(e, r.schema)), "mark" === a && (s = V(e, r.schema)), o && n.selection.ranges.forEach(e => {
                        r.doc.nodesBetween(e.$from.pos, e.$to.pos, (e, r) => {
                            i && i === e.type && n.setNodeMarkup(r, void 0, en(e.attrs, t)), s && e.marks.length && e.marks.forEach(o => {
                                s === o.type && n.addMark(r, r + e.nodeSize, s.create(en(o.attrs, t)))
                            })
                        })
                    }), !0)
                },
                ...
                setNode: (e, t = {}) => ({
                    ...
                    return i.isTextblock ? o().command(({
                        commands: e
                    }) => !!(0, l.y_)(i, t)(n) || e.clearNodes()).command(({
                        state: e
                    }) => (0, l.y_)(i, t)(e, r)).run() : (console.warn('[tiptap warn]: Currently "setNode()" only supports text block nodes.'), !1)
                },
                setNodeSelection: e => ({
                    tr: t,
                    dispatch: n
                    ...
                    if (n) {
                        let {
                            doc: n
                        } = t, o = W(e, 0, n.content.size), i = r.nh.create(n, o);
                        t.setSelection(i)
                    }
                    return !0
                },
                setTextSelection: e => ({
                    ...
                    if (n) {
                        let {
                            ...
                            from: e,
                            to: e
                        } : e, s = r.U3.atStart(n).from, a = r.U3.atEnd(n).to, l = W(o, s, a), d = W(i, s, a), c = r.U3.create(n, l, d);
                        t.setSelection(c)
                    }
                    return !0
                },
                ...
                splitBlock: ({
                    ...
                    let {
                        ...
                        $from: d,
                        $to: c
                    } = s, u = ev(i.extensionManager.attributes, d.node().type.name, d.node().attrs);
                    if (s instanceof r.nh && s.node.isBlock) return !!d.parentOffset && !!(0, a.zy)(l, d.pos) && (o && (e && eO(n, i.extensionManager.splittableMarks), t.split(d.pos).scrollIntoView()), !0);
                    ...
                    let p = c.parentOffset === c.parent.content.size,
                        ...
                        m = (0, a.zy)(t.doc, t.mapping.map(d.pos), 1, f);
                    if (!f && !m && (0, a.zy)(t.doc, t.mapping.map(d.pos), 1, h ? [{
                            type: h
                        }] : void 0) && (m = !0, f = h ? [{
                            type: h,
                            attrs: u
                        }] : void 0), o) {
                        if (m && (s instanceof r.U3 && t.deleteSelection(), t.split(t.mapping.map(d.pos), 1, f), h && !p && !d.parentOffset && d.parent.type !== h)) {
                            let e = t.mapping.map(d.before()),
                                n = t.doc.resolve(e);
                            d.node(-1).canReplaceWith(n.index(), n.index() + 1, h) && t.setNodeMarkup(t.mapping.map(d.before()), h)
                        }
                        e && eO(n, i.extensionManager.splittableMarks), t.scrollIntoView()
                    }
                    return m
                },
                splitListItem: (e, t = {}) => ({
                    ...
                    if (0 === u.parent.content.size && u.node(-1).childCount === u.indexAfter(-1)) {
                        ...
                        if (i) {
                            ...
                            for (let t = u.depth - o; t >= u.depth - 3; t -= 1) e = s.FK.from(u.node(t).copy(e));
                            let i = u.indexAfter(-1) < u.node(-2).childCount ? 1 : u.indexAfter(-2) < u.node(-3).childCount ? 2 : 3,
                                a = { ...ev(m, u.node().type.name, u.node().attrs),
                                    ...t
                                },
                                l = (null == (d = c.contentMatch.defaultType) ? void 0 : d.createAndFill(a)) || void 0;
                            e = e.append(s.FK.from(c.createAndFill(null, l) || void 0));
                            let p = u.before(u.depth - (o - 1));
                            n.replace(p, u.after(-i), new s.Ji(e, 4 - o, 0));
                            let h = -1;
                            n.doc.nodesBetween(p, n.doc.content.size, (e, t) => {
                                if (h > -1) return !1;
                                e.isTextblock && 0 === e.content.size && (h = t + 1)
                            }), h > -1 && n.setSelection(r.U3.near(n.doc.resolve(h))), n.scrollIntoView()
                        }
                        return !0
                    }
                    let y = p.pos === u.end() ? f.contentMatchAt(0).defaultType : null,
                        v = { ...ev(m, f.type.name, f.attrs),
                            ...t
                        },
                        b = { ...ev(m, u.node().type.name, u.node().attrs),
                            ...t
                        };
                ...
                toggleList: (e, t, n, r = {}) => ({
                    ...
                    if (!k) return !1;
                    let x = ed(e => ek(e.type.name, u))(m);
                    if (k.depth >= 1 && x && k.depth - x.depth <= 1) {
                        if (x.node.type === h) return d.liftListItem(f);
                        if (ek(x.node.type.name, u) && h.validContent(x.node.content) && a) return l().command(() => (i.setNodeMarkup(x.pos, h), !0)).command(() => eS(i, h)).command(() => eE(i, h)).run()
                    }
                    return n && w && a ? l().command(() => {
                        let e = c().wrapInList(h, r),
                            t = w.filter(e => p.includes(e.type.name));
                        return i.ensureMarks(t), !!e || d.clearNodes()
                    }).wrapInList(h, r).command(() => eS(i, h)).command(() => eE(i, h)).run() : l().command(() => !!c().wrapInList(h, r) || d.clearNodes()).wrapInList(h, r).command(() => eS(i, h)).command(() => eE(i, h)).run()
                },
                toggleMark: (e, t = {}, n = {}) => ({
                    state: r,
                    commands: o
                ...
                toggleNode: (e, t, n = {}) => ({
                    ...
                    let i = g(e, r.schema),
                        s = g(t, r.schema);
                    return ee(r, i, n) ? o.setNode(s) : o.setNode(i, n)
                },
                toggleWrap: (e, t = {}) => ({
                    state: n,
                    commands: r
                ...
                unsetMark: (e, t = {}) => ({
                    ...
                    if (c && s) {
                        let {
                            from: e,
                            to: t
                        } = a, r = null == (i = d.marks().find(e => e.type === l)) ? void 0 : i.attrs, o = H(d, l, r);
                    ...
                    addKeyboardShortcuts() {
                        let e = () => this.editor.commands.first(({
                                ...
                                let {
                                    ...
                                    pos: a,
                                    parent: l
                                } = s, d = s.parent.isTextblock && a > 0 ? t.doc.resolve(a - 1) : s, c = d.parent.type.spec.isolating, u = s.pos - s.parentOffset, p = c && 1 === d.parent.childCount ? u === s.pos : r.LN.atStart(o).from === a;
                        ...
                        return [new r.k_({
                            ...
                            appendTransaction: (e, t, n) => {
                                ...
                                let {
                                    ...
                                    from: i,
                                    to: s
                                } = t.selection, a = r.LN.atStart(t.doc).from, l = r.LN.atEnd(t.doc).to;
            ...
            class eI {
                ...
                get parent() {
                    ...
                    return new eI(this.resolvedPos.doc.resolve(e), this.editor)
                }
                get before() {
                ...
                get children() {
                    ...
                    return this.node.content.forEach((t, n) => {
                        ...
                        let s = new eI(i, this.editor, r, r ? t : null);
                        r && (s.actualDepth = this.depth + 1), e.push(new eI(i, this.editor, r, r ? t : null))
                    }), e
                }
                get firstChild() {
  ...
  opacity: 0
            ...
            class eB extends p {
                ...
                createExtensionManager() {
                    var e, t;
                    let n = [...this.options.enableCoreExtensions ? [eP, F.configure({
                        blockSeparator: null == (t = null == (e = this.options.coreExtensionOptions) ? void 0 : e.clipboardTextSerializer) ? void 0 : t.blockSeparator
                    }), eT, eA, eN, ej] : [], ...this.options.extensions].filter(e => ["extension", "node", "mark"].includes(null == e ? void 0 : e.type));
                    this.extensionManager = new $(n, this)
                }
                ...
                createView() {
                    let e;
                    try {
                        e = er(this.options.content, this.schema, this.options.parseOptions, {
                    ...
                    let t = G(e, this.options.autofocus);
                    this.view = new o.Lz(this.options.element, { ...this.options.editorProps,
                ...
                isActive(e, t) {
                    ...
                    return function(e, t, n = {}) {
                        if (!t) return ee(e, null, n) || eb(e, null, n);
                        let r = et(t, e.schema);
                        return "node" === r ? ee(e, t, n) : "mark" === r && eb(e, t, n)
                    }(this.state, n, r)
                }
                getJSON() {
                ...
                getHTML() {
                    return ec(this.state.doc.content, this.schema)
                }
                getText(e) {
                    let {
                        blockSeparator: t = "\n\n",
                ...
                $pos(e) {
                    return new eI(this.state.doc.resolve(e), this)
                }
                get $doc() {
                    return this.$pos(0)
                }
                    ...
                    handler: ({
                        ...
                        if (s) {
                            let r = a.search(/\S/),
                                ...
                                d = l + s.length;
                            if (ey(n.from, n.to, t.doc).filter(t => t.mark.type.excluded.find(n => n === e.type && n !== t.mark.type)).filter(e => e.to > l).length) return null;
            ...
            function ez(e) {
                return new T({
                    ...
                    handler: ({
                        ...
                        c && c.type === e.type && (0, a.n9)(s.doc, n.from - 1) && (!e.joinPredicate || e.joinPredicate(r, c)) && s.join(n.from - 1)
                    }
                })
            }
            class eF {
            ...
            class eU {
                ...
                onDragStart(e) {
                    ...
                    let f = r.nh.create(d.state.doc, this.getPos()),
                ...
                stopEvent(e) {
                    ...
                    let {
                        ...
                        isDragging: a
                    } = this, l = !!this.node.type.spec.draggable, d = r.nh.isSelectable(this.node), c = "copy" === e.type, u = "paste" === e.type, p = "cut" === e.type, h = "mousedown" === e.type;
                    ...
                    handler: ({
                        ...
                        if (a) {
                            let r = l.search(/\S/),
                                ...
                                c = o + a.length;
                            if (ey(n.from, n.to, t.doc).filter(t => t.mark.type.excluded.find(n => n === e.type && n !== t.mark.type)).filter(e => e.to > o).length) return null;
...
//# sourceMappingURL=5eae7a46-71a31a5cc5147d4d.js.map