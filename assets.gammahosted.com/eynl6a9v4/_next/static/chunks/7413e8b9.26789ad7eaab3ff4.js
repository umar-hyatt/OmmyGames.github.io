...
(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
    [1478], {
        8058: (e, t, n) => {
            ...
            function x(e, t, n, i, o, r, a, l, c, d) {
                ...
                for (n.__k = [], p = 0; p < t.length; p++)
                    if (null != (v = n.__k[p] = null == (v = t[p]) || "boolean" == typeof v ? null : "string" == typeof v || "number" == typeof v || "bigint" == typeof v ? m(null, v, null, null, v) : Array.isArray(v) ? m(b, {
                        ...
                        P(e, v, g = g || h, o, r, a, l, c, d), k = v.__e, (f = v.ref) && g.ref != f && (C || (C = []), g.ref && C.push(g.ref, null, v), C.push(f, v.__c || k, v)), null != k ? (null == y && (y = k), "function" == typeof v.type && v.__k === g.__k ? v.__d = c = function e(t, n, i) {
            ...
            function P(e, t, n, i, o, a, l, c, d) {
                ...
                try {
                    e: if ("function" == typeof E) {
                        if (S = t.props, j = (u = E.contextType) && i[u.__c], z = u ? j ? j.props.value : u.__ : i, n.__c ? C = (p = t.__c = n.__c).__ = p.__E : ("prototype" in E && E.prototype.render ? t.__c = p = new E(S, z) : (t.__c = p = new k(S, z), p.constructor = E, p.render = A), j && j.sub(p), p.props = S, p.state || (p.state = {}), p.context = z, p.__n = i, g = p.__d = !0, p.__h = []), null == p.__s && (p.__s = p.state), null != E.getDerivedStateFromProps && (p.__s == p.state && (p.__s = f({}, p.__s)), f(p.__s, E.getDerivedStateFromProps(S, p.__s))), m = p.props, v = p.state, g) null == E.getDerivedStateFromProps && null != p.componentWillMount && p.componentWillMount(), null != p.componentDidMount && p.__h.push(p.componentDidMount);
                        else {
                        ...
                        p.context = z, p.props = S, p.state = p.__s, (u = s.__r) && u(t), p.__d = !1, p.__v = t, p.__P = e, u = p.render(p.props, p.state, p.context), p.state = p.__s, null != p.getChildContext && (i = f(f({}, i), p.getChildContext())), g || null == p.getSnapshotBeforeUpdate || (y = p.getSnapshotBeforeUpdate(m, v)), L = null != u && u.type === b && null == u.key ? u.props.children : u, x(e, Array.isArray(L) ? L : [L], t, n, i, o, a, l, c, d), p.base = t.__e, t.__h = null, p.__h.length && l.push(p), C && (p.__E = p.__ = null), p.__e = !1
            ...
            function H(e, t, n) {
                var i, o, a;
                s.__ && s.__(e, t), o = (i = "function" == typeof n) ? null : n && n.__k || t.__k, a = [], P(t, e = (!i && n || t).__k = g(b, null, [e]), o || h, h, void 0 !== t.ownerSVGElement, !i && n ? [n] : o ? null : t.firstChild ? r.call(t.childNodes) : null, a, !i && n ? n : o ? o.__e : t.firstChild, i), R(a, e)
            }
            r = u.slice, s = {
                __e: function(e, t) {
            ...
            async function ei(e) {
                ...
                if (t || (t = G.emojiVersion.value), n || (n = G.set.value), o || (o = G.locale.value), X) X.categories = X.categories.filter(e => !e.name);
                else
            ...
            o(ev, "Props", em), "undefined" == typeof customElements || customElements.get("em-emoji") || customElements.define("em-emoji", ev);
            var eb, ek, ew = 0,
                ey = [],
                eC = s.__b,
                ex = s.__r,
            ...
            function eM() {
                var e;
                for (ey.sort(function(e, t) {
                        return e.__v.__b - t.__v.__b
                    }); e = ey.pop();)
                    if (e.__P) try {
                        e.__H.__h.forEach(eE), e.__H.__h.forEach(eP), e.__H.__h = []
                    } catch (t) {
            ...
            s.__b = function(e) {
                ...
                ex && ex(e);
                var t = (eb = e.__c).__H;
                t && (t.__h.forEach(eE), t.__h.forEach(eP), t.__h = [])
            }, s.diffed = function(e) {
                eS && eS(e);
                var t = e.__c;
                t && t.__H && t.__H.__h.length && (1 !== ey.push(t) && ek === s.requestAnimationFrame || ((ek = s.requestAnimationFrame) || function(e) {
                    var t, n = function() {
                            clearTimeout(i), eL && cancelAnimationFrame(t), setTimeout(e)
                        },
                        i = setTimeout(n, 100);
            ...
            function eE(e) {
                var t = eb,
                    n = e.__c;
                "function" == typeof n && (e.__c = void 0, n()), eb = t
            }
            ...
            function eB(e) {
                this.props = e
            }(eB.prototype = new k).isPureReactComponent = !0, eB.prototype.shouldComponentUpdate = function(e, t) {
            ...
            s.unmount = function(e) {
                var t = e.__c;
                t && t.__R && t.__R(), t && !0 === e.__h && (e.type = null), eT && eT(e)
            }, (eI.prototype = new k).__c = function(e, t) {
                var n = t.__c,
                    i = this;
            ...
            (eO.prototype = new k).__e = function(e) {
                var t = this,
                    n = eD(t.__v),
                    i = t.o.get(e);
                return i[0]++,
                    function(o) {
                        var r = function() {
                            t.props.revealOrder ? (i.push(o), eF(t, e, i)) : o()
                        };
                        n ? n(r) : r()
                    }
            ...
            var eV = "undefined" != typeof Symbol && Symbol.for && Symbol.for("react.element") || 60103,
                e$ = /^(?:accent|alignment|arabic|baseline|cap|clip(?!PathU)|color|dominant|fill|flood|font|glyph(?!R)|horiz|marker(?!H|W|U)|overline|paint|stop|strikethrough|stroke|text(?!L)|underline|unicode|units|v|vector|vert|word|writing|x(?!C))[A-Z]/,
            ...
            s.event = function(e) {
                return eN && (e = eN(e)), e.persist = eq, e.isPropagationStopped = eW, e.isDefaultPrevented = eK, e.nativeEvent = e
            };
            var eG = {
                    configurable: !0,
                    get: function() {
            ...
            s.vnode = function(e) {
                ...
                if ("string" == typeof t) {
                    ...
                    })), e.props = i, n.class != n.className && (eG.enumerable = "className" in n, null != n.className && (i.class = n.className), Object.defineProperty(i, "className", eG))
                }
                e.$$typeof = eV, eJ && eJ(e)
            };
            var eX = s.__r;
            ...
            class eZ extends eB {
                renderIcon(e) {
                    ...
                    return n["auto" == this.props.icons ? eY[this.props.theme] : this.props.icons] || n
                }
                render() {
                    let e = null;
                    return I("nav", {
            ...
            class e2 extends k {
                ...
                observeRows() {
                    let e = { ...this.state.visibleRows
                        ...
                        t = new IntersectionObserver(t => {
                            ...
                            root: this.refs.scroll.current,
                            rootMargin: `${this.props.emojiButtonSize*(e1.rowsPerRender+5)}px 0px ${this.props.emojiButtonSize*e1.rowsPerRender}px`
                        });
                    for (let {
                            rows: e
                    ...
                    if (t >= 0 && (e = n[t].__categoryId), e && (r = (this.refs[e] || this.refs.categories.get(e).root).current.getBoundingClientRect().top - (o.top - i.scrollTop) + 1), t >= 0) {
                        if (t) {
                            ...
                            if (e < i.scrollTop) r = e;
                                ...
                                if (!(s > i.scrollTop + o.height)) return;
                                r = s - o.height
                            }
                        } else r = 0
                    }
                ...
                renderEmojiButton(e, {
                    ...
                    let r = this.props.emojiButtonSize,
                        ...
                        l = Array.isArray(o = this.state.pos) && Array.isArray(t) && o.length === t.length && o.every((e, n) => e == t[n]),
                        ...
                        children: e.map(e => {
                            ...
                            return I("div", {
                                ...
                                children: [I("div", {
                                    ...
                                    children: n.map((t, n) => {
                                        let i = t.index - t.index % e1.rowsPerRender,
            ...
            o(e0, "Props", G), "undefined" == typeof customElements || customElements.get("em-emoji-picker") || customElements.define("em-emoji-picker", e0);
            var e3 = {};
...
//# sourceMappingURL=7413e8b9.26789ad7eaab3ff4.js.map