    ...
    [780], {
        30861: (e, t, n) => {
            ...
            function c(e) {
                ...
                return function() {
                    var n, o = u(e);
                    return n = t ? Reflect.construct(o, arguments, u(this).constructor) : o.apply(this, arguments),
                        function(e, t) {
                ...
                for (var o = e.someProp("scrollThreshold") || 0, r = e.someProp("scrollMargin") || 5, i = e.dom.ownerDocument, s = n || e.dom; s; s = k(s))
                    if (1 == s.nodeType) {
                        var a = s,
                            ...
                            d = 0,
                            u = 0;
                        if (t.top < c.top + Y(o, "top") ? u = -(c.top - t.top + Y(r, "top")) : t.bottom > c.bottom - Y(o, "bottom") && (u = t.bottom - t.top > c.bottom - c.top ? t.top + Y(r, "top") - c.top : t.bottom - c.bottom + Y(r, "bottom")), t.left < c.left + Y(o, "left") ? d = -(c.left - t.left + Y(r, "left")) : t.right > c.right - Y(o, "right") && (d = t.right - c.right + Y(r, "right")), d || u) {
                    ...
                    return m(e, [{
                        ...
                        value: function(e, t) {
                            ...
                            return d && u && !d.border && !d.domAtom ? d.domFromPos(0, t) : {
                                node: this.contentDOM,
                                offset: d ? b(d.dom) : this.contentDOM.childNodes.length
                            }
                        }
                    }, {
                        key: "parseRange",
                ...
                eg = function(e) {
                    ...
                    return m(n, [{
                        ...
                        value: function(e, t) {
                            ...
                            }(this.contentDOM, this.children, e), W && function(e) {
                ...
                for (var o = n ? eN[0] : new eS, r = [o], i = 0; i < e.length; i++) {
                    ...
                    if (s)
                        for (var a in s.nodeName && r.push(o = new eS(s.nodeName)), s) {
                            var l = s[a];
                            null != l && (n && 1 == r.length && r.push(o = new eS(t.isInline ? "span" : "div")), "class" == a ? o.class = (o.class ? o.class + " " : "") + l : "style" == a ? o.style = (o.style ? o.style + ";" : "") + l : "nodeName" != a && (o[a] = l))
                        }
                }
                return r
            }
            ...
            var eT = function() {
                function e(t, n, o) {
                    h(this, e), this.lock = n, this.view = o, this.index = 0, this.stack = [], this.changed = !1, this.top = t, this.preMatch = function(e, t) {
                        var n = t,
                            o = n.children.length,
                            r = e.childCount,
                            i = new Map,
                ...
                return m(e, [{
                    ...
                    value: function(e, t, n, o, r, i) {
                        for (var s = this.index; s < this.top.children.length; s++) {
                            ...
                            if (a instanceof eg) {
                                ...
                                if (!u && (d = this.recreateWrapper(a, e, t, n, o, i))) return this.top.children[this.index] = d, d.contentDOM && (d.dirty = 2, d.updateChildren(o, i + 1), d.dirty = 0), this.changed = !0, this.index++, !0;
                                break
                            }
                        }
                        return !1
                    ...
                    value: function() {
                        ...
                        (!e || !(e instanceof eb) || /\n$/.test(e.node.text) || this.view.requiresGeckoHackNode && /\s$/.test(e.node.text)) && ((_ || K) && e && "false" == e.dom.contentEditable && this.addHackNode("IMG", t), this.addHackNode("BR", this.top))
                    }
                }, {
                    key: "addHackNode",
                    value: function(e, t) {
            ...
            function eA(e) {
                ...
                if (T(n)) {
                    ...
                    var d = r.node;
                    if (r && d.isAtom && v.NodeSelection.isSelectable(d) && r.parent && !(d.isInline && function(e, t, n) {
            ...
            function eH(e, t, n) {
                ...
                if (o instanceof v.TextSelection) {
                    ...
                    if (!(j && n.indexOf("m") > -1)) {
                        ...
                        return !!(d.isAtom || (l = e.docView.descAt(u)) && !l.contentDOM) && (v.NodeSelection.isSelectable(d) ? ej(e, new v.NodeSelection(t < 0 ? e.state.doc.resolve(c.pos - d.nodeSize) : c)) : !!G && ej(e, new v.TextSelection(e.state.doc.resolve(t < 0 ? u : u + d.nodeSize))))
                    }
                } else {
            ...
            function e2(e, t) {
                ...
                for (var u, f = d.firstChild, h = 0; f && 1 == f.nodeType && (u = e7[f.nodeName.toLowerCase()]);) {
            ...
            function e3(e, t, n, o, r) {
                ...
                if (l) {
                    if (e.someProp("transformPastedText", function(n) {
                            t = n(t, a || o, e)
                        }), a) return t ? new g.Slice(g.Fragment.from(e.state.schema.text(t.replace(/\r\n?/g, "\n"))), 0, 0) : g.Slice.empty;
                    ...
                    var n, o = te().createElement("div"),
                        r = /<([a-z][^>\s]+)/i.exec(e);
                    if ((n = r && e7[r[1].toLowerCase()]) && (e = n.map(function(e) {
                            return "<" + e + ">"
                        }).join("") + e + n.map(function(e) {
                            return "</" + e + ">"
                        }).reverse().join("")), o.innerHTML = e, n)
                ...
                if (s || (s = (e.someProp("clipboardParser") || e.someProp("domParser") || g.DOMParser.fromSchema(e.state.schema)).parseSlice(i, {
                        preserveWhitespace: !!(l || p),
                        context: r,
                        ruleFromNode: function(e) {
                            return "BR" != e.nodeName || e.nextSibling || !e.parentNode || e5.test(e.parentNode.nodeName) ? null : {
                                ignore: !0
                            }
                        }
                    })), p) s = function(e, t) {
                ...
                else if ((s = g.Slice.maxOpen(function(e, t) {
                                            ...
                                            if (i) {
                                                ...
                                                if (t = i.length && n.length && function e(t, n, o, r, i) {
                                                        if (i < t.length && i < n.length && t[i] == n[i]) {
                                                            ...
                                                            if (r.contentMatchAt(r.childCount).matchType(i == t.length - 1 ? o.type : t[i + 1])) return r.copy(r.content.append(g.Fragment.from(e8(o, t, i + 1))))
                                                        }
            ...
            function e6(e, t, n, o, r, i) {
                var s = t < 0 ? e.firstChild : e.lastChild,
                    a = s.content;
                return e.childCount > 1 && (i = 0), r < o - 1 && (a = e6(a, t, n, o, r + 1, i)), r >= n && (a = t < 0 ? s.contentMatchAt(0).fillBefore(a, i <= r).append(a) : a.append(s.contentMatchAt(s.childCount).fillBefore(g.Fragment.empty, !0))), e.replaceChild(t < 0 ? 0 : e.childCount - 1, s.copy(a))
            }

            function e4(e, t, n) {
                return t < e.openStart && (e = new g.Slice(e6(e.content, -1, t, e.openStart, 0, e.openEnd), t, e.openEnd)), n < e.openEnd && (e = new g.Slice(e6(e.content, 1, n, e.openEnd, 0, 0), e.openStart, n)), e
            }
            var e7 = {
                    thead: ["table"],
                    tbody: ["table"],
            ...
            function te() {
                return e9 || (e9 = document.implementation.createHTMLDocument("title"))
            }
            var tt = {},
                tn = {},
                to = {
            ...
            tn.keydown = function(e, t) {
                if (e.input.shiftKey = 16 == t.keyCode || t.shiftKey, !th(e, t) && (e.input.lastKeyCode = t.keyCode, e.input.lastKeyCodeTime = Date.now(), !U || !K || 13 != t.keyCode)) {
                    if (229 != t.keyCode && e.domObserver.forceFlush(), !W || 13 != t.keyCode || t.ctrlKey || t.altKey || t.metaKey) e.someProp("handleKeyDown", function(n) {
                        return n(e, t)
                    }) || function(e, t) {
                        var n, o = t.keyCode,
                        ...
                        if (40 == o || j && 78 == o && "c" == r) return function(e) {
                            ...
                            if (n && 1 == n.nodeType && 0 == o && n.firstChild && "false" == n.firstChild.contentEditable) {
                                var r = n.firstChild;
                                e1(e, r, "true"), setTimeout(function() {
                                    return e1(e, r, "false")
                                }, 20)
                            }
                            return !1
            ...
            tt.mousedown = function(e, t) {
                ...
                var n, o, r, i = tg(e),
                    s = Date.now(),
                    a = "singleClick";
                s - e.input.lastClick.time < 500 && (o = (n = e.input.lastClick).x - t.clientX) * o + (r = n.y - t.clientY) * r < 100 && !t[tu] && ("singleClick" == e.input.lastClick.type ? a = "doubleClick" : "doubleClick" == e.input.lastClick.type && (a = "tripleClick")), e.input.lastClick = {
                    time: s,
                    x: t.clientX,
                    y: t.clientY,
                    type: a
                ...
                l && ("singleClick" == a ? (e.input.mouseDown && e.input.mouseDown.done(), e.input.mouseDown = new tf(e, l, t, !!i)) : ("doubleClick" == a ? function(e, t, n, o) {
                    return tc(e, "handleDoubleClickOn", t, n, o) || e.someProp("handleDoubleClick", function(n) {
                        return n(e, t, o)
                    })
                } : function(e, t, n, o) {
                    return tc(e, "handleTripleClickOn", t, n, o) || e.someProp("handleTripleClick", function(n) {
                        return n(e, t, o)
                    }) || function(e, t, n) {
                ...
                })(e, l.pos, l.inside, t) ? t.preventDefault() : ti(e, "pointer"))
            };
            var tf = function() {
                function e(t, n, o, r) {
                    var i, s, a = this;
                    if (h(this, e), this.view = t, this.pos = n, this.event = o, this.flushed = r, this.delayedSelectionSync = !1, this.mightDrag = null, this.startDoc = t.state.doc, this.selectNode = !!o[tu], this.allowDefault = o.shiftKey, n.inside > -1) i = t.state.doc.nodeAt(n.inside), s = n.inside;
                    else {
                    ...
                    (0 == o.button && i.type.spec.draggable && !1 !== i.type.spec.selectable || u instanceof v.NodeSelection && u.from <= s && u.to > s) && (this.mightDrag = {
                        node: i,
                        pos: s,
                    ...
                    }, 20), this.view.domObserver.start()), t.root.addEventListener("mouseup", this.up = this.up.bind(this)), t.root.addEventListener("mousemove", this.move = this.move.bind(this)), ti(t, "pointer")
                }
                return m(e, [{
                    key: "done",
                    value: function() {
                    ...
                    value: function(e) {
                        if (this.done(), this.view.dom.contains(e.target)) {
                            ...
                            (this.view.state.doc != this.startDoc && (i = this.view.posAtCoords(tl(e))), this.updateAllowDefault(e), this.allowDefault || !i) ? ti(this.view, "pointer"): (t = this.view, n = i.pos, o = i.inside, r = this.selectNode, tc(t, "handleClickOn", n, o, e) || t.someProp("handleClick", function(o) {
                                return o(t, n, e)
                            }) || (r ? function(e, t) {
                                if (-1 == t) return !1;
                            ...
                            }(t, o))) ? e.preventDefault() : 0 == e.button && (this.flushed || _ && this.mightDrag && !this.mightDrag.node.isAtom || K && !this.view.state.selection.visible && 2 >= Math.min(Math.abs(i.pos - this.view.state.selection.from), Math.abs(i.pos - this.view.state.selection.to))) ? (td(this.view, v.Selection.near(this.view.state.doc.resolve(i.pos)), "pointer"), e.preventDefault()) : ti(this.view, "pointer")
                        }
                    }
                }, {
                    key: "move",
            ...
            tn.compositionstart = tn.compositionupdate = function(e) {
                if (!e.composing) {
                    ...
                    var t = e.state,
                        n = t.selection.$to;
                    if (t.selection instanceof v.TextSelection && (t.storedMarks || !n.textOffset && n.parentOffset && n.nodeBefore.marks.some(function(e) {
            ...
            tt.copy = tn.cut = function(e, t) {
                ...
                if (!e.composing || U) {
                    ...
                    n && tb(e, tk(n), n.getData("text/html"), o, t) ? t.preventDefault() : function(e, t) {
                        if (e.dom.parentNode) {
            ...
            for (var tN in tt.dragstart = function(e, t) {
                    ...
                    if (o && o.done(), t.dataTransfer) {
                        ...
                        var a = (n || e.state.selection).content(),
                            ...
                            d = l.text,
                            u = l.slice;
                        t.dataTransfer.files.length && K && !($ > 120) || t.dataTransfer.clearData(), t.dataTransfer.setData(ty ? "Text" : "text/html", c.innerHTML), t.dataTransfer.effectAllowed = "copyMove", ty || t.dataTransfer.setData("text/plain", d), e.dragging = new tw(u, !t[tS], n)
                    }
                    ...
                    return m(e, [{
                        ...
                        value: function(t, n, o, r, i) {
                            ...
                            return this.children.length ? function(e, t, n, o, r, i, s) {
                                ...
                                if (u) {
                                    var w = tI(function(e, t, n, o, r, i, s) {
                            ...
                            }(this.children, s || [], t, n, o, r, i) : s ? new e(s.sort(tF), tT) : tA
                        }
                    }, {
                        key: "add",
                        value: function(t, n) {
            ...
            function tK(e) {
                ...
                return e.someProp("decorations", function(n) {
                    var o = n(e.state);
                    o && o != tA && t.push(o)
                }), e.cursorWrapper && t.push(tP.create(e.state.doc, [e.cursorWrapper.deco])), tV.from(t)
            }
            var t$ = {
                    childList: !0,
                    characterData: !0,
                ...
                tj = function() {
                    function e(t, n) {
                        var o = this;
                        h(this, e), this.view = t, this.handleDOMChange = n, this.queue = [], this.flushingSoon = -1, this.observer = null, this.currentSelection = new tW, this.onCharData = null, this.suppressingSelectionUpdates = !1, this.lastChangedTextNode = null, this.observer = window.MutationObserver && new window.MutationObserver(function(e) {
                            for (var t = 0; t < e.length; t++) o.queue.push(e[t]);
                            I && F <= 11 && e.some(function(e) {
                                return "childList" == e.type && e.removedNodes.length || "characterData" == e.type && e.oldValue.length > e.target.nodeValue.length
                            }) ? o.flushSoon() : o.flush()
                        }), t_ && (this.onCharData = function(e) {
                            o.queue.push({
                                target: e.target,
                                type: "characterData",
                    ...
                    return m(e, [{
                        ...
                        key: "start",
                        value: function() {
                            this.observer && (this.observer.takeRecords(), this.observer.observe(this.view.dom, t$)), this.onCharData && this.view.dom.addEventListener("DOMCharacterDataModified", this.onCharData), this.connectSelection()
                        }
                    }, {
                        key: "stop",
                        value: function() {
                        ...
                        value: function() {
                            if (this.observer) {
                                var e, t = o(this.observer.takeRecords());
                                try {
                                    for (t.s(); !(e = t.n()).done;) {
                                        var n = e.value;
                                        this.queue.push(n)
                            ...
                            if (e.docView && !(this.flushingSoon > -1)) {
                                ...
                                if (L && c.length) {
                                    ...
                                    if (2 == f.length) {
                                        ...
                                        var g, y = this.currentSelection.focusNode,
                                            b = o(f);
                                        try {
                                            for (b.s(); !(g = b.n()).done;) {
                                                var k = g.value,
                                                    w = k.parentNode;
                                                w && "LI" == w.nodeName && (!y || function(e, t) {
            ...
            function tX(e) {
                ...
                if ("BR" == e.nodeName && e.parentNode) {
                    ...
                    if (e.parentNode.lastChild == e || _ && /^(tr|table)$/i.test(e.parentNode.nodeName)) return {
                        ignore: !0
                    }
            ...
            var t0 = function() {
                            ...
                            return function(e, t, n, o, r) {
                                ...
                                if (e.input.compositionPendingChanges = 0, t < 0) {
                                    ...
                                    if (h && !e.state.selection.eq(h)) {
                                        if (K && U && 13 === e.input.lastKeyCode && Date.now() - 100 < e.input.lastKeyCodeTime && e.someProp("handleKeyDown", function(t) {
                                                return t(e, E(13, "Enter"))
                                            })) return;
                                ...
                                if (N && e.input.domChangeCount++, (W && e.input.lastIOSEnter > Date.now() - 225 || U) && r.some(function(e) {
                                        return 1 == e.nodeType && !tY.test(e.nodeName)
                                    }) && (!N || N.endA >= N.endB) && e.someProp("handleKeyDown", function(t) {
                                        return t(e, E(13, "Enter"))
                                    })) {
                                    e.input.lastIOSEnter = 0;
                                    return
                                ...
                                if (!N) {
                                    if (o && b instanceof v.TextSelection && !b.empty && b.$head.sameParent(b.$anchor) && !e.composing && !(k.sel && k.sel.anchor != k.sel.head)) N = {
                                        start: b.from,
                                        endA: b.to,
                                        endB: b.to
                                    };
                                ...
                                e.state.selection.from < e.state.selection.to && N.start == N.endB && e.state.selection instanceof v.TextSelection && (N.start > e.state.selection.from && N.start <= e.state.selection.from + 2 && e.state.selection.from >= k.from ? N.start = e.state.selection.from : N.endA < e.state.selection.to && N.endA >= e.state.selection.to - 2 && e.state.selection.to <= k.to && (N.endB += e.state.selection.to - N.endA, N.endA = e.state.selection.to)), I && F <= 11 && N.endB == N.start + 1 && N.endA == N.start && N.start > k.from && " \xa0" == k.doc.textBetween(N.start - k.from - 1, N.start - k.from + 1) && (N.start--, N.endA--, N.endB--);
                                ...
                                if ((W && e.input.lastIOSEnter > Date.now() - 225 && (!P || r.some(function(e) {
                                        return "DIV" == e.nodeName || "P" == e.nodeName
                                    })) || !P && C.pos < k.doc.content.size && !C.sameParent(M) && (a = v.Selection.findFrom(k.doc.resolve(C.pos + 1), 1, !0)) && a.head == M.pos) && e.someProp("handleKeyDown", function(t) {
                                        return t(e, E(13, "Enter"))
                                    })) {
                                    e.input.lastIOSEnter = 0;
                                    return
                                }
                                if (e.state.selection.anchor > N.start && function(e, t, n, o, r) {
                                    ...
                                    }(w, N.start, N.endA, C, M) && e.someProp("handleKeyDown", function(t) {
                                        return t(e, E(8, "Backspace"))
                                    })) {
                                    U && K && e.domObserver.suppressSelectionUpdates();
                                    return
                                }
                                K && U && N.endB == N.start && (e.input.lastAndroidDelete = Date.now()), U && !P && C.start() != M.start() && 0 == M.parentOffset && C.depth == M.depth && k.sel && k.sel.anchor == k.sel.head && k.sel.head == N.endA && (N.endB -= 2, M = k.doc.resolveNoCache(N.endB - k.from), setTimeout(function() {
                                ...
                                var A = N.start,
                                    V = N.endA;
                                if (P) {
                                    if (C.pos == M.pos) I && F <= 11 && 0 == C.parentOffset && (e.domObserver.suppressSelectionUpdates(), setTimeout(function() {
                                        return eR(e)
                                    }, 20)), l = e.state.tr.delete(A, V), c = w.resolve(N.start).marksAcross(w.resolve(N.endA));
                                    else if (N.endA == N.endB && (d = function(e, t) {
                                            ...
                                            if (g.Fragment.from(u).eq(e)) return {
                                                mark: o,
                                                type: n
                                            }
                                        }(C.parent.content.cut(C.parentOffset, M.parentOffset), x.parent.content.cut(x.parentOffset, N.endA - x.start())))) l = e.state.tr, "add" == d.type ? l.addMark(A, V, d.mark) : l.removeMark(A, V, d.mark);
                                ...
                                if (l || (l = e.state.tr.replace(A, V, k.doc.slice(N.start - k.from, N.endB - k.from))), k.sel) {
                                    ...
                                    B && !(K && U && e.composing && B.empty && (N.start != N.endB || e.input.lastAndroidDelete < Date.now() - 100) && (B.head == A || B.head == l.mapping.map(V) - 1) || I && B.empty && B.head == A) && l.setSelection(B)
                                }
                                c && l.ensureMarks(c), u && l.setMeta("composition", u), e.dispatch(l.scrollIntoView())
                            }(o, e, t, n, r)
                        }), this.domObserver.start(),
                        function(e) {
                            for (var t in tt) ! function() {
                                var n = tt[t];
                                e.dom.addEventListener(t, e.input.eventHandlers[t] = function(t) {
                                    ! function(e, t) {
                                        ...
                                        return !0
                                    }(e, t) || ta(e, t) || !e.editable && t.type in tn || n(e, t)
                                }, to[t] ? {
                                    passive: !0
                                } : void 0)
                            }();
                            _ && e.dom.addEventListener("input", function() {
                                return null
                            }), ts(e)
                ...
                return m(e, [{
                    ...
                    value: function(e) {
                        ...
                        var t = this._props;
                        this._props = e, e.plugins && (e.plugins.forEach(t8), this.directPlugins = e.plugins), this.updateStateInner(e.state, t)
                    }
                }, {
                    key: "setProps",
                    value: function(e) {
                    ...
                    value: function(e, t) {
                        ...
                        if (l) {
                            ...
                            var v, g, y, k, w, S = p && (I || K) && !this.composing && !s.selection.empty && !e.selection.empty && (v = s.selection, g = e.selection, y = Math.min(v.$anchor.sharedDepth(v.head), g.$anchor.sharedDepth(g.head)), v.$anchor.start(y) != g.$anchor.start(y));
                            if (p) {
                                ...
                                this.composing && (this.input.compositionNode = function(e) {
                                    ...
                                    return n || o
                                }(this)), (a || !this.docView.update(e.doc, f, u, this)) && (this.docView.updateOuterDeco(f), this.docView.destroy(), this.docView = ey(e.doc, f, u, this.dom, this)), N && !this.trackWrites && (S = !0)
                            }
                            S || !(this.input.mouseDown && this.domObserver.currentSelection.eq(this.domSelectionRange()) && (k = this.docView.domFromPos(this.state.selection.anchor, 0), w = this.domSelectionRange(), D(k.node, k.offset, w.anchorNode, w.anchorOffset))) ? eR(this, S) : (eL(this, e.selection), this.domObserver.setCurSelection()), this.domObserver.start()
                        }(this.updatePluginViews(s), (null === (i = this.dragging) || void 0 === i ? void 0 : i.node) && !s.doc.eq(e.doc) && this.updateDraggedNode(this.dragging, s), "reset" == h) ? this.dom.scrollTop = 0: "to selection" == h ? this.scrollToSelection() : m && (n = m.refDOM, o = m.refTop, Z(m.stack, 0 == (r = n ? n.getBoundingClientRect().top : 0) ? 0 : r - o))
                    }
                }, {
                    ...
                    value: function() {
                        this.domObserver.stop(), this.editable && function(e) {
                            ...
                            } : void 0), ee || (ee = !1, Z(t, 0))
                        }(this.dom), eR(this), this.domObserver.start()
                    }
                }, {
                    key: "root",
                    get: function() {
                    ...
                    value: function(e) {
                        return function(e, t) {
                            var n, o = e.dom.ownerDocument,
                                ...
                                i = function(e, t, n) {
                                    if (e.caretPositionFromPoint) try {
                                        ...
                                        if (o) return {
                                            node: o.offsetNode,
                                            offset: Math.min(M(o.offsetNode), o.offset)
                                        }
                                    } catch (e) {}
                                    if (e.caretRangeFromPoint) {
                                        ...
                                        if (r) return {
                                            ...
                                            offset: Math.min(M(r.startContainer), r.startOffset)
                                        }
                                    }
                                }(o, t.left, t.top);
                            ...
                            if (_)
                                for (var l = s; n && l; l = k(l)) l.draggable && (n = void 0);
                            if (s = (d = (c = s).parentNode) && /^li$/i.test(d.nodeName) && t.left < c.getBoundingClientRect().left ? d : c, n) {
                                ...
                                G && r && 1 == n.nodeType && 1 == (f = n.childNodes[r - 1]).nodeType && "false" == f.contentEditable && f.getBoundingClientRect().top >= t.top && r--, n == e.dom && r == n.childNodes.length - 1 && 1 == n.lastChild.nodeType && t.top > n.lastChild.getBoundingClientRect().bottom ? u = e.state.doc.content.size : (0 == r || 1 != n.nodeType || "BR" != n.childNodes[r - 1].nodeName) && (u = function(e, t, n, o) {
                                    for (var r = -1, i = t, s = !1; i != e.dom;) {
                                        ...
                                        if (1 == a.dom.nodeType && (a.node.isBlock && a.parent || !a.contentDOM)) {
                                            ...
                                            if (a.node.isBlock && a.parent && (!s && l.left > o.left || l.top > o.top ? r = a.posBefore : (!s && l.right < o.left || l.bottom < o.top) && (r = a.posAfter), s = !0), !a.contentDOM && r < 0 && !a.node.isText) return (a.node.isBlock ? o.top < (l.top + l.bottom) / 2 : o.left < (l.left + l.right) / 2) ? a.posBefore : a.posAfter
                                        }
                                        i = a.dom.parentNode
                                    }
                                ...
                                var o = function e(t, n) {
                                                ...
                                                if (m.top <= c && m.bottom >= d) {
                                                    ...
                                                    if (v < a) {
                                                        i = u, a = v, s = v && 3 == i.nodeType ? {
                                                            ...
                                                            top: n.top
                                                        } : n, 1 == u.nodeType && v && (l = f + (n.left >= (m.left + m.right) / 2 ? 1 : 0));
                                                        continue
                                                    }
                                        ...
                                        return (!i && o && (i = o, s = r, a = 0), i && 3 == i.nodeType) ? function(e, t) {
                                            for (var n = e.nodeValue.length, o = document.createRange(), r = 0; r < n; r++) {
                                                ...
                                                var i = eo(o, 1);
                                                if (i.top != i.bottom && et(t, i)) return {
                                                    node: e,
                    ...
                    value: function(e, t) {
                        var n, o, r, i, s;
                        return n = this, o = t || this.state, r = e, ed == o && eu == r ? ef : (ed = o, eu = r, ef = "up" == r || "down" == r ? (i = o.selection, s = "up" == r ? i.$from : i.$to, el(n, o, function() {
                            ...
                            var r = o.parentOffset,
                                ...
                                s = e.domSelection();
                            return s ? ec.test(o.parent.textContent) && s.modify ? el(e, t, function() {
                                var t = e.domSelectionRange(),
                                    r = t.focusNode,
                                    i = t.focusOffset,
                                    a = t.anchorNode,
                    ...
                    value: function() {
                        ...
                        }(this), this.destroyPluginViews(), this.mounted ? (this.docView.update(this.state.doc, [], tK(this), this), this.dom.textContent = "") : this.dom.parentNode && this.dom.parentNode.removeChild(this.dom), this.docView.destroy(), this.docView = null, N())
                    }
                }, {
                    key: "isDestroyed",
                    get: function() {
                    ...
                    value: function() {
                        ...
                        return e ? _ && 11 === this.root.nodeType && function(e) {
            ...
            function t1(e) {
                ...
                }), t.translate || (t.translate = "no"), [tx.node(0, e.state.doc.content.size, t)]
            }
            ...
            function t2(e) {
                if (e.markCursor) {
                    ...
                    t.className = "ProseMirror-separator", t.setAttribute("mark-placeholder", "true"), t.setAttribute("alt", ""), e.cursorWrapper = {
                        dom: t,
                        deco: tx.widget(e.state.selection.from, t, {
                            raw: !0,
                            marks: e.markCursor
                        })
                    }
