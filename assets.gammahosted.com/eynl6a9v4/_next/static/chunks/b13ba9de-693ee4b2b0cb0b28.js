...
`, t - 1) + 1, a = e4.findLineEnd(s, i), o = e.value.slice(n, a), r = o.replace(/(^|\n)(\t| {1,2})/g, "$1"), l = o.length - r.length;
            ...
            function te(e, t, i) {
                let {
                    ...
                    let [n, a] = t, o = s.Aq.rng(e), r = Array.from([, , , ]).map(() => [o() * i * .75, o() * i * .75]), l = [h.A.add([n / 2, 0], r[0]), h.A.add([n, a], r[1]), h.A.add([0, a], r[2])], d = Math.round(Math.abs(6 * o())), p = s.Aq.rotateArray([h.A.pointsBetween(l[0], l[1], 32), h.A.pointsBetween(l[1], l[2], 32), h.A.pointsBetween(l[2], l[0], 32)], d);
                    return {
                        points: [...p.flat(), ...p[0]]
                    }
                }(e, t, n);
                    ...
                    static getLinkedShapeIds(e, t, i, s = !0) {
                        ...
                        for (; l.length;) {
                            ...
                            r.has(e) || (r.add(e), d.forEach(t => {
                                ...
                                } = t, c = h ? a.bindings[h] : null, u = p ? a.bindings[p] : null;
                                        ...
                                        case "triangle":
                                            {
                                                let a = i.target.point,
                                                    o = e9(i.target.size, i.hasDecoration ? 16 : 0, i.target.rotation).map(e => h.l.add(e, a)),
...
`)
            ...
            function t_(e, t, i) {
                ...
                let {
                    points: I
                } = (n = e2(t), a = s.Aq.rng(e), o = n.strokeWidth, r = Math.max(0, i[0]), l = Math.max(0, i[1]), d = Array.from([, , , , ]).map(() => [a() * o * .75, a() * o * .75]), p = h.A.add([o / 2, o / 2], d[0]), c = h.A.add([r - o / 2, o / 2], d[1]), u = h.A.add([r - o / 2, l - o / 2], d[2]), g = h.A.add([o / 2, l - o / 2], d[3]), m = Math.round(Math.abs(8 * a())), f = Math.min(r / 4, 2 * o), v = Math.min(l / 4, 2 * o), b = Math.max(8, Math.floor(r / 16)), y = Math.max(8, Math.floor(l / 16)), {
            ...
            var iK = class {
                    ...
                    constructor() {
                        super(...arguments), B(this, "type", "select"), B(this, "pointedId"), B(this, "selectedGroupId"), B(this, "pointedHandleId"), B(this, "pointedBoundsHandle"), B(this, "pointedLinkHandleId"), B(this, "onEnter", () => {
                            ...
                            if (this.app.readOnly && this.app.isPointing) {
                                this.app.session ? this.app.updateSession() : h.A.dist(e, t) > 3 && (this.app.startSession("brush"), this.setStatus("brushing"));
                                return
                            }
                            switch (this.status) {
                ...
                i7 = class extends iy {
                    constructor(e, t = {}) {
                                ...
                                if (!a || i.shapes !== a.shapes || i.bindings !== a.bindings) {
                                    ...
                                    r.forEach(t => {
                                        ...
                                        let s = i.shapes[t.toId],
                                            a = i.shapes[t.fromId];
                                        if (!(s && a)) {
                                            delete n.document.pages[e].bindings[t.id];
                                            return
                                        }
                                        if (l.has(a)) return;
                        ...
                        }(this, e))), B(this, "deletePage", e => this.readOnly ? this : Object.values(this.document.pages).length <= 1 ? this : this.setState(function(e, t) {
                            let {
                                currentPageId: i,
                                document: {
                                    pages: s,
...
`);
          ...
          `
                        ...
                        }), B(this, "duplicate", (e = this.selectedIds, t) => this.readOnly ? this : 0 === e.length ? this : this.setState(function(e, t, i) {
                            let {
                                selectedIds: n,
                                currentPageId: a,
                                page: o,
                        ...
                        }(this, t, e)) : this), B(this, "setShapeProps", (e, t = this.selectedIds) => this.setState(function(e, t, i) {
                            let {
                                currentPageId: s,
                                selectedIds: n
...
//# sourceMappingURL=b13ba9de-693ee4b2b0cb0b28.js.map