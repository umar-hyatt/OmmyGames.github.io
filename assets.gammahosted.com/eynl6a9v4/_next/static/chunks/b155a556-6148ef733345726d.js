    ...
    [9573], {
        73686: (e, t, n) => {
            ...
            let x = !C && /Chrome\/(\d+)/.exec(w),
                ...
                A = E && (/Mobile\/\w+/.test(w) || !!b && b.maxTouchPoints > 2),
                P = A || !!b && /Mac/.test(b.platform),
            ...
            function z(e, t, n) {
                ...
                for (let r = n || e.dom; r; r = l(r)) {
                    ...
                    let e = r,
                        ...
                        d = 0,
                        a = 0;
                    if (t.top < l.top + L(o, "top") ? a = -(l.top - t.top + L(i, "top")) : t.bottom > l.bottom - L(o, "bottom") && (a = t.bottom - t.top > l.bottom - l.top ? t.top + L(i, "top") - l.top : t.bottom - l.bottom + L(i, "bottom")), t.left < l.left + L(o, "left") ? d = -(l.left - t.left + L(i, "left")) : t.right > l.right - L(o, "right") && (d = t.right - l.right + L(i, "right")), d || a) {
            ...
            function _(e, t, n) {
                ...
                if (3 == o.nodeType) {
                    if (r && (H.test(o.nodeValue) || (n < 0 ? !i : i == o.nodeValue.length))) {
                        let e = U(a(o, i, i), n);
                        ...
                        let e = i,
                            t = i,
                            s = n < 0 ? 1 : -1;
                        return n < 0 && !i ? (t++, s = -1) : n >= 0 && i == o.nodeValue.length ? (e--, s = 1) : n < 0 ? e-- : t++, G(U(a(o, e, t), s), s < 0)
                    }
                }
            ...
            class eo extends ee {
                ...
                static create(e, t, n, o) {
                    let s = o.nodeViews[t.type.name],
                        r = s && s(t, o, n);
                    return r && r.dom || (r = i.ZF.renderSpec(document, t.type.spec.toDOM(t, n), null, t.attrs)), new eo(e, t, r.dom, r.contentDOM || r.dom)
                }
                parseRule() {
            ...
            class ei extends ee {
                ...
                updateChildren(e, t) {
                    ...
                    }(this.contentDOM, this.children, e), A && function(e) {
                ...
                updateNextNode(e, t, n, o, i, s) {
                    for (let r = this.index; r < this.top.children.length; r++) {
                        ...
                        if (l instanceof ei) {
                            ...
                            if (!h && (c = this.recreateWrapper(l, e, t, n, o, s))) return this.top.children[this.index] = c, c.contentDOM && (c.dirty = 2, c.updateChildren(o, s + 1), c.dirty = 0), this.changed = !0, this.index++, !0;
                            break
                        }
                    }
                    return !1
                ...
                if (eM(e, n), ew(e)) {
                    ...
                    if (e.domObserver.disconnectSelection(), e.cursorWrapper) ! function(e) {
                        ...
                        let i, s, r, l, {
                            ...
                            c, h;
                        !eN || n instanceof o.U3 || (n.$from.parent.inlineContent || (c = eS(e, n.from)), n.empty || n.$from.parent.inlineContent || (h = eS(e, n.to))), e.docView.setSelection(d, a, e.root, t), eN && (c && eO(c), h && eO(h)), n.visible ? e.dom.classList.remove("ProseMirror-hideselection") : (e.dom.classList.add("ProseMirror-hideselection"), "onselectionchange" in document && ((i = e.dom.ownerDocument).removeEventListener("selectionchange", e.input.hideSelectionGuard), r = (s = e.domSelectionRange()).anchorNode, l = s.anchorOffset, i.addEventListener("selectionchange", e.input.hideSelectionGuard = () => {
                            (s.anchorNode != r || s.anchorOffset != l) && (i.removeEventListener("selectionchange", e.input.hideSelectionGuard), setTimeout(() => {
            ...
            function eV(e, t, n) {
                ...
                if (i instanceof o.U3) {
                    if (n.indexOf("s") > -1) {
                        ...
                        return eP(e, new o.U3(i.$anchor, r))
                    }
                    if (!i.empty) return !1;
                    if (e.endOfTextblock(t > 0 ? "forward" : "backward")) {
                        let n = eA(e.state, t);
                        return !!n && n instanceof o.nh && eP(e, n)
                    }
                    if (!(P && n.indexOf("m") > -1)) {
                        let n = i.$head,
                        ...
                        return !!(s.isAtom || (r = e.docView.descAt(l)) && !r.contentDOM) && (o.nh.isSelectable(s) ? eP(e, new o.nh(t < 0 ? e.state.doc.resolve(n.pos - s.nodeSize) : n)) : !!B && eP(e, new o.U3(e.state.doc.resolve(t < 0 ? l : l + s.nodeSize))))
                    }
                } else {
                    if (i instanceof o.nh && i.node.isInline) return eP(e, new o.U3(t > 0 ? i.$to : i.$from));
                    let n = eA(e.state, t);
                    return !!n && eP(e, n)
                }
            }
            ...
            function eK(e, t, n) {
                let i = e.state.selection;
                if (i instanceof o.U3 && !i.empty || n.indexOf("s") > -1 || P && n.indexOf("m") > -1) return !1;
                let {
                    $from: s,
                    $to: r
                } = i;
                if (!s.parent.inlineContent || e.endOfTextblock(t < 0 ? "up" : "down")) {
                    let n = eA(e.state, t);
                    if (n && n instanceof o.nh) return eP(e, n)
                }
            ...
            function eU(e, t, n, o, s) {
                ...
                if (a) {
                    ...
                    let n = eX().createElement("div"),
                        o = /<([a-z][^>\s]+)/i.exec(e),
                        i;
                    if ((i = o && ej[o[1].toLowerCase()]) && (e = i.map(e => "<" + e + ">").join("") + e + i.map(e => "</" + e + ">").reverse().join("")), n.innerHTML = e, i)
                ...
                if (l || (l = (e.someProp("clipboardParser") || e.someProp("domParser") || i.S4.fromSchema(e.state.schema)).parseSlice(r, {
                        ...
                        context: s,
                        ruleFromNode: e => "BR" != e.nodeName || e.nextSibling || !e.parentNode || eH.test(e.parentNode.nodeName) ? null : {
                            ignore: !0
                        }
                    })), h) l = function(e, t) {
                    if (!e.size) return e;
            ...
            let eH = /^(a|abbr|acronym|b|cite|code|del|em|i|ins|kbd|label|output|q|ruby|s|samp|span|strong|sub|sup|time|u|tt|var)$/i;
            ...
            eQ.keydown = (e, t) => {
                if (e.input.shiftKey = 16 == t.keyCode || t.shiftKey, !te(e, t) && (e.input.lastKeyCode = t.keyCode, e.input.lastKeyCodeTime = Date.now(), !R || !k || 13 != t.keyCode)) {
                    if (229 != t.keyCode && e.domObserver.forceFlush(), !A || 13 != t.keyCode || t.ctrlKey || t.altKey || t.metaKey) e.someProp("handleKeyDown", n => n(e, t)) || function(e, t) {
                        let n;
                        let o = t.keyCode,
                            i = (n = "", t.ctrlKey && (n += "c"), t.metaKey && (n += "m"), t.altKey && (n += "a"), t.shiftKey && (n += "s"), n);
                        if (8 == o || P && 72 == o && "c" == i) return eq(e, -1) || eF(e, -1);
                        if (46 == o && !t.shiftKey || P && 68 == o && "c" == i) return eq(e, 1) || eF(e, 1);
                        ...
                        if (38 == o || P && 80 == o && "c" == i) return eK(e, -1, i) || eF(e, -1);
                        if (40 == o || P && 78 == o && "c" == i) return function(e) {
                        ...
                        else if (i == (P ? "m" : "c") && (66 == o || 73 == o || 89 == o || 90 == o)) return !0;
                        return !1
                    }(e, t) ? t.preventDefault() : e3(e, "key");
                    else {
                        let t = Date.now();
                ...
                if (te(e, t) || !t.charCode || t.ctrlKey && !t.altKey || P && t.metaKey) return;
            ...
            eY.mousedown = (e, t) => {
                ...
                r && ("singleClick" == s ? (e.input.mouseDown && e.input.mouseDown.done(), e.input.mouseDown = new e4(e, r, t, !!n)) : ("doubleClick" == s ? function(e, t, n, o) {
                    return e8(e, "handleDoubleClickOn", t, n, o) || e.someProp("handleDoubleClick", n => n(e, t, o))
                } : function(e, t, n, i) {
                    return e8(e, "handleTripleClickOn", t, n, i) || e.someProp("handleTripleClick", n => n(e, t, i)) || function(e, t, n) {
                        if (0 != n.button) return !1;
                        let i = e.state.doc;
                        if (-1 == t) return !!i.inlineContent && (e9(e, o.U3.create(i, 0, i.content.size), "pointer"), !0);
                        let s = i.resolve(t);
                        for (let t = s.depth + 1; t > 0; t--) {
                            let n = t > s.depth ? s.nodeAfter : s.node(t),
                                r = s.before(t);
                            if (n.inlineContent) e9(e, o.U3.create(i, r + 1, r + 1 + n.content.size), "pointer");
                            else {
                                if (!o.nh.isSelectable(n)) continue;
                                e9(e, o.nh.create(i, r), "pointer")
                            }
                            return !0
                        }
                    }(e, n, i)
                })(e, r.pos, r.inside, t) ? t.preventDefault() : e3(e, "pointer"))
            };
            class e4 {
                constructor(e, t, n, i) {
                    let s, r;
                    ...
                    }, 20), this.view.domObserver.start()), e.root.addEventListener("mouseup", this.up = this.up.bind(this)), e.root.addEventListener("mousemove", this.move = this.move.bind(this)), e3(e, "pointer")
                }
                done() {
                ...
                up(e) {
                    ...
                    let t = this.pos;
                    if (this.view.state.doc != this.startDoc && (t = this.view.posAtCoords(e6(e))), this.updateAllowDefault(e), this.allowDefault || !t) e3(this.view, "pointer");
                    else {
                        var n, i, s, r;
                        (n = this.view, i = t.pos, s = t.inside, r = this.selectNode, e8(n, "handleClickOn", i, s, e) || n.someProp("handleClick", t => t(n, i, e)) || (r ? function(e, t) {
                            if (-1 == t) return !1;
                            let n = e.state.selection,
                                i, s;
                            ...
                            return null != s && (e9(e, o.nh.create(e.state.doc, s), "pointer"), !0)
                        }(n, s) : function(e, t) {
                            if (-1 == t) return !1;
                            let n = e.state.doc.resolve(t),
                                i = n.nodeAfter;
                            return !!(i && i.isAtom && o.nh.isSelectable(i)) && (e9(e, new o.nh(n), "pointer"), !0)
                        }(n, s))) ? e.preventDefault(): 0 == e.button && (this.flushed || E && this.mightDrag && !this.mightDrag.node.isAtom || k && !this.view.state.selection.visible && 2 >= Math.min(Math.abs(t.pos - this.view.state.selection.from), Math.abs(t.pos - this.view.state.selection.to))) ? (e9(this.view, o.LN.near(this.view.state.doc.resolve(t.pos)), "pointer"), e.preventDefault()) : e3(this.view, "pointer")
                    }
                }
                move(e) {
                    this.updateAllowDefault(e), e3(this.view, "pointer"), 0 == e.buttons && this.done()
                }
            ...
            eY.touchstart = e => {
                e.input.lastTouch = Date.now(), ti(e), e3(e, "pointer")
            }, eY.touchmove = e => {
                e.input.lastTouch = Date.now(), e3(e, "pointer")
            }, eY.contextmenu = e => ti(e);
            let tt = R ? 5e3 : -1;
            ...
            eQ.compositionstart = eQ.compositionupdate = e => {
                if (!e.composing) {
                    e.domObserver.flush();
                    let {
                        state: t
                    } = e, n = t.selection.$to;
                    if (t.selection instanceof o.U3 && (t.storedMarks || !n.textOffset && n.parentOffset && n.nodeBefore.marks.some(e => !1 === e.type.spec.inclusive))) e.markCursor = e.state.storedMarks || n.marks(), ti(e, !0), e.markCursor = null;
                ...
                e.composing && (e.input.composing = !1, e.input.compositionEndedAt = t.timeStamp, e.input.compositionPendingChanges = e.domObserver.pendingRecords().length ? e.input.compositionID : 0, e.input.compositionNode = null, e.input.compositionPendingChanges && Promise.resolve().then(() => e.domObserver.flush()), e.input.compositionID++, tn(e, 20))
            };
            let ts = C && O < 15 || A && F < 604;

            function tr(e, t, n, o, s) {
                let r = eU(e, t, n, o, e.state.selection.$from);
            ...
            eY.copy = eQ.cut = (e, t) => {
                ...
                n && tr(e, tl(n), n.getData("text/html"), o, t) ? t.preventDefault() : function(e, t) {
                    if (!e.dom.parentNode) return;
            ...
            let ta = P ? "altKey" : "ctrlKey";
            for (let e in eY.dragstart = (e, t) => {
                    let n;
                    ...
                    t.dataTransfer.files.length && k && !(T > 120) || t.dataTransfer.clearData(), t.dataTransfer.setData(ts ? "Text" : "text/html", d.innerHTML), t.dataTransfer.effectAllowed = "copyMove", ts || t.dataTransfer.setData("text/plain", a), e.dragging = new td(c, !t[ta], n)
                }, eY.dragend = e => {
                    let t = e.dragging;
                    window.setTimeout(() => {
                        e.dragging == t && (e.dragging = null)
                    }, 50)
                }, eQ.dragover = eQ.dragenter = (e, t) => t.preventDefault(), eQ.drop = (e, t) => {
                    let n = e.dragging;
                    ...
                    d ? e.someProp("transformPasted", t => {
                        d = t(d, e)
                    }) : d = eU(e, tl(t.dataTransfer), ts ? null : t.dataTransfer.getData("text/html"), !1, l);
                    let a = !!(n && !t[ta]);
                    if (e.someProp("handleDrop", n => n(e, t, d || i.Ji.empty, a))) {
                        t.preventDefault();
                        return
                    }
                    if (!d) return;
            ...
            class ty {
                ...
                mapInner(e, t, n, o, i) {
                    ...
                    return this.children.length ? function(e, t, n, o, i, s, r) {
                        ...
                        if (d) {
                            let d = tS(function(e, t, n, o, i, s, r) {
                    ...
                    }(this.children, s || [], e, t, n, o, i) : s ? new ty(s.sort(tC), tm) : tb
                }
                add(e, t) {
            ...
            function tx(e) {
                ...
                return e.someProp("decorations", n => {
                    let o = n(e.state);
                    o && o != tb && t.push(o)
                }), e.cursorWrapper && t.push(ty.create(e.state.doc, [e.cursorWrapper.deco])), tv.from(t)
            }
            let tk = {
                    childList: !0,
                    characterData: !0,
            ...
            class tA {
                constructor(e, t) {
                    this.view = e, this.handleDOMChange = t, this.queue = [], this.flushingSoon = -1, this.observer = null, this.currentSelection = new tE, this.onCharData = null, this.suppressingSelectionUpdates = !1, this.lastChangedTextNode = null, this.observer = window.MutationObserver && new window.MutationObserver(e => {
                ...
                flush() {
                    ...
                    if (M && d.length) {
                        ...
                        if (2 == t.length) {
                            ...
                            for (let o of t) {
                                let t = o.parentNode;
                                t && "LI" == t.nodeName && (!n || function(e, t) {
                    ...
                    let a = null;
                    s < 0 && i && e.input.lastFocus > Date.now() - 200 && Math.max(e.input.lastTouch, e.input.lastClick.time) < Date.now() - 300 && g(n) && (a = ev(e)) && a.eq(o.LN.near(e.state.doc.resolve(0), 1)) ? (e.input.lastFocus = 0, eD(e), this.currentSelection.set(n), e.scrollToSelection()) : (s > -1 || i) && (s > -1 && (e.docView.markDirty(s, r), tP.has(e) || (tP.set(e, null), -1 === ["normal", "nowrap", "pre-line"].indexOf(getComputedStyle(e.dom).whiteSpace)) || (e.requiresGeckoHackNode = M, tV || (console.warn("ProseMirror expects the CSS white-space property to be set, preferably to 'pre-wrap'. It is recommended to load style/prosemirror.css from the prosemirror-view package."), tV = !0))), this.handleDOMChange(s, r, l, d), e.docView && e.docView.dirty ? e.updateState(e.state) : this.currentSelection.eq(n) || eD(e), this.currentSelection.set(n))
                }
            ...
            function tB(e) {
                ...
                if ("BR" == e.nodeName && e.parentNode) {
                    ...
                    if (e.parentNode.lastChild == e || E && /^(tr|table)$/i.test(e.parentNode.nodeName)) return {
                        ignore: !0
                    }
            ...
            let tF = /^(a|abbr|acronym|b|bd[io]|big|br|button|cite|code|data(list)?|del|dfn|em|i|ins|kbd|label|map|mark|meter|output|q|ruby|s|samp|small|span|strong|su[bp]|time|u|tt|var)$/i;
            ...
            class tK {
                constructor(e, t) {
                    this._root = null, this.focused = !1, this.trackWrites = null, this.mounted = !1, this.markCursor = null, this.cursorWrapper = null, this.lastSelectedViewDesc = void 0, this.input = new e1, this.prevDirectPlugins = [], this.pluginViews = [], this.requiresGeckoHackNode = !1, this.dragging = null, this._props = t, this.state = t.state, this.directPlugins = t.plugins || [], this.directPlugins.forEach(tH), this.dispatch = this.dispatch.bind(this), this.dom = e && e.mount || document.createElement("div"), e && (e.appendChild ? e.appendChild(this.dom) : "function" == typeof e ? e(this.dom) : e.mount && (this.mounted = !0)), this.editable = tW(this), t$(this), this.nodeViews = tU(this), this.docView = es(this.state.doc, tq(this), tx(this), this.dom, this), this.domObserver = new tA(this, (e, t, n, s) => (function(e, t, n, s, r) {
                            ...
                            let N = function(e, t, n, o, i) {
                                ...
                                if (r < s && e.size < t.size) {
                                    let e = o <= s && o >= r ? s - o : 0;
                                    (s -= e) && s < t.size && tI(t.textBetween(s - 1, s + 1)) && (s += e ? 1 : -1), l = s + (l - r), r = s
                                } else if (l < s) {
                                    let t = o <= s && o >= l ? s - o : 0;
                                    (s -= t) && s < e.size && tI(e.textBetween(s - 1, s + 1)) && (s += t ? 1 : -1), r = s + (r - l), l = s
                                }
                                return {
                                    start: s,
                                    endA: r,
                            ...
                            if (N && e.input.domChangeCount++, (A && e.input.lastIOSEnter > Date.now() - 225 || R) && r.some(e => 1 == e.nodeType && !tF.test(e.nodeName)) && (!N || N.endA >= N.endB) && e.someProp("handleKeyDown", t => t(e, y(13, "Enter")))) {
                                e.input.lastIOSEnter = 0;
                                return
                            }
                            if (!N) {
                                if (s && b instanceof o.U3 && !b.empty && b.$head.sameParent(b.$anchor) && !e.composing && !(v.sel && v.sel.anchor != v.sel.head)) N = {
                                    start: b.from,
                                    endA: b.to,
                                    endB: b.to
                                };
                            ...
                            e.state.selection.from < e.state.selection.to && N.start == N.endB && e.state.selection instanceof o.U3 && (N.start > e.state.selection.from && N.start <= e.state.selection.from + 2 && e.state.selection.from >= v.from ? N.start = e.state.selection.from : N.endA < e.state.selection.to && N.endA >= e.state.selection.to - 2 && e.state.selection.to <= v.to && (N.endB += e.state.selection.to - N.endA, N.endA = e.state.selection.to)), C && O <= 11 && N.endB == N.start + 1 && N.endA == N.start && N.start > v.from && " \xa0" == v.doc.textBetween(N.start - v.from - 1, N.start - v.from + 1) && (N.start--, N.endA--, N.endB--);
                            ...
                            if ((A && e.input.lastIOSEnter > Date.now() - 225 && (!T || r.some(e => "DIV" == e.nodeName || "P" == e.nodeName)) || !T && S.pos < v.doc.content.size && !S.sameParent(M) && (a = o.LN.findFrom(v.doc.resolve(S.pos + 1), 1, !0)) && a.head == M.pos) && e.someProp("handleKeyDown", t => t(e, y(13, "Enter")))) {
                                e.input.lastIOSEnter = 0;
                                return
                            }
                            if (e.state.selection.anchor > N.start && function(e, t, n, o, i) {
                                    if (n - t <= i.pos - o.pos || tz(o, !0, !1) < i.pos) return !1;
                                    let s = e.resolve(t);
                                    ...
                                    let r = e.resolve(tz(s, !0, !0));
                                    return !(!r.parent.isTextblock || r.pos > n || tz(r, !0, !1) < n) && o.parent.content.cut(o.parentOffset).eq(r.parent.content)
                                }(w, N.start, N.endA, S, M) && e.someProp("handleKeyDown", t => t(e, y(8, "Backspace")))) {
                                R && k && e.domObserver.suppressSelectionUpdates();
                                return
                            }
                            k && R && N.endB == N.start && (e.input.lastAndroidDelete = Date.now()), R && !T && S.start() != M.start() && 0 == M.parentOffset && S.depth == M.depth && v.sel && v.sel.anchor == v.sel.head && v.sel.head == N.endA && (N.endB -= 2, M = v.doc.resolveNoCache(N.endB - v.from), setTimeout(() => {
                            ...
                            let E = N.start,
                                P = N.endA;
                            if (T) {
                                if (S.pos == M.pos) C && O <= 11 && 0 == S.parentOffset && (e.domObserver.suppressSelectionUpdates(), setTimeout(() => eD(e), 20)), c = e.state.tr.delete(E, P), h = w.resolve(N.start).marksAcross(w.resolve(N.endA));
                                    ...
                                    }(S.parent.content.cut(S.parentOffset, M.parentOffset), x.parent.content.cut(x.parentOffset, N.endA - x.start())))) c = e.state.tr, "add" == u.type ? c.addMark(E, P, u.mark) : c.removeMark(E, P, u.mark);
                                    ...
                                    if (e.someProp("handleTextInput", n => n(e, E, P, t))) return;
                                    c = e.state.tr.insertText(t, E, P)
                                }
                            }
                            if (c || (c = e.state.tr.replace(E, P, v.doc.slice(N.start - v.from, N.endB - v.from))), v.sel) {
                                let t = tL(e, c.doc, v.sel);
                                t && !(k && R && e.composing && t.empty && (N.start != N.endB || e.input.lastAndroidDelete < Date.now() - 100) && (t.head == E || t.head == c.mapping.map(P) - 1) || C && t.empty && t.head == E) && c.setSelection(t)
                            }
                            ...
                            for (let t in eY) {
                                ...
                                e.dom.addEventListener(t, e.input.eventHandlers[t] = t => {
                                    ! function(e, t) {
                                        ...
                                        return !0
                                    }(e, t) || e5(e, t) || !e.editable && t.type in eQ || n(e, t)
                                }, e0[t] ? {
                                    passive: !0
                                } : void 0)
                            }
                            E && e.dom.addEventListener("input", () => null), e2(e)
                ...
                update(e) {
                    ...
                    let t = this._props;
                    this._props = e, e.plugins && (e.plugins.forEach(tH), this.directPlugins = e.plugins), this.updateStateInner(e.state, t)
                }
                setProps(e) {
                    let t = {};
                ...
                updateStateInner(e, t) {
                    ...
                    }(a || t.handleDOMEvents != this._props.handleDOMEvents) && e2(this), this.editable = tW(this), t$(this);
                    let c = tx(this),
                        u = tq(this),
                    ...
                    if (d) {
                        ...
                        let a = g && (C || k) && !this.composing && !s.selection.empty && !e.selection.empty && (o = s.selection, i = e.selection, d = Math.min(o.$anchor.sharedDepth(o.head), i.$anchor.sharedDepth(i.head)), o.$anchor.start(d) != i.$anchor.start(d));
                        if (g) {
                    ...
                    this.updatePluginViews(s), (null === (n = this.dragging) || void 0 === n ? void 0 : n.node) && !s.doc.eq(e.doc) && this.updateDraggedNode(this.dragging, s), "reset" == f ? this.dom.scrollTop = 0 : "to selection" == f ? this.scrollToSelection() : y && function({
                        refDOM: e,
                        refTop: t,
                        stack: n
                    }) {
                ...
                updateDraggedNode(e, t) {
                    ...
                    this.dragging = new td(e.slice, e.move, i < 0 ? void 0 : o.nh.create(this.state.doc, i))
                }
                someProp(e, t) {
                            ...
                            B && d && 1 == r.nodeType && 1 == (n = r.childNodes[d - 1]).nodeType && "false" == n.contentEditable && n.getBoundingClientRect().top >= t.top && d--, r == e.dom && d == r.childNodes.length - 1 && 1 == r.lastChild.nodeType && t.top > r.lastChild.getBoundingClientRect().bottom ? i = e.state.doc.content.size : (0 == d || 1 != r.nodeType || "BR" != r.childNodes[d - 1].nodeName) && (i = function(e, t, n, o) {
                                ...
                                for (let n = t, s = !1; n != e.dom;) {
                                    ...
                                    if (1 == t.dom.nodeType && (t.node.isBlock && t.parent || !t.contentDOM)) {
                                        ...
                                        if (t.node.isBlock && t.parent && (!s && e.left > o.left || e.top > o.top ? i = t.posBefore : (!s && e.right < o.left || e.bottom < o.top) && (i = t.posAfter), s = !0), !t.contentDOM && i < 0 && !t.node.isText) return (t.node.isBlock ? o.top < (e.top + e.bottom) / 2 : o.left < (e.left + e.right) / 2) ? t.posBefore : t.posAfter
                                    }
                                    n = t.dom.parentNode
                                }
                                        ...
                                        if (f.top <= c && f.bottom >= h) {
                                            ...
                                            if (t < r) {
                                                s = e, r = t, l = t && 3 == s.nodeType ? {
                                                    ...
                                                    top: n.top
                                                } : n, 1 == e.nodeType && t && (d = u + (n.left >= (f.left + f.right) / 2 ? 1 : 0));
                                                continue
                                            }
                ...
                endOfTextblock(e, t) {
                    var n, o, i;
                    let s, r;
                    return n = this, o = t || this.state, i = e, X == o && Y == i ? Q : (X = o, Y = i, Q = "up" == i || "down" == i ? (s = o.selection, r = "up" == i ? s.$from : s.$to, j(n, o, () => {
                        let {
                            node: e
                ...
                destroy() {
                    ...
                    }(this), this.destroyPluginViews(), this.mounted ? (this.docView.update(this.state.doc, [], tx(this), this), this.dom.textContent = "") : this.dom.parentNode && this.dom.parentNode.removeChild(this.dom), this.docView.destroy(), this.docView = null, c())
                }
                get isDestroyed() {
                    return null == this.docView
                }
                dispatchEvent(e) {
                    e5(this, e) || !eY[e.type] || !this.editable && e.type in eQ || eY[e.type](this, e)
                }
                dispatch(e) {
            ...
            function tq(e) {
                ...
                }), t.translate || (t.translate = "no"), [tp.node(0, e.state.doc.content.size, t)]
            }
            ...
            function t$(e) {
                if (e.markCursor) {
                    ...
                    t.className = "ProseMirror-separator", t.setAttribute("mark-placeholder", "true"), t.setAttribute("alt", ""), e.cursorWrapper = {
                        dom: t,
                        deco: tp.widget(e.state.selection.from, t, {
                            raw: !0,
                            marks: e.markCursor
                        })
                    }
...
//# sourceMappingURL=b155a556-6148ef733345726d.js.map