...
(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
    [6576], {
        13236: (e, t, n) => {
            ...
            class B {
                constructor(e, t) {
                    this.splittableMarks = [], this.editor = t, this.extensions = B.resolve(e), this.schema = M(this.extensions, t), this.setupExtensions()
                }
                static resolve(e) {
                    var t;
                ...
                get plugins() {
                    let {
                        ...
                        let r = {
                            ...
                            l = {};
                        if ("mark" === t.type && t.config.exitable && (l.ArrowRight = () => eF.handleExit({
                                editor: e,
                                mark: t
                            })), a) {
                        ...
                        O(t, e.options.enableInputRules) && c && n.push(...c());
                        let u = h(t, "addPasteRules", r);
                        O(t, e.options.enablePasteRules) && u && o.push(...u());
            ...
            function I(e, t) {
                ...
                return D(e) && D(t) && Object.keys(t).forEach(r => {
                    D(t[r]) && r in e ? n[r] = I(e[r], t[r]) : Object.assign(n, {
                        [r]: t[r]
                    })
                }), n
            }
            ...
            function U(e, t, n = {
                ...
                let r = Object.keys(t);
                return !r.length || r.every(r => n.strict ? t[r] === e[r] : T(t[r]) ? t[r].test(e[r]) : t[r] === e[r])
            }
            ...
            function H(e, t, n = {}) {
                ...
                let o = V([...r.node.marks], t, n);
                if (!o) return;
                let i = r.index,
                    s = e.start() + r.offset,
                    a = i + 1,
                    l = s + r.node.nodeSize;
                for (V([...r.node.marks], t, n); i > 0 && o.isInSet(e.parent.child(i - 1).marks);) i -= 1, s -= e.parent.child(i).nodeSize;
            ...
            let q = e => {
                ...
                for (let n = t.length - 1; n >= 0; n -= 1) {
                    let r = t[n];
                    3 === r.nodeType && r.nodeValue && /^(\n\s\s|\n)$/.test(r.nodeValue) ? e.removeChild(r) : 1 === r.nodeType && q(r)
                }
                return e
            };
            ...
            function Y(e) {
                let t = `<body>${e}</body>`;
                return q(new window.DOMParser().parseFromString(t, "text/html").body)
            }
            ...
            var eT = Object.freeze({
                ...
                joinItemBackward: () => ({
                    ...
                    try {
                        let r = (0, a.N0)(t.doc, t.selection.$from.pos, -1);
                        if (null == r) return !1;
                ...
                keyboardShortcut: e => ({
                    ...
                    let i = (function(e) {
                            ...
                            for (let e = 0; e < i.length - 1; e += 1) {
                                ...
                                else if (/^mod$/i.test(s)) J() || Q() ? o = !0 : n = !0;
                ...
                splitBlock: ({
                    ...
                    if (s instanceof r.nh && s.node.isBlock) return !!(d.parentOffset && (0, a.zy)(l, d.pos)) && (o && (e && eS(n, i.extensionManager.splittableMarks), t.split(d.pos).scrollIntoView()), !0);
                    if (!d.parent.isBlock) return !1;
                    if (o) {
                        let o = c.parentOffset === c.parent.content.size;
                        s instanceof r.U3 && t.deleteSelection();
                        let l = 0 === d.depth ? void 0 : function(e) {
                            ...
                            h = (0, a.zy)(t.doc, t.mapping.map(d.pos), 1, p);
                        if (!p && !h && (0, a.zy)(t.doc, t.mapping.map(d.pos), 1, l ? [{
                                type: l
                            }] : void 0) && (h = !0, p = l ? [{
                                type: l,
                                attrs: u
                        ...
                        e && eS(n, i.extensionManager.splittableMarks), t.scrollIntoView()
                    }
                    return !0
                },
                splitListItem: e => ({
                    ...
                    if (!(0, a.zy)(t.doc, c.pos, 2)) return !1;
                    if (o) {
                        let {
                            selection: e,
                            storedMarks: r
                        ...
                        if (t.split(c.pos, 2, b).scrollIntoView(), !a || !o) return !0;
                ...
                toggleList: (e, t, n, r = {}) => ({
                    ...
                    if (k.depth >= 1 && x && k.depth - x.depth <= 1) {
                        ...
                        if (ek(x.node.type.name, u) && h.validContent(x.node.content) && a) return l().command(() => (i.setNodeMarkup(x.pos, h), !0)).command(() => eO(i, h)).command(() => eE(i, h)).run()
                    }
                    return n && w && a ? l().command(() => {
                        let e = c().wrapInList(h, r),
                            t = w.filter(e => p.includes(e.type.name));
                        return i.ensureMarks(t), !!e || d.clearNodes()
                    }).wrapInList(h, r).command(() => eO(i, h)).command(() => eE(i, h)).run() : l().command(() => !!c().wrapInList(h, r) || d.clearNodes()).wrapInList(h, r).command(() => eO(i, h)).command(() => eE(i, h)).run()
                },
                toggleMark: (e, t = {}, n = {}) => ({
                    state: r,
                    commands: o
                ...
                unsetMark: (e, t = {}) => ({
                    ...
                    if (c && s) {
                        let {
                            from: e,
                            to: t
                        } = a, r = null === (i = d.marks().find(e => e.type === l)) || void 0 === i ? void 0 : i.attrs, o = H(d, l, r);
            ...
            class e$ {
                ...
                get children() {
                    ...
                    return this.node.content.forEach((t, n) => {
                        ...
                        let s = new e$(i, this.editor, r, r ? t : null);
                        r && (s.actualDepth = this.depth + 1), e.push(new e$(i, this.editor, r, r ? t : null))
                    }), e
                }
                get firstChild() {
  ...
  opacity: 0
            ...
            class eD extends p {
                ...
                createExtensionManager() {
                    ...
                    }), eC, eA, eN, ej] : [], ...this.options.extensions].filter(e => ["extension", "node", "mark"].includes(null == e ? void 0 : e.type));
                ...
                createView() {
                    let e = er(this.options.content, this.schema, this.options.parseOptions),
                        t = G(e, this.options.autofocus);
                ...
                $pos(e) {
                    return new e$(this.state.doc.resolve(e), this)
                }
                get $doc() {
                    return this.$pos(0)
                }
            ...
            class eV {
                ...
                onDragStart(e) {
                    ...
                    let {
                        view: d
                    } = this.editor, c = e.target, u = 3 === c.nodeType ? null === (t = c.parentElement) || void 0 === t ? void 0 : t.closest("[data-drag-handle]") : c.closest("[data-drag-handle]");
...
//# sourceMappingURL=b779bb5e-2c5b28feb2f04471.js.map