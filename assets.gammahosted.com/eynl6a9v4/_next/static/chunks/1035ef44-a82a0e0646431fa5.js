        ...
        24895: (e, t, n) => {
            ...
            class L {
                ...
                get plugins() {
                    let {
                        editor: e
                    } = this, t = L.sort([...this.extensions].reverse()), n = [], r = [], o = t.map(t => {
                        let o = {
                                name: t.name,
                                options: t.options,
                                storage: t.storage,
                            ...
                            l = {};
                        if ("mark" === t.type && t.config.exitable && (l.ArrowRight = () => eH.handleExit({
                                editor: e,
                                mark: t
                            })), a) {
            ...
            function V(e, t) {
                ...
                return H(e) && H(t) && Object.keys(t).forEach(r => {
                    H(t[r]) && r in e ? n[r] = V(e[r], t[r]) : Object.assign(n, {
                        [r]: t[r]
                    })
                }), n
            }
            class K {
                ...
                configure(e = {}) {
                    let t = this.extend();
                    return t.parent = this.parent, t.options = V(this.options, e), t.storage = k(h(t, "addStorage", {
                        name: t.name,
                        options: t.options
                    })), t
                }
            ...
            function ea(e, t, n = {}) {
                ...
                let l = o - r,
                    d = a.filter(e => !s || s.name === e.node.type.name).filter(e => q(e.node.attrs, n, {
                        strict: !1
                    }));
            ...
            function eS(e, t, n = {}) {
                ...
                if (r) return !!(e.storedMarks || e.selection.$from.marks()).filter(e => !i || i.name === e.type.name).find(e => q(e.attrs, n, {
                    strict: !1
                }));
                let s = 0,
                    a = [];
                ...
                let l = a.filter(e => !i || i.name === e.mark.type.name).filter(e => q(e.mark.attrs, n, {
                        strict: !1
            ...
            var eA = Object.freeze({
                ...
                insertContentAt: (e, t, n) => ({
                    ...
                    if (o) {
                        ...
                        d ? (o = Array.isArray(t) ? t.map(e => e.text || "").join("") : "object" == typeof t && t && t.text ? t.text : t, r.insertText(o, a, l)) : (o = s, r.replaceWith(a, l, o)), n.updateSelection && eo(r, r.steps.length - 1, -1), n.applyInputRules && r.setMeta("applyInputRules", {
                            from: a,
                            text: o
                ...
                splitBlock: ({
                    ...
                    if (o) {
                        ...
                        if (!p && !h && a.canSplit(t.doc, t.mapping.map(d.pos), 1, l ? [{
                                type: l
                            }] : void 0) && (h = !0, p = l ? [{
                                type: l,
                                attrs: u
                ...
                splitListItem: e => ({
                    ...
                    if (0 === c.parent.content.size && c.node(-1).childCount === c.indexAfter(-1)) {
                        ...
                        if (o) {
                            ...
                            }), p > -1 && t.setSelection(r.TextSelection.near(t.doc.resolve(p))), t.scrollIntoView()
                        }
                        return !0
                    }
                    ...
                    if (!a.canSplit(t.doc, c.pos, 2)) return !1;
                    if (o) {
                        let {
                            selection: e,
                            storedMarks: r
                ...
                toggleList: (e, t, n, r = {}) => ({
                    ...
                    let {
                        ...
                        $from: v,
                        $to: b
                    } = m, k = v.blockRange(b), x = y || m.$to.parentOffset && m.$from.marks();
                    if (!k) return !1;
                    let w = ef(e => eO(e.type.name, u))(m);
                    if (k.depth >= 1 && w && k.depth - w.depth <= 1) {
                        if (w.node.type === h) return d.liftListItem(f);
                        if (eO(w.node.type.name, u) && h.validContent(w.node.content) && a) return l().command(() => (i.setNodeMarkup(w.pos, h), !0)).command(() => eP(i, h)).command(() => eC(i, h)).run()
                    }
                    return n && x && a ? l().command(() => {
                        let e = c().wrapInList(h, r),
                            t = x.filter(e => p.includes(e.type.name));
                        return i.ensureMarks(t), !!e || d.clearNodes()
                    }).wrapInList(h, r).command(() => eP(i, h)).command(() => eC(i, h)).run() : l().command(() => !!c().wrapInList(h, r) || d.clearNodes()).wrapInList(h, r).command(() => eP(i, h)).command(() => eC(i, h)).run()
                },
                toggleMark: (e, t = {}, n = {}) => ({
                    state: r,
                    commands: o
                ...
                unsetMark: (e, t = {}) => ({
                    ...
                    if (c && s) {
                        let {
                            from: e,
                            to: t
                        } = a, r = null === (i = d.marks().find(e => e.type === l)) || void 0 === i ? void 0 : i.attrs, o = G(d, l, r);
  ...
  opacity: 0
            ...
            class eL extends p {
                ...
                createExtensionManager() {
                    var e, t;
                    let n = [...this.options.enableCoreExtensions ? [ej, U.configure({
                    ...
                    }), eN, eR, eB, e$] : [], ...this.options.extensions].filter(e => ["extension", "node", "mark"].includes(null == e ? void 0 : e.type));
            ...
            class eH {
                ...
                configure(e = {}) {
                    let t = this.extend();
                    return t.options = V(this.options, e), t.storage = k(h(t, "addStorage", {
                        name: t.name,
                        options: t.options
                    })), t
                }
                extend(e = {}) {
                    let t = new eH({ ...this.config,
                        ...e
                    });
                    return t.parent = this, this.child = t, t.name = e.name ? e.name : t.parent.name, e.defaultOptions && console.warn(`[tiptap warn]: BREAKING CHANGE: "defaultOptions" is deprecated. Please use "addOptions" instead. Found in extension: "${t.name}".`), t.options = k(h(t, "addOptions", {
                        name: t.name
            ...
            t.CommandManager = u, t.Editor = eL, t.Extension = K, t.InputRule = A, t.Mark = eH, t.Node = eV, t.NodePos = eD, t.NodeView = eK, t.PasteRule = $, t.Tracker = eJ, t.callOrReturn = k, t.combineTransactionSteps = function(e, t) {
            ...
            }, t.createChainableState = c, t.createDocument = ec, t.createNodeFromContent = er, t.createStyleTag = ez, t.defaultBlockAt = ep, t.deleteProps = ed, t.elementFromString = en, t.escapeForRegEx = function(e) {
                return e.replace(/[-/\\^$*+?.()|[\]{}]/g, "\\$&")
            }, t.extensions = eI, t.findChildren = function(e, t) {
                let n = [];
            ...
            }, t.findDuplicates = z, t.findParentNode = ef, t.findParentNodeClosestToPos = eh, t.fromString = w, t.generateHTML = function(e, t) {
                let n = eg(t);
            ...
            }, t.getAttributes = eb, t.getAttributesFromExtensions = m, t.getChangedRanges = function(e) {
                let {
                    mapping: t,
                    steps: n
                } = e, r = [];
            ...
            }, t.isEmptyObject = x, t.isExtensionRulesEnabled = T, t.isFunction = b, t.isList = eO, t.isMacOS = es, t.isMarkActive = eS, t.isNodeActive = ea, t.isNodeEmpty = eE, t.isNodeSelection = function(e) {
                return e instanceof r.NodeSelection
            }, t.isNumber = B, t.isPlainObject = H, t.isRegExp = C, t.isString = function(e) {
            ...
            }, t.objectIncludes = q, t.pasteRulesPlugin = F, t.posToDOMRect = function(e, t, n) {
