...
export default function Button({
    ...
    const tag = props.href || props.target || props.theme === 'link' ? 'a' : 'button';
    const externalLinkProps = tag === 'a' && props.target === '_blank' ? {
        rel: 'noopener'
    } : {};
    ...
    const btnAddonEl = props.btnAddon ? < UX2.Element.Element className = 'btnAddon' / > : null;
    ...
    const iconChildren = ( <
        ...
        /UX2.Element.Element> <
        UX2.Element.Element className = 'iconText'
        style = {
            { ...iconStyles.common,
                ...iconStyles.text
            }
