...
export function CommerceCardOverlay({
    ...
    const contentProps = {
        ...
        salePrice,
        titleProps: {
            align: cardType === cardTypes.MAJOR || cardType === cardTypes.MEDIUM ? 'center' : 'left'
        },
        dataAids
    };
    ...
    const content = ( <
        ...
        <
        UX2.Component.CommerceCardPictureContainer backgroundColor = {
            backgroundColor
        } { ...overlayProps
        } >
        <
        ...
        style = {
            cardType === cardTypes.MAJOR ? {} : styles.desktop
        }
        /> <
        /> <
