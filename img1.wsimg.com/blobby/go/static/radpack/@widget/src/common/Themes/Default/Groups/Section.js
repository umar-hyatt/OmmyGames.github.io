...
function generateSectionHeadingChildren(children, hrType, richtext) {
    ...
    if (hrType === SMALL_UNDERLINE) {
        ...
        return [ <
            ...
            /UX2.Base>, <
            UX2.Element.Block key = 'hr'
            style = {
                blockStyles
            } >
            <
            UX2.Element.HR group = 'SectionHeading'
            sectionHeadingHR = {
                hrType
            }
            style = {
...
export function SectionHeading({
    ...
    return this.Heading(
        this.merge({
                ...
                children: generateSectionHeadingChildren(children, sectionHeadingHR, richtext),
                style: {
                    lineHeight: '1.4',
                    // Theme Based
                    marginTop: 0,
...
export function SectionHeadingHR({
    sectionHeadingHR,
    ...props
}) {
    const styleMap = {
