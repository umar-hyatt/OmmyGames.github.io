...
export function CommerceCardPriceDisplay({
    ...
    const styles = {
        container: {
            ...
            '@sm': {
                ...
                justifyContent: cardType === cardTypes.MAJOR || cardType === cardTypes.MEDIUM ? 'center' : 'flex-start'
            },
            ...componentStyles
        },
        duration: {
    ...
    const content = ( <
            UX2.Element.Block active style = {
                ...
                duration && < UX2.Element.Price children = {
                    duration
                }
                featured style = {
                    styles.duration
                ...
                /> } {
                    priceText && < UX2.Element.Price children = {
                        priceText
                    }
                    featured style = {
                        styles.range
