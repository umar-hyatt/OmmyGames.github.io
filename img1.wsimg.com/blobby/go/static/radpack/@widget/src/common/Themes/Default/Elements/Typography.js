...
export function Heading({
    ...
    const originalText = saveOriginalText ? {
    ...
    const levelFilterValue = levelFilter({
        tag,
        level
    });
    ...
    const whiteSpace = !props.richtext && typeof children === 'string' && children.includes('\n') ?
        'pre-line' :
        void 0;
    ...
    if (props.dangerouslySetInnerHTML) {
        ...
        props.children = children && Wrapper ? < Wrapper > {
            children
        } < /Wrapper> : children;
    }
