...
export function CommerceCardContent({
    ...
    const layoutStyles = !hasImage && isBoxed ?
        {
            display: 'flex',
            flexDirection: 'column',
            alignItems: 'center',
    ...
    const content = ( <
        > {
            eyebrowText && ( <
                UX2.Element.Details.Minor style = {
                    styles.eyebrow
                }
                data - aid = {
                    dataAids.eyebrow
        ...
        UX2.Component.CommerceCardTitle title = {
            name
        }
        isDigitalProduct = {
            productType === 'digital'
        ...
        PriceRowComponent { ...priceRowProps
            ...
            isPriceShown && ( <
                UX2.Component.CommerceCardPriceDisplay price = {
                    price
                }
                salePrice = {
                    salePrice
                ...
                styles = {
                    {
                        marginRight: ratings ? 'xxsmall' : '0'
                    }
                }
                />
            )
        } {
            ratings && < UX2.Element.Block > {
                    ratings
                } < /UX2.Element.Block> } <
                /PriceRowComponent> {
                    hasColors && ( <
                        UX2.Component.CommerceCardColors colors = {
                            colors
                        }
                        renderColorsLabel = {
                            renderColorsLabel
                    ...
                    buttonText && ( <
                        UX2.Element.Button.Spotlight style = {
                            styles.button
                        }
                        data - aid = {
                            dataAids.button
                    ...
                    linkText && ( <
                        UX2.Element.MoreLink category = {
                            linkCategory
                        }
                        section = {
                            isImageShown ? 'overlay' : 'default'
                        }
                        tag = 'span' >
                        {
                            linkText
