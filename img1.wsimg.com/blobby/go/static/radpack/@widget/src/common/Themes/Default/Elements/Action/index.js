...
import {
    DESKTOP_NAV_COVER
} from '../../../../Components/Internal/Header/constants/searchFormLocations';
...
export function InputFloatLabelInput({
    labelFocusStyles,
    ...props
}) {
    return this.Input(
...
export function ButtonPrevious(props) {
    return this.merge({
            tag: 'button',
            children: < UX2.Element.Icon icon = 'chevronLeft'
...
export function ButtonNext(props) {
    return this.merge({
            tag: 'button',
            children: < UX2.Element.Icon icon = 'chevronRight'
            data - edit - interactive = {
                true
            }
            />
...
export function LinkIcon({
    ...
    export function MoreLinkExpand({
        expanded,
        ...props
    }) {
