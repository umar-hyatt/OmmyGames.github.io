(() => {
    ...
    s.n = e => {
        ...
        var e = s(89),
            ...
            r = s(522),
            i = s(634);
        const c = JSON.parse('["ommygames\\\\.godaddysites\\\\.com(?:/.*)?/ola/services/.*","ommygames\\\\.godaddysites\\\\.com/ola/meetings/.*","/api/","https://api\\\\.ola\\\\.godaddy\\\\.com","https://12319777-5597-4574-9344-c99777374329\\\\.onlinestore\\\\.godaddy\\\\.com","/t/1/tl/event","google-analytics\\\\.com/collect","calendar\\\\.apps\\\\.(dev-|test-)?secureserver\\\\.net"]').map((e => new RegExp(e))),
            o = JSON.parse('["ommygames\\\\.godaddysites\\\\.com(?:/.*)?/f/.*","https://blog\\\\.apps\\\\.secureserver\\\\.net/v1/website/12319777-5597-4574-9344-c99777374329/feed/post/","https://blog\\\\.apps\\\\.secureserver\\\\.net/v1/website/12319777-5597-4574-9344-c99777374329/feed"]').map((e => new RegExp(e))),
            h = JSON.parse('["/","/games"]').map((e => ({
                url: e,
                revision: "1677577267539"
            })));
        self.addEventListener("activate", (function(e) {
            e.waitUntil(caches.keys().then((function(e) {
                return Promise.all(e.filter((e => e.startsWith("ommygames.com-"))).map((e => caches.delete(e))))
            })))
