(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
    [2888], {
        ...
        96103: function(e, t) {
            ...
            t.AsyncMode = u, t.ConcurrentMode = p, t.ContextConsumer = c, t.ContextProvider = l, t.Element = r, t.ForwardRef = f, t.Fragment = i, t.Lazy = m, t.Memo = d, t.Portal = o, t.Profiler = a, t.StrictMode = s, t.Suspense = g, t.isAsyncMode = function(e) {
                return O(e) || S(e) === u
                ...
                return "string" === typeof e || "function" === typeof e || e === i || e === p || e === a || e === s || e === g || e === h || "object" === typeof e && null !== e && (e.$$typeof === m || e.$$typeof === d || e.$$typeof === l || e.$$typeof === c || e.$$typeof === f || e.$$typeof === v || e.$$typeof === b || e.$$typeof === x || e.$$typeof === y)
            }, t.typeOf = S
        },
        ...
        10593: function(e, t, n) {
            ...
            var y = {
                ...
                v = "undefined" !== typeof window ? a.useLayoutEffect : a.useEffect,
                b = ["i18n"],
                x = ["i18n"];
            ...
            var k = ["backend", "detection"],
                w = function(e) {
                    ...
                    var o = e.i18n,
                        i = m(e, b),
                        s = y.i18n,
                        a = O(O(O(O({}, m(y, x)), i), s), o),
                        l = a.defaultNS,
                        c = a.lng,
                        u = a.localeExtension,
                        p = a.localePath,
                        d = a.nonExplicitSupportedLngs,
                        v = a.locales.filter((function(e) {
                            return "default" !== e
                        }));
                    if ("cimode" === c) return a;
                    ...
                    var w = null === e || void 0 === e || null === (t = e.interpolation) || void 0 === t ? void 0 : t.prefix,
                        ...
                        P = null !== w && void 0 !== w ? w : "{{",
                        N = null !== L && void 0 !== L ? L : "}}";
                    "string" !== typeof(null === e || void 0 === e ? void 0 : e.localeStructure) && (w || L) && (a.localeStructure = "".concat(P, "lng").concat(N, "/").concat(P, "ns").concat(N));
                    var j = a.fallbackLng,
                        C = a.localeStructure;
                    if (d) {
                        var $ = function(e, t) {
                        ...
                        if ("string" === typeof j) a.fallbackLng = a.locales.filter((function(e) {
                            return e.includes("-")
                        })).reduce($, {
                            default: [j]
                        });
                        else if (Array.isArray(j)) a.fallbackLng = a.locales.filter((function(e) {
                            return e.includes("-")
                        })).reduce($, {
                            default: j
                        });
                        else if ("object" === (0, g.Z)(j)) a.fallbackLng = Object.entries(a.fallbackLng).reduce((function(e, t) {
                            var n, r = h(t, 2),
                                o = r[0],
                                i = r[1];
                            return e[o] = o.includes("-") ? (n = [o.split("-")[0]].concat(f(i)), Array.from(new Set(n))) : i, e
                        }), j);
                        else if ("function" === typeof j) throw new Error("If nonExplicitSupportedLngs is true, no functions are allowed for fallbackLng")
                    }
                    return (null === e || void 0 === e || null === (r = e.use) || void 0 === r ? void 0 : r.some((function(e) {
                        return "backend" === e.type
                    }))) || ("string" === typeof p ? a.backend = {
                        addPath: "".concat(p, "/").concat(C, ".missing.").concat(u),
                        loadPath: "".concat(p, "/").concat(C, ".").concat(u)
            ...
            class P {
                ...
                init(e) {
                    let t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
                    this.prefix = t.prefix || "i18next:", this.logger = e || L, this.options = t, this.debug = t.debug
                }
                log() {
                ...
                clone(e) {
                    return (e = e || this.options).prefix = e.prefix || this.prefix, new P(this.logger, e)
                }
            }
            var N = new P;
            class j {
            ...
            function R(e, t, n) {
                ...
                const i = "string" !== typeof t ? [].concat(t) : t.split(".");
                for (; i.length > 1;) {
                    if (o()) return {};
                    const t = r(i.shift());
            ...
            function M(e, t) {
                ...
                for (let i = 0; i < r.length; ++i) {
                    ...
                    if (void 0 === o[r[i]]) {
                        let e = 2,
                            s = r.slice(i, i + e).join(n),
                            a = o[s];
                        for (; void 0 === a && r.length > i + e;) e++, s = r.slice(i, i + e).join(n), a = o[s];
                        if (void 0 === a) return;
                        ...
                        const l = r.slice(i + e).join(n);
                        return l ? M(a, l, n) : void 0
                    }
                    o = o[r[i]]
                }
                return o
            ...
            class z extends j {
                ...
                getResource(e, t, n) {
                    ...
                    let s = [e, t];
                    n && "string" !== typeof n && (s = s.concat(n)), n && "string" === typeof n && (s = s.concat(o ? n.split(o) : n)), e.indexOf(".") > -1 && (s = e.split("."));
                    const a = A(this.data, s);
                    return a || !i || "string" !== typeof n ? a : M(this.data && this.data[e] && this.data[e][t], n, o)
                }
                addResource(e, t, n, r) {
                ...
                addResources(e, t, n) {
                    ...
                    for (const o in n) "string" !== typeof n[o] && "[object Array]" !== Object.prototype.toString.apply(n[o]) || this.addResource(e, t, o, n[o], {
                        silent: !0
                    });
            ...
            class H extends j {
                constructor(e) {
                    ...
                    super(),
                        ...
                        }(["resourceStore", "languageUtils", "pluralResolver", "interpolator", "backendConnector", "i18nFormat", "utils"], e, this), this.options = t, void 0 === this.options.keySeparator && (this.options.keySeparator = "."), this.logger = N.create("translator")
                }
                changeLanguage(e) {
                    e && (this.language = e)
                }
                ...
                extractFromKey(e, t) {
                    ...
                    const i = n && e.indexOf(n) > -1,
                        s = !this.options.userDefinedKeySeparator && !t.keySeparator && !this.options.userDefinedNsSeparator && !t.nsSeparator && ! function(e, t, n) {
                            ...
                            const o = new RegExp(`(${r.map((e=>"?"===e?"\\?":e)).join("|")})`);
                            let i = !o.test(e);
                            if (!i) {
                                const t = e.indexOf(n);
                ...
                translate(e, t, n) {
                    ...
                    let p = u && u.res;
                    const f = u && u.usedKey || i,
                        g = u && u.exactUsedKey || i,
                    ...
                    if (m && p && ("string" !== typeof p && "boolean" !== typeof p && "number" !== typeof p) && ["[object Number]", "[object Function]", "[object RegExp]"].indexOf(h) < 0 && ("string" !== typeof d || "[object Array]" !== h)) {
                    ...
                    } else if (m && "string" === typeof d && "[object Array]" === h) p = p.join(d), p && (p = this.extendTranslation(p, e, t, n));
                    else {
                        let r = !1,
                            s = !1;
                        const c = void 0 !== t.count && "string" !== typeof t.count,
                            ...
                            d = t[`defaultValue${g}`] || t[`defaultValue${h}`] || t.defaultValue;
                        !this.isValidLookup(p) && f && (r = !0, p = d), this.isValidLookup(p) || (s = !0, p = i);
                        const m = (t.missingKeyNoValueFallbackToKey || this.options.missingKeyNoValueFallbackToKey) && s ? void 0 : p,
                            y = f && d !== p && this.options.updateMissing;
                        if (s || r || y) {
                            if (this.logger.log(y ? "updateKey" : "missingKey", l, a, i, y ? d : p), o) {
                            ...
                            const r = (e, n, r) => {
                                const o = f && r !== p ? r : m;
                                this.options.missingKeyHandler ? this.options.missingKeyHandler(e, a, n, o, y, t) : this.backendConnector && this.backendConnector.saveMissing && this.backendConnector.saveMissing(e, a, n, o, y, t), this.emit("missingKey", e, a, n, p)
                            };
                            this.options.saveMissing && (this.options.saveMissingPlurals && c ? e.forEach((e => {
                                this.pluralResolver.getSuffixes(e, t).forEach((n => {
                                    r([e], i + n, t[`defaultValue${n}`] || d)
                                }))
                            })) : r(e, i, d))
                        }
                        p = this.extendTranslation(p, e, t, u, n), s && p === i && this.options.appendNamespaceToMissingKey && (p = `${a}:${i}`), (s || r) && this.options.parseMissingKeyHandler && (p = "v1" !== this.options.compatibilityAPI ? this.options.parseMissingKeyHandler(this.options.appendNamespaceToMissingKey ? `${a}:${i}` : i, r ? p : void 0) : this.options.parseMissingKeyHandler(p))
                    }
                ...
                extendTranslation(e, t, n, r, o) {
                    ...
                    return void 0 !== e && null !== e && a && a.length && !1 !== n.applyPostProcessor && (e = _.handle(a, e, t, this.options && this.options.postProcessPassResolved ? {
                        i18nResolved: { ...r,
                ...
                resolve(e) {
                    ...
                    return "string" === typeof e && (e = [e]), e.forEach((e => {
                        ...
                        const u = void 0 !== s.count && "string" !== typeof s.count,
                            p = u && !s.ordinal && 0 === s.count && this.pluralResolver.shouldUseIntlApi(),
                        ...
                        c.forEach((e => {
                            this.isValidLookup(t) || (i = e, !B[`${g[0]}-${e}`] && this.utils && this.utils.hasLoadedNamespace && !this.utils.hasLoadedNamespace(i) && (B[`${g[0]}-${e}`] = !0, this.logger.warn(`key "${n}" for languages "${g.join(", ")}" won't get resolved as namespace "${i}" was not yet loaded`, "This means something IS WRONG in your setup. You access the t function before i18next.init / i18next.loadNamespace / i18next.changeLanguage was done. Wait for the callback or Promise to resolve before accessing it!!!")), g.forEach((n => {
                                if (this.isValidLookup(t)) return;
                                o = n;
                                const i = [l];
                                if (this.i18nFormat && this.i18nFormat.addLookupKeys) this.i18nFormat.addLookupKeys(i, l, n, e, s);
                                    ...
                                    if (u && (i.push(l + e), s.ordinal && 0 === e.indexOf(r) && i.push(l + e.replace(r, this.options.pluralSeparator)), p && i.push(l + t)), f) {
                                        const n = `${l}${this.options.contextSeparator}${s.context}`;
                                        i.push(n), u && (i.push(n + e), s.ordinal && 0 === e.indexOf(r) && i.push(n + e.replace(r, this.options.pluralSeparator)), p && i.push(n + t))
                                    }
                                }
                                let a;
            ...
            class Z {
                ...
                formatLanguageCode(e) {
                    if ("string" === typeof e && e.indexOf("-") > -1) {
                        ...
                        let n = e.split("-");
                        return this.options.lowerCaseLng ? n = n.map((e => e.toLowerCase())) : 2 === n.length ? (n[0] = n[0].toLowerCase(), n[1] = n[1].toUpperCase(), t.indexOf(n[1].toLowerCase()) > -1 && (n[1] = J(n[1].toLowerCase()))) : 3 === n.length && (n[0] = n[0].toLowerCase(), 2 === n[1].length && (n[1] = n[1].toUpperCase()), "sgn" !== n[0] && 2 === n[2].length && (n[2] = n[2].toUpperCase()), t.indexOf(n[1].toLowerCase()) > -1 && (n[1] = J(n[1].toLowerCase())), t.indexOf(n[2].toLowerCase()) > -1 && (n[2] = J(n[2].toLowerCase()))), n.join("-")
                    }
            ...
            class Q {
                constructor(e) {
                    let t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
                    this.languageUtils = e, this.options = t, this.logger = N.create("pluralResolver"), this.options.compatibilityJSON && !G.includes(this.options.compatibilityJSON) || "undefined" !== typeof Intl && Intl.PluralRules || (this.options.compatibilityJSON = "v3", this.logger.error("Your environment seems not to be Intl API compatible, use an Intl.PluralRules polyfill. Will fallback to the compatibilityJSON v3 format handling.")), this.rules = function() {
                        const e = {};
                        return q.forEach((t => {
                            t.lngs.forEach((n => {
                                e[n] = {
                ...
                getRule(e) {
                    ...
                    if (this.shouldUseIntlApi()) try {
                        return new Intl.PluralRules(K(e), {
            ...
            function ee(e, t, n) {
                let r = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : ".",
                    ...
                    i = I(e, t, n);
                return !i && o && "string" === typeof n && (i = M(e, n, r), void 0 === i && (i = M(t, n, r))), i
            }
            class te {
                constructor() {
                    let e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {};
                ...
                init() {
                    ...
                    this.escape = void 0 !== t.escape ? t.escape : V, this.escapeValue = void 0 === t.escapeValue || t.escapeValue, this.useRawValueToEscape = void 0 !== t.useRawValueToEscape && t.useRawValueToEscape, this.prefix = t.prefix ? T(t.prefix) : t.prefixEscaped || "{{", this.suffix = t.suffix ? T(t.suffix) : t.suffixEscaped || "}}", this.formatSeparator = t.formatSeparator ? t.formatSeparator : t.formatSeparator || ",", this.unescapePrefix = t.unescapeSuffix ? "" : t.unescapePrefix || "-", this.unescapeSuffix = this.unescapePrefix ? "" : t.unescapeSuffix || "", this.nestingPrefix = t.nestingPrefix ? T(t.nestingPrefix) : t.nestingPrefixEscaped || T("$t("), this.nestingSuffix = t.nestingSuffix ? T(t.nestingSuffix) : t.nestingSuffixEscaped || T(")"), this.nestingOptionsSeparator = t.nestingOptionsSeparator ? t.nestingOptionsSeparator : t.nestingOptionsSeparator || ",", this.maxReplaces = t.maxReplaces ? t.maxReplaces : 1e3, this.alwaysFormat = void 0 !== t.alwaysFormat && t.alwaysFormat, this.resetRegExp()
                }
                reset() {
                ...
                interpolate(e, t, n, r) {
                    ...
                    const c = e => {
                        if (e.indexOf(this.formatSeparator) < 0) {
                            const o = ee(t, a, e, this.options.keySeparator, this.options.ignoreJSONStructure);
                        ...
                        return this.format(ee(t, a, i, this.options.keySeparator, this.options.ignoreJSONStructure), s, n, { ...r,
                            ...t,
                            interpolationkey: i
                        })
                    };
                    this.resetRegExp();
                    const u = r && r.missingInterpolationHandler || this.options.missingInterpolationHandler,
                        ...
                        const {
                            ...
                            if (e.indexOf("(") > -1) {
                                ...
                                "currency" === t && o.indexOf(":") < 0 ? n.currency || (n.currency = o.trim()) : "relativetime" === t && o.indexOf(":") < 0 ? n.range || (n.range = o.trim()) : o.split(";").forEach((e => {
                                    if (!e) return;
                                    const [t, ...r] = e.split(":"), o = r.join(":").trim().replace(/^'+|'+$/g, "");
                ...
                saveMissing(e, t, n, r, o) {
                    ...
                    if (this.services.utils && this.services.utils.hasLoadedNamespace && !this.services.utils.hasLoadedNamespace(t)) this.logger.warn(`did not save key "${n}" as the namespace "${t}" was not yet loaded`, "This means something IS WRONG in your setup. You access the t function before i18next.init / i18next.loadNamespace / i18next.changeLanguage was done. Wait for the callback or Promise to resolve before accessing it!!!");
                        ...
                        if (this.backend && this.backend.create) {
                            ...
                            if (c.length < 6) try {
                                let o;
                                o = 5 === c.length ? c(e, t, n, r, l) : c(e, t, n, r), o && "function" === typeof o.then ? o.then((e => s(null, e))).catch(s) : s(null, o)
                            } catch (a) {
                                s(a)
                            } else c(e, t, n, r, s, l)
                        }
            ...
            class le extends j {
                ...
                init() {
                    ...
                    if (this.options = { ...r,
                        ...
                        let t;
                        this.modules.logger ? N.init(o(this.modules.logger), this.options) : N.init(null, this.options), this.modules.formatter ? t = this.modules.formatter : "undefined" !== typeof Intl && (t = re);
                        const n = new Z(this.options);
                        this.store = new z(this.options.resources, this.options);
                        const i = this.services;
                        i.logger = N, i.resourceStore = this.store, i.languageUtils = n, i.pluralResolver = new Q(n, {
                            prepend: this.options.pluralSeparator,
                            compatibilityJSON: this.options.compatibilityJSON,
                            simplifyPluralSuffix: this.options.simplifyPluralSuffix
                        }), !t || this.options.interpolation.format && this.options.interpolation.format !== r.interpolation.format || (i.formatter = o(t), i.formatter.init(i, this.options), this.options.interpolation.format = i.formatter.format.bind(i.formatter)), i.interpolator = new te(this.options), i.utils = {
                            hasLoadedNamespace: this.hasLoadedNamespace.bind(this)
                        }, i.backendConnector = new oe(o(this.modules.backend), i.resourceStore, i, this.options), i.backendConnector.on("*", (function(t) {
                    ...
                    if (this.format = this.options.interpolation.format, n || (n = ae), this.options.fallbackLng && !this.services.languageDetector && !this.options.lng) {
                    ...
                    const i = C(),
                        s = () => {
                            const e = (e, t) => {
                                this.isInitialized && !this.initializedStoreOnce && this.logger.warn("init: i18next is already initialized. You should call init just once!"), this.isInitialized = !0, this.options.isClone || this.logger.log("initialized", this.options), this.emit("initialized", this.options), i.resolve(t), n(e, t)
                            };
                ...
                reloadResources(e, t, n) {
                    const r = C();
                    return e || (e = this.languages), t || (t = this.options.ns), n || (n = ae), this.services.backendConnector.reload(e, t, (e => {
                        r.resolve(), n(e)
                    })), r
                }
                use(e) {
                ...
                getFixedT(e, t, n) {
                    ...
                    const o = function(e, t) {
                        ...
                        let u;
                        return u = i.keyPrefix && Array.isArray(e) ? e.map((e => `${i.keyPrefix}${c}${e}`)) : i.keyPrefix ? `${i.keyPrefix}${c}${e}` : e, r.t(u, i)
                    };
                ...
                dir(e) {
                    ...
                    const t = this.services && this.services.languageUtils || new Z(ie());
                ...
                cloneInstance() {
                    ...
                    }, n && (o.store = new z(this.store.data, r), o.services.resourceStore = o.store), o.translator = new H(o.services, r), o.translator.on("*", (function(e) {
                        for (var t = arguments.length, n = new Array(t > 1 ? t - 1 : 0), r = 1; r < t; r++) n[r - 1] = arguments[r];
                        o.emit(e, ...n)
            ...
            var he = function(e, t) {
                ...
                de = function(e) {
                    var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : null,
                        n = function(n) {
                            var i, s, l = (n.pageProps || {})._nextI18Next,
                                c = null !== (i = null === l || void 0 === l ? void 0 : l.initialLocale) && void 0 !== i ? i : null === n || void 0 === n || null === (s = n.router) || void 0 === s ? void 0 : s.locale,
                                u = null === l || void 0 === l ? void 0 : l.ns,
                                p = (0, a.useRef)(null),
                                f = (0, a.useMemo)((function() {
                                    ...
                                    c || (c = n.i18n.defaultLocale);
                                    var i = p.current;
                                    return i ? he(i, o) : (i = ue(ge(ge({}, w(ge(ge({}, n), {}, {
                                        lng: c
                                    }))), {}, {
                                        lng: c,
                                        ns: u,
                                        resources: o
                                    })).i18n, he(i, o), i, p.current = i), i
                                }), [l, c, u]);
                            return v((function() {
                                f && c && f.changeLanguage(c)
                            }), [f, c]), null !== f ? pe(r.a3, {
                                i18n: f
                            }, pe(e, n)) : pe(e, (0, o.Z)({
                                key: c
                            ...
                            var r = {
                                ...
                                relative: function(e, n) {
                                    ...
                                    for (var l = n.length - a, c = s < l ? s : l, u = -1, p = 0; p <= c; ++p) {
                                        if (p === c) {
                                            ...
                                            } else s > c && (47 === e.charCodeAt(o + p) ? u = p : 0 === p && (u = 0));
                                            break
                                        }
                                    ...
                                    var g = "";
                                    for (p = o + u + 1; p <= i; ++p) p !== i && 47 !== e.charCodeAt(p) || (0 === g.length ? g += ".." : g += "/..");
                                    return g.length > 0 ? g + n.slice(a + u) : (a += u, 47 === n.charCodeAt(a) && ++a, n.slice(a))
                                },
                                ...
                                basename: function(e, n) {
                                    ...
                                    if (void 0 !== n && n.length > 0 && n.length <= e.length) {
                                        ...
                                        for (r = e.length - 1; r >= 0; --r) {
                                            ...
                                            } else -1 === l && (s = !1, l = r + 1), a >= 0 && (c === n.charCodeAt(a) ? -1 === --a && (i = r) : (a = -1, i = l))
                                        }
                                ...
                                parse: function(e) {
                                    ...
                                    for (var s = -1, a = 0, l = -1, c = !0, u = e.length - 1, p = 0; u >= r; --u)
                                        if (47 !== (o = e.charCodeAt(u))) - 1 === l && (c = !1, l = u + 1), 46 === o ? -1 === s ? s = u : 1 !== p && (p = 1) : -1 !== s && (p = -1);
                                        else if (!c) {
                                        a = u + 1;
                                        break
                                    }
        ...
        67421: function(e, t, n) {
            ...
            function O(e) {
                ...
                const d = (a.isInitialized || a.initializedStoreOnce) && h.every((e => p(e, a, u)));

                function m() {
                    return a.getFixedT(t.lng || null, "fallback" === u.nsMode ? h : h[0], g)
                }
                const [O, k] = (0, r.useState)(m);
                let w = h.join();
                t.lng && (w = `${t.lng}${w}`);
                const L = S(w),
                    P = (0, r.useRef)(!0);
                (0, r.useEffect)((() => {
                    ...
                    return P.current = !0, d || f || (t.lng ? c(a, t.lng, h, (() => {
                        P.current && k(m)
                    })) : l(a, h, (() => {
                        P.current && k(m)
                    }))), d && L && L !== w && P.current && k(m), e && a && a.on(e, r), n && a && a.store.on(n, r), () => {
                        P.current = !1, e && a && e.split(" ").forEach((e => a.off(e, r))), n && a && n.split(" ").forEach((e => a.store.off(e, r)))
                    }
                }), [a, w]);
                const N = (0, r.useRef)(!0);
                (0, r.useEffect)((() => {
                    P.current && !N.current && k(m), N.current = !1
                }), [a, g]);
                const j = [O, a, d];
                if (j.t = O, j.i18n = a, j.ready = d, d) return j;
                if (!d && !f) return j;
                throw new Promise((e => {
                    t.lng ? c(a, t.lng, h, (() => e())) : l(a, h, (() => e()))
                }))
            }
