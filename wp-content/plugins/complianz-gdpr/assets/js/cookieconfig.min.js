    ...
    function cmplz_cookie_warning() {
        ...
        window.cookieconsent.initialise({
            ...
            onInitialise: function(status) {
                ...
                if (status === "allow") {
                    var all = false;
                    if (complianz.use_categories === "no") all = true;
            ...
            highestTabIndex++;
            $(".cc-btn, .cc-link, .cmplz-classic, .cmplz-square, .cmplz-slider").each(function(i) {
                $(this).attr("tabindex", i + highestTabIndex)
            });
            $.event.trigger({
        ...
        if ($(".cmplz-manage-consent-container").length) {
            $.ajax({
                ...
                success: function(response) {
                    ...
                    highestTabIndex++;
                    $("#cmplz-manage-consent-container .cmplz-classic, #cmplz-manage-consent-container .cmplz-square, #cmplz-manage-consent-container .cmplz-slider").each(function(i) {
                        $(this).attr("tabindex", i + highestTabIndex)
                    })
                }
            })
