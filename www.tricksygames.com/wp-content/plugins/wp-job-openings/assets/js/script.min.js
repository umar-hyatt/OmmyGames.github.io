! function(s) {
    ...
    function s(e, t) {
        var s = this;
        s.element = e, s.$element = d(e), s.state = {
    ...
    s.prototype = {
        ...
        init: function(e) {
            ...
            o.options = d.extend(!0, {}, d.fn[l].defaults, o.options, e), o.utils.triggerCallback("BeforeInit", o), o.destroy(!0), o.options.disableOnMobile && o.utils.isMobile() ? o.disableOnMobile = !0 : (o.classes = o.getClassNames(), e = d("<input/>", {
                ...
                class: "label"
            }), a = o.$element.wrap("<div/>").parent().append(i.prepend(n), t, e), r = d("<div/>", {
        ...
        setLabel: function() {
            ...
            s.state.multiple ? (e = 0 === (e = d.isArray(s.state.currValue) ? s.state.currValue : [s.state.currValue]).length ? [0] : e, t = d.map(e, function(t) {
            ...
            }), s.options.multiple.maxLabelEntries && (t.length >= s.options.multiple.maxLabelEntries + 1 ? (t = t.slice(0, s.options.multiple.maxLabelEntries)).push(d.isFunction(i) ? i({
                text: "..."
            }) : s.utils.format(i, {
                text: "..."
            })) : t.slice(t.length - 1)), s.elements.label.html(t.join(s.options.multiple.separator))) : (e = s.lookupItems[s.state.currValue], s.elements.label.html(d.isFunction(i) ? i(e) : s.utils.format(i, e)))
        },
        populate: function() {
            var i = this,
            ...
            1 < s.length && i.state.multiple && (n = [], s.each(function() {
                n.push(d(this).index())
            })), i.state.currValue = ~n ? n : t, i.state.selectedIdx = i.state.currValue, i.state.highlightedIdx = i.state.currValue, i.items = [], i.lookupItems = [], e.length && (e.each(function(e) {
                var s, t = d(this);
                t.is("optgroup") ? (s = {
                    element: t,
                    label: t.prop("label"),
                ...
                }), i.items[e] = s) : (i.items[e] = i.getItemData(a, t, t.prop("disabled")), i.lookupItems[a] = i.items[e], a++)
        ...
        getItemsMarkup: function(e) {
            var s = this,
                i = "<ul>";
            return d.isFunction(s.options.listBuilder) && s.options.listBuilder && (e = s.options.listBuilder(e)), d.each(e, function(e, t) {
                void 0 !== t.label ? (i += s.utils.format('<ul class="{1}"><li class="{2}">{3}</li>', s.utils.arrayToClassname([s.classes.group, t.groupDisabled ? "disabled" : "", t.element.prop("class")]), s.classes.grouplabel, t.element.prop("label")), d.each(t.items, function(e, t) {
        ...
        getItemMarkup: function(e, t) {
            ...
            return s.utils.format('<li data-index="{1}" class="{2}">{3}</li>', e, s.utils.arrayToClassname([t.className, e === s.items.length - 1 ? "last" : "", t.disabled ? "disabled" : "", t.selected ? "selected" : ""]), d.isFunction(i) ? s.utils.format(i(t, this.$element, e), t) : s.utils.format(i, n))
        },
        ...
        bindEvents: function() {
            ...
            }), a.options.nativeOnMobile && a.utils.isMobile() || (a.$element.on("focus" + i, function() {
                a.elements.input.focus()
            }), a.elements.input.prop({
                tabindex: a.originalTabindex,
                disabled: !1
            }).on("keydown" + i, d.proxy(a.handleKeys, a)).on("focusin" + i, function(e) {
                ...
                clearTimeout(a.resetStr), a.resetStr = setTimeout(function() {
                    ...
                    if (!t.disabled)
                        ...
                        for (var s = t.alt.split("|"), i = 0; i < s.length && s[i]; i++)
                            if (n.test(s[i].trim())) return void a.highlight(e)
                })
            })), a.$li.on({
        ...
        setOptionsDimensions: function() {
            ...
            !e.options.expandToItemText || i < n ? e.finalWidth = n : (e.elements.items.css("overflow", "scroll"), e.elements.outerWrapper.width(9e4), e.finalWidth = e.elements.items.width(), e.elements.items.css("overflow", ""), e.elements.outerWrapper.width("")), e.elements.items.width(e.finalWidth).height() > s && e.elements.items.height(s), t.removeClass(e.classes.tempshow)
        },
        ...
        open: function(e) {
            ...
            n.utils.triggerCallback("BeforeOpen", n), e && (e.preventDefault(), n.options.stopPropagation) && e.stopPropagation(), n.state.enabled && (n.setOptionsDimensions(), d("." + n.classes.hideselect, "." + n.classes.open).children()[l]("close"), n.state.opened = !0, n.itemsHeight = n.elements.items.outerHeight(), n.itemsInnerHeight = n.elements.items.height(), n.elements.outerWrapper.addClass(n.classes.open), n.elements.input.val(""), e && "focusin" !== e.type && n.elements.input.focus(), setTimeout(function() {
                ...
                var t = e.originalEvent,
                    s = d(this).scrollTop(),
                    i = 0;
                "detail" in t && (i = -1 * t.detail), "wheelDelta" in t && (i = t.wheelDelta), "wheelDeltaY" in t && (i = t.wheelDeltaY), "deltaY" in t && (i = -1 * t.deltaY), (s === this.scrollHeight - n.itemsInnerHeight && i < 0 || 0 === s && 0 < i) && e.preventDefault()
        ...
        change: function() {
            var s = this;
            s.utils.triggerCallback("BeforeChange", s), s.state.multiple ? (d.each(s.lookupItems, function(e) {
...
function(e) {
    ...
    d.extend(d.fn, {
        validate: function(e) {
            var i;
            if (this.length) return (i = d.data(this[0], "validator")) || (this.attr("novalidate", "novalidate"), i = new d.validator(e, this[0]), d.data(this[0], "validator", i), i.settings.onsubmit && (this.on("click.validate", ":submit", function(e) {
                ...
                function e() {
                    var e, t;
                    return i.submitButton && (i.settings.submitHandler || i.formSubmitted) && (e = d("<input type='hidden'/>").attr("name", i.submitButton.name).val(d(i.submitButton).val()).appendTo(i.currentForm)), !(i.settings.submitHandler && !i.settings.debug) || (t = i.settings.submitHandler.call(i, i.currentForm, s), e && e.remove(), void 0 !== t && t)
                }
        ...
        valid: function() {
            var e, t, s;
            return d(this[0]).is("form") ? e = this.validate().form() : (s = [], e = !0, t = d(this[0].form).validate(), this.each(function() {
                (e = t.element(this) && e) || (s = s.concat(t.errorList))
            }), t.errorList = s), e
        },
        rules: function(e, t) {
            var s, i, n, a, r, o = this[0],
            ...
            if (null != o && (!o.form && l && (o.form = this.closest("form")[0], o.name = this.attr("name")), null != o.form)) {
                if (e) switch (i = (s = d.data(o.form, "validator").settings).rules, n = d.validator.staticRules(o), e) {
                    case "add":
                ...
                return (l = d.validator.normalizeRules(d.extend({}, d.validator.classRules(o), d.validator.attributeRules(o), d.validator.dataRules(o), d.validator.staticRules(o)), o)).required && (a = l.required, delete l.required, l = d.extend({
                    required: a
    ...
    d.extend(d.expr.pseudos || d.expr[":"], {
        ...
        prototype: {
            init: function() {
                ...
                var s, n = this.currentForm,
                    i = this.groups = {};

                function e(e) {
                    var t, s, i = void 0 !== d(this).attr("contenteditable") && "false" !== d(this).attr("contenteditable");
                    !this.form && i && (this.form = d(this).closest("form")[0], this.name = d(this).attr("name")), n === this.form && (i = d.data(this.form, "validator"), t = "on" + e.type.replace(/^validate/, ""), (s = i.settings)[t]) && !d(this).is(s.ignore) && s[t].call(i, this, e)
                }
                d.each(this.settings.groups, function(s, e) {
                    "string" == typeof e && (e = e.split(/\s/)), d.each(e, function(e, t) {
                        i[t] = s
                    })
                }), s = this.settings.rules, d.each(s, function(e, t) {
            ...
            element: function(e) {
                var t, s, i = this.clean(e),
                    ...
                    a = this,
                    r = !0;
                return void 0 === n ? delete this.invalid[i.name] : (this.prepareElement(n), this.currentElements = d(n), (s = this.groups[n.name]) && d.each(this.groups, function(e, t) {
                    t === s && e !== n.name && (i = a.validationTargetFor(a.clean(a.findByName(e)))) && i.name in a.invalid && (a.currentElements.push(i), r = a.check(i) && r)
                }), t = !1 !== this.check(n), r = r && t, this.invalid[n.name] = !t, this.numberOfInvalids() || (this.toHide = this.toHide.add(this.containers)), this.showErrors(), d(e).attr("aria-invalid", !t)), r
            },
            showErrors: function(t) {
                var s;
                t && (d.extend((s = this).errorMap, t), this.errorList = d.map(this.errorMap, function(e, t) {
                    return {
                        message: e,
            ...
            check: function(t) {
                ...
                for (s in "function" == typeof a.normalizer ? n = a.normalizer : "function" == typeof this.settings.normalizer && (n = this.settings.normalizer), n && (l = n.call(t, l), delete a.normalizer), a) {
                    ...
                    try {
                        if ("dependency-mismatch" === (e = d.validator.methods[s].call(this, l, t, i.parameters)) && 1 === r) o = !0;
                        else {
            ...
            defaultMessage: function(e, t) {
                var s = this.findDefined(this.customMessage(e.name, (t = "string" == typeof t ? {
                        method: t
                    } : t).method), this.customDataMessage(e, t.method), !this.settings.ignoreTitle && e.title || void 0, d.validator.messages[t.method], "<strong>Warning: No message defined for " + e.name + "</strong>"),
                    i = /\$?\{(\d+)\}/g;
            ...
            showLabel: function(e, t) {
                var s, i, n, a = this.errorsFor(e),
                    r = this.idOrName(e),
                    o = d(e).attr("aria-describedby");
                a.length ? (a.removeClass(this.settings.validClass).addClass(this.settings.errorClass), a.html(t)) : (i = a = d("<" + this.settings.errorElement + ">").attr("id", r + "-error").addClass(this.settings.errorClass).html(t || ""), this.settings.wrapper && (i = a.hide().show().wrap("<" + this.settings.wrapper + "/>").parent()), this.labelContainer.length ? this.labelContainer.append(i) : this.settings.errorPlacement ? this.settings.errorPlacement.call(this, i, d(e)) : i.insertAfter(e), a.is("label") ? a.attr("for", r) : 0 === a.parents("label[for='" + this.escapeCssMeta(r) + "']").length && (i = a.attr("id"), o ? o.match(new RegExp("\\b" + this.escapeCssMeta(i) + "\\b")) || (o += " " + i) : o = i, d(e).attr("aria-describedby", o), s = this.groups[e.name]) && d.each((n = this).groups, function(e, t) {
        ...
        methods: {
            ...
            remote: function(i, n, e, a) {
                ...
                var r, t, o = this.previousValue(n, a);
                return this.settings.messages[n.name] || (this.settings.messages[n.name] = {}), o.originalMessage = o.originalMessage || this.settings.messages[n.name][a], this.settings.messages[n.name][a] = o.message, t = d.param(d.extend({
                    data: i
                }, (e = "string" == typeof e ? {
                    url: e
                } : e).data)), o.old === t ? o.valid : (o.old = t, (r = this).startRequest(n), (t = {})[n.name] = i, d.ajax(d.extend(!0, {
                    mode: "abort",
                    ...
                    success: function(e) {
                        var t, s = !0 === e || "true" === e;
                        r.settings.messages[n.name][a] = o.originalMessage, s ? (t = r.formSubmitted, r.resetInternals(), r.toHide = r.errorsFor(n), r.formSubmitted = t, r.successList.push(n), r.invalid[n.name] = !1, r.showErrors()) : (t = {}, e = e || r.defaultMessage(n, {
                            method: a,
                            parameters: i
                        }), t[n.name] = o.message = e, r.invalid[n.name] = !0, r.showErrors(t)), o.valid = s, r.stopRequest(n, s)
                    }
                }, e)), "pending")
            }
        }
    ...
    var s, i, n = {};
    return d.ajaxPrefilter ? d.ajaxPrefilter(function(e, t, s) {
        var i = e.port;
...
function(s) {
    ...
    var e, t = function() {
        ...
        a = !t || ((a = new t).append("s", " &"), "s=+%26" === a.toString()),
        o = u.prototype,
        ...
        if ("object" == typeof e)
            if (f(e))
                ...
                for (var a = (e = 0 === e.indexOf("?") ? e.slice(1) : e).split("&"), r = 0; r < a.length; r++) {
                    var o = a[r],
                        l = o.indexOf("="); - 1 < l ? p(t, c(o.slice(0, l)), c(o.slice(l + 1))) : o && p(t, c(o), "")
                }
        return t
    }
    ...
    t && i && n && a || (o.append = function(e, t) {
        ...
        var e, t, s, i, n = this[r],
            a = [];
        for (t in n)
            for (s = d(t), e = 0, i = n[t]; e < i.length; e++) a.push(s + "=" + d(i[e]));
        return a.join("&")
    }, !!n && t && !i && s.Proxy ? (e = new Proxy(t, {
        ...
        for (t = 0; t < i.length; t++)
            for (var n = i[t], a = s[n], r = 0; r < a.length; r++) this.append(n, a[r])
    ...
    var s = window.awsmJobs = window.awsmJobs || {},
        e = Number(awsmJobsPublic.job_id),
        e = (e && !isNaN(e) && m.post(awsmJobsPublic.ajaxurl, {
            action: "awsm_view_count",
            awsm_job_id: e
        }), m(".awsm-application-form")),
        i = (s.submitApplication = function(n, e) {
            e = void 0 !== e ? e : {};
            var s, t = n.find(".awsm-application-submit-btn"),
                a = n.parents(".awsm-job-form-inner").find(".awsm-application-message"),
                i = t.val(),
                r = t.data("responseText"),
                o = "awsm-success-message",
                l = "awsm-error-message",
                u = (m(".awsm-application-message").hide(), n[0]),
                d = !0,
                c = n.find(".awsm-form-file-control"),
            ...
            0 < c.length && c.each(function() {
                ...
                h < e && (d = !1)
            }), !1 === d ? a.addClass(l).html(awsmJobsPublic.i18n.form_error_msg.file_validation).fadeIn() : (a.removeClass(o + " " + l).hide(), t.prop("disabled", !0).val(r).addClass("awsm-application-submit-btn-disabled"), s = new FormData(u), "fields" in e && Array.isArray(e.fields) && m.each(e.fields, function(e, t) {
                ...
                var t, s, i;
                e && (t = "awsm-default-message", s = "", i = [], 0 < e.error.length ? (t = l, i = e.error, n.trigger("awsmjobs_application_failed", [e])) : 0 < e.success.length && (n[0].reset(), t = o, i = e.success, n.trigger("awsmjobs_application_submitted", [e])), m(i).each(function(e, t) {
                    s += "<p>" + t + "</p>"
                }), a.addClass(t).html(s).fadeIn())
            }).fail(function(e) {
                a.addClass(l).html(awsmJobsPublic.i18n.form_error_msg.general).fadeIn()
            }).always(function() {
                t.prop("disabled", !1).val(i).removeClass("awsm-application-submit-btn-disabled")
            }))
    ...
    function a(s) {
        ...
        0 < n.length && (t = t.concat(n)), r && (r = !1, f.ajax({
            url: e.attr("action"),
            beforeSend: function() {
            ...
            0 < t.length && (0 < t.val().length ? (s.find(".awsm-job-search-btn").addClass("awsm-job-hide"), s.find(".awsm-job-search-close-btn")) : s.find(".awsm-job-search-btn")).removeClass("awsm-job-hide"), f(document).trigger("awsmjobs_filtered_listings", [s, e])
    ...
    function y(e) {
        var t = !1;
        return 0 < e.length && e.find(".awsm-filter-option").each(function() {
    ...
    function t(e) {
        ...
        e.find(v).data("search", s), 0 === s.length && e.find(".awsm-job-search-icon-wrapper").addClass("awsm-job-hide"), o(e, "jq", s), awsmJobsPublic.deep_linking.search && (t = e.find('input[name="awsm_pagination_base"]'), x("jq", s, t.val())), a(e)
    }
    0 < f(g).length && f(g).each(function() {
        var e = f(this),
            t = e.find(b + " form");
        (0 < awsmJobsPublic.is_search.length || y(t)) && (r = !0, a(e))
    });
    ...
    function o(e, t, s) {
        var i, n, a = e.find('input[name="awsm_pagination_base"]');
    ...
    function s() {
        f(".awsm-filter-wrap").not(".awsm-no-search-filter-wrap").each(function() {
            var e = f(this);
            e.find(".awsm-filter-item").first().offset().top < e.find(".awsm-filter-item").last().offset().top ? e.addClass("awsm-full-width-search-filter-wrap") : e.removeClass("awsm-full-width-search-filter-wrap")
        })
    }
    f(b + " .awsm-filter-option").on("change", function(e) {
        e.preventDefault();
        var t, e = f(this),
            ...
            s = s.data("slug");
        o(i, e, s = void 0 !== s ? s : ""), awsmJobsPublic.deep_linking.spec && (t = i.find('input[name="awsm_pagination_base"]'), x(e, s, t.val())), a(i)
    }), f(b + " .awsm-job-search-btn").on("click", function() {
        t(f(this))
    }), f(b + " .awsm-job-search-close-btn").on("click", function() {
        var e = f(this);
        e.parents(g).find(".awsm-job-search").val(""), t(e)
    }), f(b + " .awsm-job-search").on("keypress", function(e) {
        13 == e.which && (e.preventDefault(), t(f(this)))
    }), f(v).on("click", ".awsm-jobs-pagination .awsm-load-more-btn, .awsm-jobs-pagination a.page-numbers", function(e) {
        e.preventDefault();
        var t, s, i, n = f(this),
            a = n.hasClass("awsm-load-more-btn"),
            e = 1,
            r = [],
            o = n.parents(g),
            l = o.find(v),
            u = n.parents(".awsm-jobs-pagination"),
            d = l.data("listings"),
            c = l.data("specs"),
            h = l.data("lang"),
            m = l.data("search"),
            p = (a ? (n.prop("disabled", !0), e = void 0 === (e = n.data("page")) ? 1 : e) : (n.parents(".page-numbers").find(".page-numbers").removeClass("current").removeAttr("aria-current"), n.addClass("current").attr("aria-current", "page")), u.addClass("awsm-jobs-pagination-loading"), o.find(b + " form")),
            p = (y(p) && (r = p.find(".awsm-filter-option").serializeArray()), a || (p = "", 1 < (i = (t = n.attr("href")).split("?")).length && (e = (s = new URLSearchParams(i[1])).get("paged"), s.delete("paged"), 0 < s.toString().length) && (p = "?" + s.toString()), t = i[0] + p, r.push({
                name: "awsm_pagination_base",
                value: i[0] + p
            }), awsmJobsPublic.deep_linking.pagination && x("paged", e, t)), awsmJobsPublic.is_tax_archive && (s = l.data("taxonomy"), i = l.data("termId"), void 0 !== s) && void 0 !== i && r.push({
                name: "awsm_job_spec[" + s + "]",
                value: i
            }), r.push({
                name: "action",
                value: "loadmore"
        ...
        0 < p.length && (r = r.concat(p)), f.ajax({
            url: awsmJobsPublic.ajaxurl,
            data: f.param(r),
            type: "POST",
            beforeSend: function() {
                a ? n.text(awsmJobsPublic.i18n.loading_text) : l.addClass("awsm-jobs-loading")
            }
        }).done(function(e) {
            var t;
            e ? (t = u.data("effectDuration"), u.remove(), a ? l.append(e) : (l.html(e), l.removeClass("awsm-jobs-loading"), void 0 !== t && (t = isNaN(t) ? t : Number(t), f("html, body").animate({
                scrollTop: o.offset().top - 25
            }, t)))) : n.remove(), f(document).trigger("awsmjobs_load_more", [n, e])
        }).fail(function(e) {})
    }), e(f(".awsm-job-select-control")), e(f(".awsm-filter-item select")), f(document).on("click", ".awsm-filter-toggle", function(e) {
        e.preventDefault();
        e = f(this);
